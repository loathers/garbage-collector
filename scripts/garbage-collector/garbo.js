...
function gin() {
  if ((0,dist.have)((0,dist.$item)(_templateObject91 || (_templateObject91 = dailies_taggedTemplateLiteral(["Time-Spinner"]))))) {
...
new FreeFight(function () {
  ...
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject92 || (_templateObject92 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
}, {
  cost: function cost() {
