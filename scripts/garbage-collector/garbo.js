...
function volcanoDailies() {
  ...
  if ((0,dist.have)((0,dist.$skill)(_templateObject63 || (_templateObject63 = dailies_taggedTemplateLiteral(["Unaccompanied Miner"])))) && (0,dist.get)("_unaccompaniedMinerUsed") < 5) {
...
function checkVolcanoQuest() {
  ...
  var volcanoItems = [dist.property.getItem("_volcanoItem1") || (0,dist.$item)(_templateObject64 || (_templateObject64 = dailies_taggedTemplateLiteral(["none"]))), dist.property.getItem("_volcanoItem2") || (0,dist.$item)(_templateObject65 || (_templateObject65 = dailies_taggedTemplateLiteral(["none"]))), dist.property.getItem("_volcanoItem3") || (0,dist.$item)(_templateObject66 || (_templateObject66 = dailies_taggedTemplateLiteral(["none"])))];
  var volcanoWhatToDo = new Map([[(0,dist.$item)(_templateObject67 || (_templateObject67 = dailies_taggedTemplateLiteral(["new age healing crystal"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject68 || (_templateObject68 = dailies_taggedTemplateLiteral(["new age healing crystal"])))) >= 5) return true;else {
      return (0,external_kolmafia_.buy)(5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject69 || (_templateObject69 = dailies_taggedTemplateLiteral(["new age healing crystal"])))), (0,dist.$item)(_templateObject70 || (_templateObject70 = dailies_taggedTemplateLiteral(["new age healing crystal"]))), 1000) === 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject71 || (_templateObject71 = dailies_taggedTemplateLiteral(["new age healing crystal"]))));
    }
  }], [(0,dist.$item)(_templateObject72 || (_templateObject72 = dailies_taggedTemplateLiteral(["smooch bottlecap"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject73 || (_templateObject73 = dailies_taggedTemplateLiteral(["smooch bottlecap"])))) > 0) return true;else return (0,external_kolmafia_.buy)(1, (0,dist.$item)(_templateObject74 || (_templateObject74 = dailies_taggedTemplateLiteral(["smooch bottlecap"]))), 5000) === 1;
  }], [(0,dist.$item)(_templateObject75 || (_templateObject75 = dailies_taggedTemplateLiteral(["gooey lava globs"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject76 || (_templateObject76 = dailies_taggedTemplateLiteral(["gooey lava globs"])))) >= 5) {
      return true;
    } else {
      var toBuy = 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject77 || (_templateObject77 = dailies_taggedTemplateLiteral(["gooey lava globs"]))));
      return (0,external_kolmafia_.buy)(toBuy, (0,dist.$item)(_templateObject78 || (_templateObject78 = dailies_taggedTemplateLiteral(["gooey lava globs"]))), 5000) === toBuy;
    }
  }], [(0,dist.$item)(_templateObject79 || (_templateObject79 = dailies_taggedTemplateLiteral(["fused fuse"]))), function () {
    return (0,dist.have)((0,dist.$item)(_templateObject80 || (_templateObject80 = dailies_taggedTemplateLiteral(["clara's bell"]))));
  }], [(0,dist.$item)(_templateObject81 || (_templateObject81 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject82 || (_templateObject82 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) < 3) {
      (0,external_kolmafia_.cliExecute)("acquire ".concat((3 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject83 || (_templateObject83 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))))).toString(), " smooth velvet bra"));
    }

    return (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject84 || (_templateObject84 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) >= 3;
  }], [(0,dist.$item)(_templateObject85 || (_templateObject85 = dailies_taggedTemplateLiteral(["smooch bracers"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject86 || (_templateObject86 = dailies_taggedTemplateLiteral(["smooch bracers"])))) < 3) {
      (0,external_kolmafia_.cliExecute)("acquire ".concat((3 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject87 || (_templateObject87 = dailies_taggedTemplateLiteral(["smooch bracers"]))))).toString(), " smooch bracers"));
    }

    return (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject88 || (_templateObject88 = dailies_taggedTemplateLiteral(["smooch bracers"])))) >= 3;
  }]]);
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (volcanoItems.includes(volcanoItem)) {
        if (tryToGetIt()) {
          if (volcanoItem !== (0,dist.$item)(_templateObject89 || (_templateObject89 = dailies_taggedTemplateLiteral(["fused fuse"])))) {
            (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
...
function cheat() {
  if ((0,dist.have)((0,dist.$item)(_templateObject90 || (_templateObject90 = dailies_taggedTemplateLiteral(["deck of every card"]))))) {
      ...
      while (nextFight !== null) {
        ...
        (0,combat.withMacro)(embezzlerMacro(), function () {
          if (nextFight) {
            ...
            if (nextFight.draggable && !(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || waterBreathingEquipment.some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || familiarWaterBreathingEquipment.some(dist.have)) && ((0,dist.have)((0,dist.$effect)(fights_templateObject72 || (fights_templateObject72 = fights_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(fights_templateObject73 || (fights_templateObject73 = fights_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(fights_templateObject74 || (fights_templateObject74 = fights_taggedTemplateLiteral(["envyfish egg"]))))) {
              (0,external_kolmafia_.setLocation)((0,dist.$location)(fights_templateObject75 || (fights_templateObject75 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
              ...
              (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject76 || (fights_templateObject76 = fights_taggedTemplateLiteral(["pulled green taffy"]))));
              if (!(0,dist.have)((0,dist.$effect)(fights_templateObject77 || (fights_templateObject77 = fights_taggedTemplateLiteral(["Fishy"]))))) (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject78 || (fights_templateObject78 = fights_taggedTemplateLiteral(["fishy pipe"]))));
              nextFight.run((0,dist.$location)(fights_templateObject79 || (fights_templateObject79 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
              ...
              (0,external_kolmafia_.setLocation)((0,dist.$location)(fights_templateObject80 || (fights_templateObject80 = fights_taggedTemplateLiteral(["Noob Cave"]))));
              meatOutfit(true, nextFight.requirements);
              nextFight.run((0,dist.$location)(fights_templateObject81 || (fights_templateObject81 = fights_taggedTemplateLiteral(["Noob Cave"]))));
            }
          }
        });
        startDigitize();
...
var pygmyMacro = combat.Macro.if_("monstername pygmy bowler", combat.Macro.trySkill("Snokebomb").item((0,dist.$item)(fights_templateObject82 || (fights_templateObject82 = fights_taggedTemplateLiteral(["Louder than Bomb"]))))).if_("monstername pygmy orderlies", combat.Macro.trySkill("Feel Hatred").item((0,dist.$item)(fights_templateObject83 || (fights_templateObject83 = fights_taggedTemplateLiteral(["divine champagne popper"]))))).if_("monstername pygmy janitor", combat.Macro.item((0,dist.$item)(fights_templateObject84 || (fights_templateObject84 = fights_taggedTemplateLiteral(["tennis ball"]))))).if_("monstername time-spinner prank", combat.Macro.meatKill()).abort();
var freeFightSources = [// Get a Fish Head from our robortender if available
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject85 || (fights_templateObject85 = fights_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) && (0,dist.have)((0,dist.$familiar)(fights_templateObject86 || (fights_templateObject86 = fights_taggedTemplateLiteral(["Robortender"])))) && !(0,dist.get)("_cargoPocketEmptied") && String((0,dist.get)("cargoPocketsEmptied", "")).indexOf("428") === -1;
}, function () {
  return (0,external_kolmafia_.cliExecute)("cargo monster Mob Penguin Thug");
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(fights_templateObject87 || (fights_templateObject87 = fights_taggedTemplateLiteral(["Robortender"])));
  }
}), new FreeFight(function () {
  ...
  var haveEldritchEssence = (0,external_kolmafia_.itemAmount)((0,dist.$item)(fights_templateObject88 || (fights_templateObject88 = fights_taggedTemplateLiteral(["eldritch essence"])))) !== 0;
  ...
  return (0,dist.have)((0,dist.$skill)(fights_templateObject89 || (fights_templateObject89 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"])))) && !(0,dist.get)("_eldritchHorrorEvoked");
}, function () {
  return (0,external_kolmafia_.useSkill)((0,dist.$skill)(fights_templateObject90 || (fights_templateObject90 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
}), new FreeFight(function () {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        if (freeKillSource.available()) {
          ensureEffect((0,dist.$effect)(_templateObject210 || (_templateObject210 = fights_taggedTemplateLiteral(["Feeling Lost"]))));
...
function deliverThesis() {
  ...
  if ((0,dist.have)((0,dist.$item)(_templateObject217 || (_templateObject217 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject218 || (_templateObject218 = fights_taggedTemplateLiteral(["Triple-Sized"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") <= 95) {
    ...
    ensureEffect((0,dist.$effect)(_templateObject221 || (_templateObject221 = fights_taggedTemplateLiteral(["Triple-Sized"]))));
...
function barfTurn() {
  ...
  if ((0,dist.have)((0,dist.$item)(src_templateObject21 || (src_templateObject21 = src_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("_envyfishEggUsed")) {
    ...
    (0,dist.adventureMacroAuto)(location, combat.Macro.externalIf(underwater, combat.Macro.if_("monsterid ".concat((0,dist.$monster)(src_templateObject27 || (src_templateObject27 = src_taggedTemplateLiteral(["knob goblin embezzler"]))).id), combat.Macro.item("pulled green taffy"))).meatKill());
  }
...
function src_main() {
  ...
  var gardens = (0,dist.$items)(src_templateObject28 || (src_templateObject28 = src_taggedTemplateLiteral(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores"])));
  ...
  try {
    ...
    if ((0,dist.have)((0,dist.$item)(src_templateObject29 || (src_templateObject29 = src_taggedTemplateLiteral(["packet of tall grass seeds"])))) && (0,external_kolmafia_.myGardenType)() !== "grass") (0,external_kolmafia_.use)((0,dist.$item)(src_templateObject30 || (src_templateObject30 = src_taggedTemplateLiteral(["packet of tall grass seeds"]))));
    (0,external_kolmafia_.setAutoAttack)(0);
    ...
    withStash((0,dist.$items)(src_templateObject31 || (src_templateObject31 = src_taggedTemplateLiteral(["haiku katana, repaid diaper"]))), function () {
      // 0. diet stuff.
