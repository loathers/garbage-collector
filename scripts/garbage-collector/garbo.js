...
new FreeFight(function () {
  ...
  lib/* propertyManager.setChoices */.kr.setChoices({
    1310: !(0,dist.have)((0,dist.$item)(_templateObject281 || (_templateObject281 = fights_taggedTemplateLiteral(["God Lobster's Crown"])))) ? 1 : 2 // god lob equipment, then stats
  ...
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject282 || (_templateObject282 = fights_taggedTemplateLiteral(["God Lobster"])));
  },
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      bonusEquip: new Map([[(0,dist.$item)(_templateObject283 || (_templateObject283 = fights_taggedTemplateLiteral(["God Lobster's Scepter"]))), 1000], [(0,dist.$item)(_templateObject284 || (_templateObject284 = fights_taggedTemplateLiteral(["God Lobster's Ring"]))), 2000], [(0,dist.$item)(_templateObject285 || (_templateObject285 = fights_taggedTemplateLiteral(["God Lobster's Rod"]))), 3000], [(0,dist.$item)(_templateObject286 || (_templateObject286 = fights_taggedTemplateLiteral(["God Lobster's Robe"]))), 4000], [(0,dist.$item)(_templateObject287 || (_templateObject287 = fights_taggedTemplateLiteral(["God Lobster's Crown"]))), 5000]])
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject288 || (_templateObject288 = fights_taggedTemplateLiteral(["Machine Elf"])))) ? (0,lib/* clamp */.uZ)(5 - (0,dist.get)("_machineTunnelsAdv"), 0, 5) : 0;
}, function () {
  lib/* propertyManager.setChoices */.kr.setChoices({
    1119: 6 //escape DMT

  });
  var thought = (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject289 || (_templateObject289 = fights_taggedTemplateLiteral(["abstraction: certainty"])))) >= (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject290 || (_templateObject290 = fights_taggedTemplateLiteral(["abstraction: thought"]))));
  var action = (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject291 || (_templateObject291 = fights_taggedTemplateLiteral(["abstraction: joy"])))) >= (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject292 || (_templateObject292 = fights_taggedTemplateLiteral(["abstraction: action"]))));
  var sensation = (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject293 || (_templateObject293 = fights_taggedTemplateLiteral(["abstraction: motion"])))) >= (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject294 || (_templateObject294 = fights_taggedTemplateLiteral(["abstraction: sensation"]))));

  if (thought) {
    acquire(1, (0,dist.$item)(_templateObject295 || (_templateObject295 = fights_taggedTemplateLiteral(["abstraction: thought"]))), (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject296 || (_templateObject296 = fights_taggedTemplateLiteral(["abstraction: certainty"])))), false);
  }

  if (action) {
    acquire(1, (0,dist.$item)(_templateObject297 || (_templateObject297 = fights_taggedTemplateLiteral(["abstraction: action"]))), (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject298 || (_templateObject298 = fights_taggedTemplateLiteral(["abstraction: joy"])))), false);
  }

  if (sensation) {
    acquire(1, (0,dist.$item)(_templateObject299 || (_templateObject299 = fights_taggedTemplateLiteral(["abstraction: sensation"]))), (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject300 || (_templateObject300 = fights_taggedTemplateLiteral(["abstraction: motion"])))), false);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject301 || (_templateObject301 = fights_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), combat.Macro.externalIf(thought, combat.Macro.if_("monstername Perceiver of Sensations", combat.Macro.tryItem((0,dist.$item)(_templateObject302 || (_templateObject302 = fights_taggedTemplateLiteral(["abstraction: thought"])))))).externalIf(action, combat.Macro.if_("monstername Thinker of Thoughts", combat.Macro.tryItem((0,dist.$item)(_templateObject303 || (_templateObject303 = fights_taggedTemplateLiteral(["abstraction: action"])))))).externalIf(sensation, combat.Macro.if_("monstername Performer of Actions", combat.Macro.tryItem((0,dist.$item)(_templateObject304 || (_templateObject304 = fights_taggedTemplateLiteral(["abstraction: sensation"])))))).basicCombat());
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject305 || (_templateObject305 = fights_taggedTemplateLiteral(["Machine Elf"])));
  }
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject306 || (_templateObject306 = fights_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), -1, "");
}), new FreeFight(function () {
  ...
  nepQuest();
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject307 || (_templateObject307 = fights_taggedTemplateLiteral(["The Neverending Party"]))), combat.Macro.trySkill((0,dist.$skill)(_templateObject308 || (_templateObject308 = fights_taggedTemplateLiteral(["Feel Pride"])))).basicCombat());
  ...
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      forceEquip: (0,dist.have)((0,dist.$item)(_templateObject309 || (_templateObject309 = fights_taggedTemplateLiteral(["January's Garbage Tote"])))) ? (0,dist.$items)(_templateObject310 || (_templateObject310 = fights_taggedTemplateLiteral(["makeshift garbage shirt"]))) : []
    })];
  }
}), // Get a li'l ninja costume for 150% item drop
new FreeFight(function () {
  return !(0,dist.have)((0,dist.$item)(_templateObject311 || (_templateObject311 = fights_taggedTemplateLiteral(["li'l ninja costume"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject312 || (_templateObject312 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject313 || (_templateObject313 = fights_taggedTemplateLiteral(["The Jokester's gun"])))) && (0,lib/* questStep */.cL)("questL08Trapper") >= 2;
}, function () {
  return (0,dist.adventureMacro)((0,dist.$location)(_templateObject314 || (_templateObject314 = fights_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))), combat.Macro.skill((0,dist.$skill)(_templateObject315 || (_templateObject315 = fights_taggedTemplateLiteral(["Fire the Jokester's Gun"])))).abort());
}, {
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      forceEquip: (0,dist.$items)(_templateObject316 || (_templateObject316 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })];
  }
}), // Fallback for li'l ninja costume if Lair of the Ninja Snowmen is unavailable
new FreeFight(function () {
  return !(0,dist.have)((0,dist.$item)(_templateObject317 || (_templateObject317 = fights_taggedTemplateLiteral(["li'l ninja costume"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject318 || (_templateObject318 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject319 || (_templateObject319 = fights_taggedTemplateLiteral(["The Jokester's gun"])))) && (0,dist.have)((0,dist.$skill)(_templateObject320 || (_templateObject320 = fights_taggedTemplateLiteral(["Comprehensive Cartography"])))) && (0,dist.get)("_monstersMapped") < 3;
}, function () {
  try {
    combat.Macro.skill((0,dist.$skill)(_templateObject321 || (_templateObject321 = fights_taggedTemplateLiteral(["Fire the Jokester's Gun"])))).abort().setAutoAttack();
    (0,lib/* mapMonster */.dU)((0,dist.$location)(_templateObject322 || (_templateObject322 = fights_taggedTemplateLiteral(["The Haiku Dungeon"]))), (0,dist.$monster)(_templateObject323 || (_templateObject323 = fights_taggedTemplateLiteral(["amateur ninja"]))));
  } finally {
...
new FreeRunFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject325 || (_templateObject325 = fights_taggedTemplateLiteral(["latte lovers member's mug"])))) && !(0,dist.get)("latteUnlocks").includes("cajun") && (0,lib/* questStep */.cL)("questL11MacGuffin") > -1;
}, function (runSource) {
  ...
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject326 || (_templateObject326 = fights_taggedTemplateLiteral(["The Black Forest"]))), runSource.macro);
}, {
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
  ...
  return (0,dist.have)((0,dist.$item)(_templateObject328 || (_templateObject328 = fights_taggedTemplateLiteral(["latte lovers member's mug"])))) && !(0,dist.get)("latteUnlocks").includes("rawhide") && (0,lib/* questStep */.cL)("questL02Larva") > -1;
}, function (runSource) {
  ...
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject329 || (_templateObject329 = fights_taggedTemplateLiteral(["The Spooky Forest"]))), runSource.macro);
}, {
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      forceEquip: (0,dist.$items)(_templateObject330 || (_templateObject330 = fights_taggedTemplateLiteral(["latte lovers member's mug"])))
    })];
  }
}), new FreeRunFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject331 || (_templateObject331 = fights_taggedTemplateLiteral(["latte lovers member's mug"])))) && !(0,dist.get)("latteUnlocks").includes("carrot") && (0,dist.get)("latteUnlocks").includes("cajun") && (0,dist.get)("latteUnlocks").includes("rawhide");
}, function (runSource) {
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject332 || (_templateObject332 = fights_taggedTemplateLiteral(["The Dire Warren"]))), runSource.macro);
}, {
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      forceEquip: (0,dist.$items)(_templateObject333 || (_templateObject333 = fights_taggedTemplateLiteral(["latte lovers member's mug"])))
    })];
  }
}), new FreeRunFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject334 || (_templateObject334 = fights_taggedTemplateLiteral(["Space Jellyfish"])))) && (0,dist.have)((0,dist.$skill)(_templateObject335 || (_templateObject335 = fights_taggedTemplateLiteral(["Meteor Lore"])))) && (0,dist.get)("_macrometeoriteUses") < 10;
}, function (runSource) {
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject336 || (_templateObject336 = fights_taggedTemplateLiteral(["Barf Mountain"]))), combat.Macro.while_("!pastround 28 && hasskill macrometeorite", combat.Macro.skill((0,dist.$skill)(_templateObject337 || (_templateObject337 = fights_taggedTemplateLiteral(["Extract Jelly"])))).skill((0,dist.$skill)(_templateObject338 || (_templateObject338 = fights_taggedTemplateLiteral(["Macrometeorite"]))))).trySkill((0,dist.$skill)(_templateObject339 || (_templateObject339 = fights_taggedTemplateLiteral(["Extract Jelly"])))).step(runSource.macro));
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject340 || (_templateObject340 = fights_taggedTemplateLiteral(["Space Jellyfish"])));
  }
}), new FreeRunFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject341 || (_templateObject341 = fights_taggedTemplateLiteral(["Space Jellyfish"])))) && (0,dist.have)((0,dist.$item)(_templateObject342 || (_templateObject342 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") < 91;
}, function (runSource) {
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject343 || (_templateObject343 = fights_taggedTemplateLiteral(["Barf Mountain"]))), combat.Macro.while_("!pastround 28 && hasskill CHEAT CODE: Replace Enemy", combat.Macro.skill((0,dist.$skill)(_templateObject344 || (_templateObject344 = fights_taggedTemplateLiteral(["Extract Jelly"])))).skill((0,dist.$skill)(_templateObject345 || (_templateObject345 = fights_taggedTemplateLiteral(["CHEAT CODE: Replace Enemy"]))))).trySkill((0,dist.$skill)(_templateObject346 || (_templateObject346 = fights_taggedTemplateLiteral(["Extract Jelly"])))).step(runSource.macro));
}, {
  familiar: function familiar() {
  ...
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      forceEquip: (0,dist.$items)(_templateObject348 || (_templateObject348 = fights_taggedTemplateLiteral(["Powerful Glove"])))
    })];
  }
}), new FreeFight(function () {
  ...
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject350 || (_templateObject350 = fights_taggedTemplateLiteral(["Gingerbread Civic Center"]))), runSource.macro);
  ...
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject351 || (_templateObject351 = fights_taggedTemplateLiteral(["Gingerbread Train Station"]))), combat.Macro.abort());
}), new FreeRunFight(function () {
  return ((0,dist.get)("gingerbreadCityAvailable") || (0,dist.get)("_gingerbreadCityToday")) && (0,dist.get)("_gingerbreadCityTurns") + ((0,dist.get)("_gingerbreadClockAdvanced") ? 5 : 0) >= 10 && (0,dist.get)("_gingerbreadCityTurns") + ((0,dist.get)("_gingerbreadClockAdvanced") ? 5 : 0) < 19 && (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject352 || (_templateObject352 = fights_taggedTemplateLiteral(["sprinkles"])))) > 5;
}, function (runSource) {
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject353 || (_templateObject353 = fights_taggedTemplateLiteral(["Gingerbread Civic Center"]))), runSource.macro);

  if (["Even Tamer Than Usual", "Never Break the Chain", "Close, but Yes Cigar", "Armchair Quarterback"].includes((0,dist.get)("lastEncounter"))) {
    (0,dist.set)("_gingerbreadCityTurns", 1 + (0,dist.get)("_gingerbreadCityTurns"));
  }
}), new FreeFight(function () {
  return ((0,dist.get)("gingerbreadCityAvailable") || (0,dist.get)("_gingerbreadCityToday")) && (0,dist.get)("_gingerbreadCityTurns") + ((0,dist.get)("_gingerbreadClockAdvanced") ? 5 : 0) === 19 && (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject354 || (_templateObject354 = fights_taggedTemplateLiteral(["sprinkles"])))) > 5;
}, function () {
  lib/* propertyManager.setChoices */.kr.setChoices({
    1203: 4 // Gingerbread Civic Center 5 gingerbread cigarettes

  });
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject355 || (_templateObject355 = fights_taggedTemplateLiteral(["Gingerbread Civic Center"]))), combat.Macro.abort());
}), // Try for mini-hipster\goth kid free fights with any remaining non-familiar free runs
new FreeRunFight(function () {
  return (0,dist.get)("_hipsterAdv") < 7 && ((0,dist.have)((0,dist.$familiar)(_templateObject356 || (_templateObject356 = fights_taggedTemplateLiteral(["Mini-Hipster"])))) || (0,dist.have)((0,dist.$familiar)(_templateObject357 || (_templateObject357 = fights_taggedTemplateLiteral(["Artistic Goth Kid"])))));
}, function (runSource) {
  ...
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject358 || (_templateObject358 = fights_taggedTemplateLiteral(["Mini-Hipster"])))) ? (0,dist.$familiar)(_templateObject359 || (_templateObject359 = fights_taggedTemplateLiteral(["Mini-Hipster"]))) : (0,dist.$familiar)(_templateObject360 || (_templateObject360 = fights_taggedTemplateLiteral(["Artistic Goth Kid"])));
  },
  requirements: function requirements() {
    return [new lib/* Requirement */.nb([], {
      bonusEquip: new Map((0,dist.have)((0,dist.$familiar)(_templateObject361 || (_templateObject361 = fights_taggedTemplateLiteral(["Mini-Hipster"])))) ? [[(0,dist.$item)(_templateObject362 || (_templateObject362 = fights_taggedTemplateLiteral(["ironic moustache"]))), (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject363 || (_templateObject363 = fights_taggedTemplateLiteral(["mole skin notebook"]))))], [(0,dist.$item)(_templateObject364 || (_templateObject364 = fights_taggedTemplateLiteral(["chiptune guitar"]))), (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject365 || (_templateObject365 = fights_taggedTemplateLiteral(["ironic knit cap"]))))], [(0,dist.$item)(_templateObject366 || (_templateObject366 = fights_taggedTemplateLiteral(["fixed-gear bicycle"]))), (0,lib/* saleValue */.L0)((0,dist.$item)(_templateObject367 || (_templateObject367 = fights_taggedTemplateLiteral(["ironic oversized sunglasses"]))))]] : [])
    })];
  }
})];
var freeKillSources = [new FreeFight(function () {
  return !(0,dist.get)("_gingerbreadMobHitUsed") && (0,dist.have)((0,dist.$skill)(_templateObject368 || (_templateObject368 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject369 || (_templateObject369 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject370 || (_templateObject370 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"])))), function () {
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject372 || (_templateObject372 = fights_taggedTemplateLiteral(["Shattering Punch"])))) ? (0,lib/* clamp */.uZ)(3 - (0,dist.get)("_shatteringPunchUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject373 || (_templateObject373 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject374 || (_templateObject374 = fights_taggedTemplateLiteral(["Shattering Punch"])))), function () {
...
new FreeFight(function () {
  return !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject376 || (_templateObject376 = fights_taggedTemplateLiteral(["The Jokester's gun"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject377 || (_templateObject377 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject378 || (_templateObject378 = fights_taggedTemplateLiteral(["Fire the Jokester's Gun"])))), function () {
  ...
  requirements: function requirements() {
    return [new lib/* Requirement */.nb(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject380 || (_templateObject380 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })];
  }
}), // 22	3	0	0	Chest X-Ray	combat skill	must have a Lil' Doctor™ bag equipped
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject381 || (_templateObject381 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? (0,lib/* clamp */.uZ)(3 - (0,dist.get)("_chestXRayUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject382 || (_templateObject382 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject383 || (_templateObject383 = fights_taggedTemplateLiteral(["Chest X-Ray"])))), function () {
  ...
  requirements: function requirements() {
    return [new lib/* Requirement */.nb(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject385 || (_templateObject385 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject386 || (_templateObject386 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))) ? (0,lib/* clamp */.uZ)(3 - (0,dist.get)("_usedReplicaBatoomerang"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject387 || (_templateObject387 = fights_taggedTemplateLiteral(["Sing Along"])))).item((0,dist.$item)(_templateObject388 || (_templateObject388 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))), function () {
  ...
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject390 || (_templateObject390 = fights_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(_templateObject391 || (_templateObject391 = fights_taggedTemplateLiteral(["Asdon Martin: Missile Launcher"])))), function () {
  ...
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject393 || (_templateObject393 = fights_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(_templateObject394 || (_templateObject394 = fights_taggedTemplateLiteral(["Shocking Lick"])))), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject395 || (_templateObject395 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
function freeFights() {
  ...
  var stashRun = (0,external_kolmafia_.stashAmount)((0,dist.$item)(_templateObject396 || (_templateObject396 = fights_taggedTemplateLiteral(["navel ring of navel gazing"])))) ? (0,dist.$items)(_templateObject397 || (_templateObject397 = fights_taggedTemplateLiteral(["navel ring of navel gazing"]))) : (0,external_kolmafia_.stashAmount)((0,dist.$item)(_templateObject398 || (_templateObject398 = fights_taggedTemplateLiteral(["Greatest American Pants"])))) ? (0,dist.$items)(_templateObject399 || (_templateObject399 = fights_taggedTemplateLiteral(["Greatest American Pants"]))) : [];
  (0,external_kolmafia_.refreshStash)();
  ...
  try {
    ...
    try {
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
        ...
        if (freeKillSource.available()) {
          ...
          (0,lib/* ensureEffect */.pq)((0,dist.$effect)(_templateObject400 || (_templateObject400 = fights_taggedTemplateLiteral(["Feeling Lost"]))));

          if ((0,dist.have)((0,dist.$skill)(_templateObject401 || (_templateObject401 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"])))) && !(0,dist.get)("_steelyEyedSquintUsed")) {
            (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject402 || (_templateObject402 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"]))));
          }
        }
    ...
    if ((0,dist.have)((0,dist.$item)(_templateObject403 || (_templateObject403 = fights_taggedTemplateLiteral(["January's Garbage Tote"]))))) (0,external_kolmafia_.cliExecute)("fold wad of used tape");
  }
}
...
function thesisReady() {
  return !(0,dist.get)("_thesisDelivered") && (0,dist.have)((0,dist.$familiar)(_templateObject404 || (_templateObject404 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject405 || (_templateObject405 = fights_taggedTemplateLiteral(["Pocket Professor"]))).experience >= 400;
}
...
function deliverThesis() {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject406 || (_templateObject406 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
  freeFightMood().execute();
  freeFightOutfit([new lib/* Requirement */.nb(["100 muscle"], {})]);
  safeRestore();

  if ((0,dist.have)((0,dist.$item)(_templateObject407 || (_templateObject407 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject408 || (_templateObject408 = fights_taggedTemplateLiteral(["Triple-Sized"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") <= 95) {
    (0,external_kolmafia_.cliExecute)("checkpoint");
    (0,external_kolmafia_.equip)((0,dist.$slot)(_templateObject409 || (_templateObject409 = fights_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject410 || (_templateObject410 = fights_taggedTemplateLiteral(["Powerful Glove"]))));
    (0,lib/* ensureEffect */.pq)((0,dist.$effect)(_templateObject411 || (_templateObject411 = fights_taggedTemplateLiteral(["Triple-Sized"]))));
    (0,external_kolmafia_.outfit)("checkpoint");
  }

  (0,external_kolmafia_.cliExecute)("gain 1800 muscle");
  (0,dist.adventureMacro)(thesisInNEP ? (0,dist.$location)(_templateObject412 || (_templateObject412 = fights_taggedTemplateLiteral(["The Neverending Party"]))) : (0,dist.$location)(_templateObject413 || (_templateObject413 = fights_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), combat.Macro.skill((0,dist.$skill)(_templateObject414 || (_templateObject414 = fights_taggedTemplateLiteral(["deliver your thesis!"])))));
}
...
function safeRestore() {
  ...
  if ((0,external_kolmafia_.myMp)() < 50 && (0,external_kolmafia_.myMaxmp)() > 50) {
    if (((0,dist.have)((0,dist.$item)(_templateObject415 || (_templateObject415 = fights_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(_templateObject416 || (_templateObject416 = fights_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject417 || (_templateObject417 = fights_taggedTemplateLiteral(["magical sausage"]))));
    }
...
function doSausage() {
  ...
  freeFightOutfit([new lib/* Requirement */.nb([], {
    forceEquip: (0,dist.$items)(_templateObject418 || (_templateObject418 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
  })]);
