...
var familiar_templateObject, _templateObject2, _templateObject3, _templateObject4, _templateObject5, _templateObject6, _templateObject7, _templateObject8, _templateObject9, _templateObject10, _templateObject11, _templateObject12, _templateObject13, _templateObject14, _templateObject15, _templateObject16, _templateObject17, _templateObject18, _templateObject19, _templateObject20, _templateObject21, _templateObject22, _templateObject23, _templateObject24, _templateObject25, _templateObject26, _templateObject27, _templateObject28, _templateObject29, _templateObject30;
...
function meatFamiliar() {
  if (!_meatFamiliar) {
    if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)() && (0,dist.have)((0,dist.$familiar)(familiar_templateObject || (familiar_templateObject = familiar_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && (0,dist.have)((0,dist.$item)(_templateObject2 || (_templateObject2 = familiar_taggedTemplateLiteral(["li'l pirate costume"]))))) {
      ...
      var bestLeps = Familiar.all().filter(dist.have).sort(function (a, b) {
        return (0,external_kolmafia_.numericModifier)(b, "Leprechaun", 1, (0,dist.$item)(_templateObject4 || (_templateObject4 = familiar_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Leprechaun", 1, (0,dist.$item)(_templateObject5 || (_templateObject5 = familiar_taggedTemplateLiteral(["none"]))));
      });
      var bestLepMult = (0,external_kolmafia_.numericModifier)(bestLeps[0], "Leprechaun", 1, (0,dist.$item)(_templateObject6 || (_templateObject6 = familiar_taggedTemplateLiteral(["none"]))));
      _meatFamiliar = bestLeps.filter(function (familiar) {
        return (0,external_kolmafia_.numericModifier)(familiar, "Leprechaun", 1, (0,dist.$item)(_templateObject7 || (_templateObject7 = familiar_taggedTemplateLiteral(["none"])))) === bestLepMult;
      }).sort(function (a, b) {
        return (0,external_kolmafia_.numericModifier)(b, "Fairy", 1, (0,dist.$item)(_templateObject8 || (_templateObject8 = familiar_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Fairy", 1, (0,dist.$item)(_templateObject9 || (_templateObject9 = familiar_taggedTemplateLiteral(["none"]))));
      })[0];
    }
  }
...
var rotatingFamiliars = {
  "Fist Turkey": {
    ...
    drop: (0,dist.$item)(_templateObject10 || (_templateObject10 = familiar_taggedTemplateLiteral(["Ambitious Turkey"]))),
    pref: "_turkeyBooze"
  },
  "Llama Lama": {
    expected: [3.42, 3.91, 4.52, 5.29, 5.29],
    drop: (0,dist.$item)(_templateObject11 || (_templateObject11 = familiar_taggedTemplateLiteral(["llama lama gong"]))),
    pref: "_gongDrops"
  },
  "Li'l Xenomorph": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject12 || (_templateObject12 = familiar_taggedTemplateLiteral(["transporter transponder"]))),
    pref: "_transponderDrops"
  },
  "Rogue Program": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject13 || (_templateObject13 = familiar_taggedTemplateLiteral(["Game Grid token"]))),
    pref: "_tokenDrops"
  },
  "Bloovian Groose": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject14 || (_templateObject14 = familiar_taggedTemplateLiteral(["groose grease"]))),
    pref: "_grooseDrops"
  },
  "Baby Sandworm": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject15 || (_templateObject15 = familiar_taggedTemplateLiteral(["agua de vida"]))),
    pref: "_aguaDrops"
  },
  "Green Pixie": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject16 || (_templateObject16 = familiar_taggedTemplateLiteral(["tiny bottle of absinthe"]))),
    pref: "_absintheDrops"
  },
  "Blavious Kloop": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject17 || (_templateObject17 = familiar_taggedTemplateLiteral(["devilish folio"]))),
    pref: "_kloopDrops"
  },
  "Galloping Grill": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(_templateObject18 || (_templateObject18 = familiar_taggedTemplateLiteral(["hot ashes"]))),
    pref: "_hotAshesDrops"
  }
};
...
function freeFightFamiliar() {
  ...
  if ((0,dist.have)((0,dist.$familiar)(_templateObject20 || (_templateObject20 = familiar_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject21 || (_templateObject21 = familiar_taggedTemplateLiteral(["Pocket Professor"]))).experience < 400 && !(0,dist.get)("_thesisDelivered")) {
    // Estimate based on value to charge thesis.
    familiarValue.push([(0,dist.$familiar)(_templateObject22 || (_templateObject22 = familiar_taggedTemplateLiteral(["Pocket Professor"]))), 3000]);
  }
  ...
  if ((0,dist.have)((0,dist.$familiar)(_templateObject23 || (_templateObject23 = familiar_taggedTemplateLiteral(["Stocking Mimic"]))))) {
    var mimicWeight = myFamiliarWeight((0,dist.$familiar)(_templateObject24 || (_templateObject24 = familiar_taggedTemplateLiteral(["Stocking Mimic"]))));
    var actionPercentage = 1 / 3 + ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(_templateObject25 || (_templateObject25 = familiar_taggedTemplateLiteral(["Jingle Jangle Jingle"])))) ? 0.1 : 0);
    var mimicValue = mimicDropValue() + mimicWeight * actionPercentage * 1 / 4 * 10 * 4 * 1.2;
    familiarValue.push([(0,dist.$familiar)(_templateObject26 || (_templateObject26 = familiar_taggedTemplateLiteral(["Stocking Mimic"]))), mimicValue]);
  }

  if ((0,external_kolmafia_.haveFamiliar)((0,dist.$familiar)(_templateObject27 || (_templateObject27 = familiar_taggedTemplateLiteral(["Robortender"]))))) familiarValue.push([(0,dist.$familiar)(_templateObject28 || (_templateObject28 = familiar_taggedTemplateLiteral(["Robortender"]))), 200]);

  var _iterator = _createForOfIteratorHelper((0,dist.$familiars)(_templateObject30 || (_templateObject30 = familiar_taggedTemplateLiteral(["Hobo Monkey, Cat Burglar, Urchin Urchin, Leprechaun"])))),
      _step;
  ...
  familiarValue.push([(0,dist.$familiar)(_templateObject29 || (_templateObject29 = familiar_taggedTemplateLiteral(["none"]))), 0]);
...
function freeFightOutfit() {
  ...
  var bjornChoice = (0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(outfit_templateObject2 || (outfit_templateObject2 = outfit_taggedTemplateLiteral(["Machine Elf"]))) ? pickBjorn(PickBjornMode.DMT) : pickBjorn(PickBjornMode.FREE);
  var compiledRequirements = Requirement.merge([].concat(outfit_toConsumableArray(requirements), [new Requirement((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(outfit_templateObject3 || (outfit_templateObject3 = outfit_taggedTemplateLiteral(["Pocket Professor"]))) ? ["Familiar Experience"] : ["Familiar Weight"], {
    bonusEquip: new Map([[(0,dist.$item)(outfit_templateObject4 || (outfit_templateObject4 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(outfit_templateObject5 || (outfit_templateObject5 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(outfit_templateObject6 || (outfit_templateObject6 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(outfit_templateObject7 || (outfit_templateObject7 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180]].concat(outfit_toConsumableArray(pantsgiving()), outfit_toConsumableArray(cheeses(false))))
  })]));
  var bjornAlike = (0,dist.have)((0,dist.$item)(outfit_templateObject8 || (outfit_templateObject8 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) && !(compiledRequirements.maximizeOptions_.forceEquip && compiledRequirements.maximizeOptions_.forceEquip.some(function (equipment) {
    return (0,external_kolmafia_.toSlot)(equipment) === (0,dist.$slot)(outfit_templateObject9 || (outfit_templateObject9 = outfit_taggedTemplateLiteral(["back"])));
  })) ? (0,dist.$item)(outfit_templateObject10 || (outfit_templateObject10 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) : (0,dist.$item)(outfit_templateObject11 || (outfit_templateObject11 = outfit_taggedTemplateLiteral(["Crown of Thrones"])));
  var finalRequirements = compiledRequirements.merge(new Requirement([], {
    ...
    preventEquip: bjornAlike === (0,dist.$item)(outfit_templateObject12 || (outfit_templateObject12 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) ? (0,dist.$items)(outfit_templateObject13 || (outfit_templateObject13 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) : (0,dist.$items)(outfit_templateObject14 || (outfit_templateObject14 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))
  }));
...
function meatOutfit(embezzlerUp) {
  ...
  if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) {
    forceEquip.push((0,dist.$item)(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))));
  } else if (!embezzlerUp) {
    if ((0,dist.getKramcoWandererChance)() > 0.05 && (0,dist.have)((0,dist.$item)(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      forceEquip.push((0,dist.$item)(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
    } // TODO: Fix pointer finger ring construction.


    if ((0,external_kolmafia_.myClass)() !== (0,dist.$class)(outfit_templateObject20 || (outfit_templateObject20 = outfit_taggedTemplateLiteral(["Seal Clubber"])))) {
      if ((0,dist.have)((0,dist.$item)(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["haiku katana"]))))) {
        forceEquip.push((0,dist.$item)(outfit_templateObject22 || (outfit_templateObject22 = outfit_taggedTemplateLiteral(["haiku katana"]))));
      } else if ((0,dist.have)((0,dist.$item)(outfit_templateObject23 || (outfit_templateObject23 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) {
        if (!(0,dist.have)((0,dist.$item)(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["ice nine"]))))) (0,external_kolmafia_.retrieveItem)((0,dist.$item)(outfit_templateObject25 || (outfit_templateObject25 = outfit_taggedTemplateLiteral(["ice nine"]))));
        forceEquip.push((0,dist.$item)(outfit_templateObject26 || (outfit_templateObject26 = outfit_taggedTemplateLiteral(["ice nine"]))));
      }
    }

    if ((0,dist.have)((0,dist.$item)(outfit_templateObject27 || (outfit_templateObject27 = outfit_taggedTemplateLiteral(["protonic accelerator pack"])))) && (0,dist.get)("questPAGhost") === "unstarted" && (0,dist.get)("nextParanormalActivity") <= (0,external_kolmafia_.totalTurnsPlayed)() && !forceEquip.includes((0,dist.$item)(outfit_templateObject28 || (outfit_templateObject28 = outfit_taggedTemplateLiteral(["ice nine"]))))) {
      forceEquip.push((0,dist.$item)(outfit_templateObject29 || (outfit_templateObject29 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));
    }
  ...
  if ((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(_templateObject31 || (_templateObject31 = outfit_taggedTemplateLiteral(["Obtuse Angel"])))) {
    forceEquip.push((0,dist.$item)(_templateObject32 || (_templateObject32 = outfit_taggedTemplateLiteral(["quake of arrows"]))));
    if (!(0,dist.have)((0,dist.$item)(_templateObject33 || (_templateObject33 = outfit_taggedTemplateLiteral(["quake of arrows"]))))) (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject34 || (_templateObject34 = outfit_taggedTemplateLiteral(["quake of arrows"]))));
  }
  ...
  var bjornAlike = (0,dist.have)((0,dist.$item)(_templateObject35 || (_templateObject35 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) && !forceEquip.some(function (item) {
    return (0,external_kolmafia_.toSlot)(item) === (0,dist.$slot)(_templateObject36 || (_templateObject36 = outfit_taggedTemplateLiteral(["back"])));
  }) ? (0,dist.$item)(_templateObject37 || (_templateObject37 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) : (0,dist.$item)(_templateObject38 || (_templateObject38 = outfit_taggedTemplateLiteral(["Crown of Thrones"])));
  var compiledRequirements = Requirement.merge([].concat(outfit_toConsumableArray(requirements), [new Requirement(["".concat(((embezzlerUp ? baseMeat + 750 : baseMeat) / 100).toFixed(2), " Meat Drop"), "".concat(embezzlerUp ? 0 : 0.72, " Item Drop")].concat(additionalRequirements), {
    ...
    preventEquip: [].concat(outfit_toConsumableArray((0,dist.$items)(_templateObject39 || (_templateObject39 = outfit_taggedTemplateLiteral(["broken champagne bottle, unwrapped knock-off retro superhero cape"])))), outfit_toConsumableArray(embezzlerUp ? (0,dist.$items)(_templateObject40 || (_templateObject40 = outfit_taggedTemplateLiteral(["cheap sunglasses"]))) : []), [bjornAlike === (0,dist.$item)(_templateObject41 || (_templateObject41 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) ? (0,dist.$item)(_templateObject42 || (_templateObject42 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) : (0,dist.$item)(_templateObject43 || (_templateObject43 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))]),
    bonusEquip: new Map([[(0,dist.$item)(_templateObject44 || (_templateObject44 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(_templateObject45 || (_templateObject45 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))), 300], [(0,dist.$item)(_templateObject46 || (_templateObject46 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(_templateObject47 || (_templateObject47 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(_templateObject48 || (_templateObject48 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180]].concat(outfit_toConsumableArray(embezzlerUp ? [] : pantsgiving()), outfit_toConsumableArray(cheeses(embezzlerUp)), [[bjornAlike, !bjornChoice.dropPredicate || bjornChoice.dropPredicate() ? bjornChoice.meatVal() * bjornChoice.probability : 0]]))
  })]));
  (0,dist.maximizeCached)(compiledRequirements.maximizeParameters(), compiledRequirements.maximizeOptions());

  if ((0,external_kolmafia_.equippedAmount)((0,dist.$item)(_templateObject49 || (_templateObject49 = outfit_taggedTemplateLiteral(["ice nine"])))) > 0) {
    (0,external_kolmafia_.equip)((0,dist.$item)(_templateObject50 || (_templateObject50 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
  }

  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(_templateObject51 || (_templateObject51 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_.bjornifyFamiliar)(bjornChoice.familiar);
  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(_templateObject52 || (_templateObject52 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_.enthroneFamiliar)(bjornChoice.familiar);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if ((0,dist.have)(airSource)) {
            if (airSource === (0,dist.$item)(_templateObject53 || (_templateObject53 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying"])))) (0,external_kolmafia_.cliExecute)("edpiece fish");
...
var waterBreathingEquipment = (0,dist.$items)(_templateObject54 || (_templateObject54 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying, aerated diving helmet, crappy Mer-kin mask, Mer-kin gladiator mask, Mer-kin scholar mask, old SCUBA tank"])));
var familiarWaterBreathingEquipment = (0,dist.$items)(_templateObject55 || (_templateObject55 = outfit_taggedTemplateLiteral(["das boot, little bitty bathysphere"])));

function pantsgiving() {
  if (!(0,dist.have)((0,dist.$item)(_templateObject56 || (_templateObject56 = outfit_taggedTemplateLiteral(["Pantsgiving"]))))) return new Map();
...
var secondChainMacro = function secondChainMacro() {
  return combat.Macro.if_("monstername Knob Goblin Embezzler", combat.Macro.externalIf((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(fights_templateObject5 || (fights_templateObject5 = fights_taggedTemplateLiteral(["Pocket Professor"]))), combat.Macro.if_("!hasskill Lecture on Relativity", combat.Macro.if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(fights_templateObject6 || (fights_templateObject6 = fights_taggedTemplateLiteral(["Meteor Shower"]))))), combat.Macro.step("skill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(fights_templateObject7 || (fights_templateObject7 = fights_taggedTemplateLiteral(["Meteor Shower"])))))))) //fix when libram is updated
  .if_("!hasskill Lecture on Relativity", combat.Macro.externalIf((0,dist.get)("spookyPuttyCopiesMade") < 5, combat.Macro.tryItem((0,dist.$item)(fights_templateObject8 || (fights_templateObject8 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))))).externalIf(!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject9 || (fights_templateObject9 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))), combat.Macro.tryItem((0,dist.$item)(fights_templateObject10 || (fights_templateObject10 = fights_taggedTemplateLiteral(["4-d camera"]))))).externalIf((0,dist.get)("_sourceTerminalDigitizeMonster") !== (0,dist.$monster)(fights_templateObject11 || (fights_templateObject11 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))), combat.Macro.trySkill("Digitize"))).trySkill("Lecture on Relativity")).meatKill()).abort();
};

var embezzlerMacro = function embezzlerMacro() {
  return combat.Macro.if_("monstername Knob Goblin Embezzler", combat.Macro.if_("snarfblat 186", combat.Macro.item((0,dist.$item)(fights_templateObject12 || (fights_templateObject12 = fights_taggedTemplateLiteral(["pulled green taffy"]))))).trySkill("Wink At").trySkill("Fire a badly romantic arrow").externalIf((0,dist.get)("_sourceTerminalDigitizeMonster") !== (0,dist.$monster)(fights_templateObject13 || (fights_templateObject13 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))), combat.Macro.trySkill("Digitize")).externalIf((0,dist.get)("spookyPuttyCopiesMade") < 5, combat.Macro.tryItem((0,dist.$item)(fights_templateObject14 || (fights_templateObject14 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))))).externalIf(!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject15 || (fights_templateObject15 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))), combat.Macro.tryItem((0,dist.$item)(fights_templateObject16 || (fights_templateObject16 = fights_taggedTemplateLiteral(["4-d camera"]))))).meatKill()).abort();
};

var embezzlerSources = [new EmbezzlerFight("Digitize", function () {
  return (0,dist.get)("_sourceTerminalDigitizeMonster") === (0,dist.$monster)(fights_templateObject17 || (fights_templateObject17 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,external_kolmafia_.getCounters)("Digitize Monster", 0, 0).trim() !== "";
}, function () {
  return dist.SourceTerminal.have() && (0,dist.get)("_sourceTerminalDigitizeUses") === 0 ? 1 : 0;
}, function (options) {
  (0,external_kolmafia_.adv1)(options.location || (0,dist.$location)(fights_templateObject18 || (fights_templateObject18 = fights_taggedTemplateLiteral(["Noob Cave"]))));
}, [], true), new EmbezzlerFight("Backup", function () {
  return (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(fights_templateObject19 || (fights_templateObject19 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,dist.have)((0,dist.$item)(fights_templateObject20 || (fights_templateObject20 = fights_taggedTemplateLiteral(["backup camera"])))) && (0,dist.get)("_backUpUses") < 11;
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject21 || (fights_templateObject21 = fights_taggedTemplateLiteral(["backup camera"])))) ? 11 - (0,dist.get)("_backUpUses") : 0;
}, function (options) {
  var realLocation = options.location && options.location.combatPercent >= 100 ? options.location : (0,dist.$location)(fights_templateObject22 || (fights_templateObject22 = fights_taggedTemplateLiteral(["Noob Cave"])));
  ...
  forceEquip: (0,dist.$items)(fights_templateObject23 || (fights_templateObject23 = fights_taggedTemplateLiteral(["backup camera"]))),
  bonusEquip: new Map([[(0,dist.$item)(fights_templateObject24 || (fights_templateObject24 = fights_taggedTemplateLiteral(["backup camera"]))), 5000]])
})], true), new EmbezzlerFight("Fax", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject25 || (fights_templateObject25 = fights_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject26 || (fights_templateObject26 = fights_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed") ? 1 : 0;
}, function () {
  faxEmbezzler();
  (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject27 || (fights_templateObject27 = fights_taggedTemplateLiteral(["photocopied monster"]))));
}), new EmbezzlerFight("Pillkeeper Semirare", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject28 || (fights_templateObject28 = fights_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(fights_templateObject29 || (fights_templateObject29 = fights_taggedTemplateLiteral(["Cobb's Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject30 || (fights_templateObject30 = fights_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(fights_templateObject31 || (fights_templateObject31 = fights_taggedTemplateLiteral(["Cobb's Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed") ? 1 : 0;
}, function () {
  (0,external_kolmafia_.cliExecute)("pillkeeper semirare");
  (0,external_kolmafia_.adv1)((0,dist.$location)(fights_templateObject32 || (fights_templateObject32 = fights_taggedTemplateLiteral(["Cobb's Knob Treasury"]))));
}), new EmbezzlerFight("Chateau Painting", function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(fights_templateObject33 || (fights_templateObject33 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(fights_templateObject34 || (fights_templateObject34 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) ? 1 : 0;
}, function () {
  return dist.ChateauMantegna.fightPainting();
}), new EmbezzlerFight("Spooky Putty", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject35 || (fights_templateObject35 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) && (0,dist.get)("spookyPuttyMonster") === (0,dist.$monster)(fights_templateObject36 || (fights_templateObject36 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  if ((0,dist.have)((0,dist.$item)(fights_templateObject37 || (fights_templateObject37 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))))) {
    return 5 - (0,dist.get)("spookyPuttyCopiesMade");
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject38 || (fights_templateObject38 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) && (0,dist.get)("spookyPuttyMonster") === (0,dist.$monster)(fights_templateObject39 || (fights_templateObject39 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])))) {
    return 6 - (0,dist.get)("spookyPuttyCopiesMade");
  }

  return 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject40 || (fights_templateObject40 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))));
}), new EmbezzlerFight("4-d Camera", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject41 || (fights_templateObject41 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(fights_templateObject42 || (fights_templateObject42 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject43 || (fights_templateObject43 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(fights_templateObject44 || (fights_templateObject44 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject45 || (fights_templateObject45 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))));
}), new EmbezzlerFight("Green Taffy", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject46 || (fights_templateObject46 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(fights_templateObject47 || (fights_templateObject47 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject48 || (fights_templateObject48 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(fights_templateObject49 || (fights_templateObject49 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject50 || (fights_templateObject50 = fights_taggedTemplateLiteral(["envyfish egg"]))));
}), new EmbezzlerFight("Professor MeatChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(fights_templateObject51 || (fights_templateObject51 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false) ? 10 : 0;
}, function () {
  return;
}), new EmbezzlerFight("Professor WeightChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(fights_templateObject52 || (fights_templateObject52 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false) ? 5 : 0;
}, function () {
  return;
})];
...
function embezzlerSetup() {
  ...
  if ((0,external_kolmafia_.mySpleenUse)() < (0,external_kolmafia_.spleenLimit)() && (0,dist.have)((0,dist.$item)(fights_templateObject54 || (fights_templateObject54 = fights_taggedTemplateLiteral(["body spradium"]))))) {
    ensureEffect((0,dist.$effect)(fights_templateObject55 || (fights_templateObject55 = fights_taggedTemplateLiteral(["Boxing Day Glow"]))));
  }

  freeFightMood().execute(50);
  withStash((0,dist.$items)(fights_templateObject56 || (fights_templateObject56 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))), function () {
    if ((0,dist.have)((0,dist.$item)(fights_templateObject57 || (fights_templateObject57 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject58 || (fights_templateObject58 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))));
    }
  });
  if ((0,dist.have)((0,dist.$item)(fights_templateObject59 || (fights_templateObject59 = fights_taggedTemplateLiteral(["License to Chill"])))) && !(0,dist.get)("_licenseToChillUsed")) (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject60 || (fights_templateObject60 = fights_taggedTemplateLiteral(["License to Chill"]))));
  bathroomFinance(embezzlerCount());
  if (dist.SourceTerminal.have()) dist.SourceTerminal.educate([(0,dist.$skill)(fights_templateObject61 || (fights_templateObject61 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject62 || (_templateObject62 = fights_taggedTemplateLiteral(["Digitize"])))]);

  if (!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(_templateObject63 || (_templateObject63 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))))) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject64 || (_templateObject64 = fights_taggedTemplateLiteral(["4-d camera"]))));
  }
}
...
function getEmbezzlerFight() {
  ...
  if (potentials && (0,dist.get)("_genieFightsUsed") < 3 && (0,external_kolmafia_.userConfirm)("Garbo has detected you have potential ways to copy an Embezzler, but no way to start a fight with one. Should we wish for an Embezzler?")) {
    return new EmbezzlerFight("Pocket Wish", function () {
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject65 || (_templateObject65 = fights_taggedTemplateLiteral(["pocket wish"]))));
  ...
  if ((0,external_kolmafia_.getCounters)("Digitize Monster", 0, 100).trim() === "" && (0,dist.get)("_sourceTerminalDigitizeUses") !== 0) {
    do {
      var run = findRun() || new FreeRun(function () {
        return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject67 || (_templateObject67 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
      }, function () {
        return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject68 || (_templateObject68 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
      }, combat.Macro.item("louder than bomb"));
      run.prepare();
      (0,dist.adventureMacro)((0,dist.$location)(_templateObject69 || (_templateObject69 = fights_taggedTemplateLiteral(["Noob Cave"]))), run.macro);
    } while ((0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject66 || (_templateObject66 = fights_taggedTemplateLiteral(["Government agent"]))));
  }
}

var witchessPieces = [{
  piece: (0,dist.$monster)(_templateObject70 || (_templateObject70 = fights_taggedTemplateLiteral(["Witchess Bishop"]))),
  drop: (0,dist.$item)(_templateObject71 || (_templateObject71 = fights_taggedTemplateLiteral(["Sacramento wine"])))
}, {
  piece: (0,dist.$monster)(_templateObject72 || (_templateObject72 = fights_taggedTemplateLiteral(["Witchess Knight"]))),
  drop: (0,dist.$item)(_templateObject73 || (_templateObject73 = fights_taggedTemplateLiteral(["jumping horseradish"])))
}, {
  piece: (0,dist.$monster)(_templateObject74 || (_templateObject74 = fights_taggedTemplateLiteral(["Witchess Pawn"]))),
  drop: (0,dist.$item)(_templateObject75 || (_templateObject75 = fights_taggedTemplateLiteral(["armored prawn"])))
}, {
  piece: (0,dist.$monster)(_templateObject76 || (_templateObject76 = fights_taggedTemplateLiteral(["Witchess Rook"]))),
  drop: (0,dist.$item)(_templateObject77 || (_templateObject77 = fights_taggedTemplateLiteral(["Greek fire"])))
}];
...
function dailyFights() {
  if (embezzlerSources.some(function (source) {
    ...
    withStash((0,dist.$items)(_templateObject78 || (_templateObject78 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))), function () {
      embezzlerSetup(); // FIRST EMBEZZLER CHAIN

      if ((0,dist.have)((0,dist.$familiar)(_templateObject79 || (_templateObject79 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false)) {
        var startLectures = (0,dist.get)("_pocketProfessorLectures");
        var fightSource = getEmbezzlerFight();
        if (!fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject80 || (_templateObject80 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        meatOutfit(true, [].concat(fights_toConsumableArray(fightSource.requirements), [new Requirement([], {
          forceEquip: (0,dist.$items)(_templateObject81 || (_templateObject81 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
        })]));
      ...
      if ((0,dist.have)((0,dist.$familiar)(_templateObject82 || (_templateObject82 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false)) {
        var _startLectures = (0,dist.get)("_pocketProfessorLectures");

        var _fightSource = getEmbezzlerFight();

        if (!_fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject83 || (_templateObject83 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        var requirements = Requirement.merge([new Requirement(["Familiar Weight"], {
          forceEquip: (0,dist.$items)(_templateObject84 || (_templateObject84 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
      ...
      while (nextFight !== null) {
        ...
        if ((0,dist.have)((0,dist.$skill)(_templateObject85 || (_templateObject85 = fights_taggedTemplateLiteral(["Musk of the Moose"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject86 || (_templateObject86 = fights_taggedTemplateLiteral(["Musk of the Moose"]))))) (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject87 || (_templateObject87 = fights_taggedTemplateLiteral(["Musk of the Moose"]))));
        (0,combat.withMacro)(embezzlerMacro(), function () {
          if (nextFight) {
            (0,external_kolmafia_.useFamiliar)(meatFamiliar());

            if (((0,dist.have)((0,dist.$familiar)(_templateObject88 || (_templateObject88 = fights_taggedTemplateLiteral(["Reanimated Reanimator"])))) || (0,dist.have)((0,dist.$familiar)(_templateObject89 || (_templateObject89 = fights_taggedTemplateLiteral(["Obtuse Angel"]))))) && (0,dist.get)("_badlyRomanticArrows") === 0 && !nextFight.draggable) {
              if ((0,dist.have)((0,dist.$familiar)(_templateObject90 || (_templateObject90 = fights_taggedTemplateLiteral(["Obtuse Angel"]))))) (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject91 || (_templateObject91 = fights_taggedTemplateLiteral(["Obtuse Angel"]))));else (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject92 || (_templateObject92 = fights_taggedTemplateLiteral(["Reanimated Reanimator"]))));
            }

            if (nextFight.draggable && !(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || waterBreathingEquipment.some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || familiarWaterBreathingEquipment.some(dist.have)) && ((0,dist.have)((0,dist.$effect)(_templateObject93 || (_templateObject93 = fights_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(_templateObject94 || (_templateObject94 = fights_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(_templateObject95 || (_templateObject95 = fights_taggedTemplateLiteral(["envyfish egg"]))))) {
              (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject96 || (_templateObject96 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
              ...
              (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject97 || (_templateObject97 = fights_taggedTemplateLiteral(["pulled green taffy"]))));
              if (!(0,dist.have)((0,dist.$effect)(_templateObject98 || (_templateObject98 = fights_taggedTemplateLiteral(["Fishy"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject99 || (_templateObject99 = fights_taggedTemplateLiteral(["fishy pipe"]))));
              nextFight.run({
                location: (0,dist.$location)(_templateObject100 || (_templateObject100 = fights_taggedTemplateLiteral(["The Briny Deeps"])))
              });
              ...
              (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject101 || (_templateObject101 = fights_taggedTemplateLiteral(["Noob Cave"]))));
              meatOutfit(true, nextFight.requirements);
              nextFight.run({
                location: (0,dist.$location)(_templateObject102 || (_templateObject102 = fights_taggedTemplateLiteral(["Noob Cave"])))
              });
            }
          }
        });

        if ((0,external_kolmafia_.totalTurnsPlayed)() - startTurns === 1 && (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject103 || (_templateObject103 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (nextFight.name === "Backup" || (0,dist.get)("lastEncounter") === "Knob Goblin Embezzler")) {
...
function bestFairy() {
  if ((0,dist.have)((0,dist.$familiar)(_templateObject104 || (_templateObject104 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && (0,dist.have)((0,dist.$item)(_templateObject105 || (_templateObject105 = fights_taggedTemplateLiteral(["li'l ninja costume"]))))) return (0,dist.$familiar)(_templateObject106 || (_templateObject106 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])));
  if ((0,dist.get)("_cheerleaderSteam") > 100 && (0,dist.have)((0,dist.$familiar)(_templateObject107 || (_templateObject107 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"]))))) return (0,dist.$familiar)(_templateObject108 || (_templateObject108 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"])));

  if (!bestNonCheerleaderFairy) {
    (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject109 || (_templateObject109 = fights_taggedTemplateLiteral(["Noob Cave"]))));
    var bestNonCheerleaderFairies = Familiar.all().filter(function (familiar) {
      return (0,dist.have)(familiar) && familiar !== (0,dist.$familiar)(_templateObject110 || (_templateObject110 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"])));
    }).sort(function (a, b) {
      return (0,external_kolmafia_.numericModifier)(b, "Fairy", 1, (0,dist.$item)(_templateObject111 || (_templateObject111 = fights_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Fairy", 1, (0,dist.$item)(_templateObject112 || (_templateObject112 = fights_taggedTemplateLiteral(["none"]))));
    });
    var bestFairyMult = (0,external_kolmafia_.numericModifier)(bestNonCheerleaderFairies[0], "Fairy", 1, (0,dist.$item)(_templateObject113 || (_templateObject113 = fights_taggedTemplateLiteral(["none"]))));
    bestNonCheerleaderFairy = bestNonCheerleaderFairies.filter(function (fairy) {
      return (0,external_kolmafia_.numericModifier)(fairy, "Fairy", 1, (0,dist.$item)(_templateObject114 || (_templateObject114 = fights_taggedTemplateLiteral(["none"])))) === bestFairyMult;
    }).sort(function (a, b) {
      return (0,external_kolmafia_.numericModifier)(b, "Leprechaun", 1, (0,dist.$item)(_templateObject115 || (_templateObject115 = fights_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Leprechaun", 1, (0,dist.$item)(_templateObject116 || (_templateObject116 = fights_taggedTemplateLiteral(["none"]))));
    })[0];
  }
...
var pygmyMacro = combat.Macro.if_("monstername pygmy bowler", combat.Macro.trySkill("Snokebomb").item((0,dist.$item)(_templateObject117 || (_templateObject117 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))))).if_("monstername pygmy orderlies", combat.Macro.trySkill("Feel Hatred").item((0,dist.$item)(_templateObject118 || (_templateObject118 = fights_taggedTemplateLiteral(["divine champagne popper"]))))).if_("monstername pygmy janitor", combat.Macro.item((0,dist.$item)(_templateObject119 || (_templateObject119 = fights_taggedTemplateLiteral(["tennis ball"]))))).if_("monstername time-spinner prank", combat.Macro.meatKill()).abort();
var freeFightSources = [// Get a Fish Head from our robortender if available
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject120 || (_templateObject120 = fights_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject121 || (_templateObject121 = fights_taggedTemplateLiteral(["Robortender"])))) && !(0,dist.get)("_cargoPocketEmptied") && String((0,dist.get)("cargoPocketsEmptied", "")).indexOf("428") === -1;
}, function () {
  return (0,external_kolmafia_.cliExecute)("cargo monster Mob Penguin Thug");
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject122 || (_templateObject122 = fights_taggedTemplateLiteral(["Robortender"])));
  }
}), new FreeFight(function () {
  ...
  var haveEldritchEssence = (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject123 || (_templateObject123 = fights_taggedTemplateLiteral(["eldritch essence"])))) !== 0;
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject124 || (_templateObject124 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"])))) && !(0,dist.get)("_eldritchHorrorEvoked");
}, function () {
  return (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject125 || (_templateObject125 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
}), new FreeFight(function () {
  return clamp(3 - (0,dist.get)("_lynyrdSnareUses"), 0, 3);
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject126 || (_templateObject126 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject127 || (_templateObject127 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject128 || (_templateObject128 = fights_taggedTemplateLiteral(["[glitch season reward name]"])))) && !(0,dist.get)("_glitchMonsterFights");
}, function () {
...
new FreeFight(function () {
  var maxSeals = (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject129 || (_templateObject129 = fights_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) ? 10 : 5;
  var maxSealsAvailable = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? maxSeals : Math.min(maxSeals, Math.floor((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject130 || (_templateObject130 = fights_taggedTemplateLiteral(["seal-blubber candle"])))) / 3));
  return (0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject131 || (_templateObject131 = fights_taggedTemplateLiteral(["Seal Clubber"]))) ? Math.max(maxSealsAvailable - (0,dist.get)("_sealsSummoned"), 0) : 0;
}, function () {
  var figurine = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? (0,dist.$item)(_templateObject132 || (_templateObject132 = fights_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))) : (0,dist.$item)(_templateObject133 || (_templateObject133 = fights_taggedTemplateLiteral(["figurine of an ancient seal"])));
  (0,external_kolmafia_.retrieveItem)(1, figurine);
  (0,external_kolmafia_.retrieveItem)((0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? 1 : 3, (0,dist.$item)(_templateObject134 || (_templateObject134 = fights_taggedTemplateLiteral(["seal-blubber candle"]))));
  ...
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject135 || (_templateObject135 = fights_taggedTemplateLiteral(["BRICKO ooze"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject136 || (_templateObject136 = fights_taggedTemplateLiteral(["BRICKO eye brick"])))) + 2 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject137 || (_templateObject137 = fights_taggedTemplateLiteral(["BRICKO brick"]))));
  }
}), //Initial 9 Pygmy fights
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" ? clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9) : 0;
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject138 || (_templateObject138 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject139 || (_templateObject139 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)(clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9), (0,dist.$item)(_templateObject140 || (_templateObject140 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject141 || (_templateObject141 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject142 || (_templateObject142 = fights_taggedTemplateLiteral(["tennis ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject143 || (_templateObject143 = fights_taggedTemplateLiteral(["divine champagne popper"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject144 || (_templateObject144 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject147 || (_templateObject147 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject148 || (_templateObject148 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject149 || (_templateObject149 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
        return (0,dist.have)(item);
      })
    })];
  }
...
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("_drunkPygmyBanishes") === 10 && !(0,dist.have)((0,dist.$item)(_templateObject150 || (_templateObject150 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject151 || (_templateObject151 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject152 || (_templateObject152 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject153 || (_templateObject153 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject154 || (_templateObject154 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
}), //11th+ pygmy fight if we have a saber- saber friends
new FreeFight(function () {
  var rightTime = (0,dist.have)((0,dist.$item)(_templateObject155 || (_templateObject155 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) && (0,dist.get)("_drunkPygmyBanishes") >= 10;
  var saberedMonster = (0,dist.get)("_saberForceMonster");
  var wrongPygmySabered = saberedMonster && (0,dist.$monsters)(_templateObject156 || (_templateObject156 = fights_taggedTemplateLiteral(["pygmy orderlies, pygmy bowler, pygmy janitor"]))).includes(saberedMonster);
  var drunksCanAppear = (0,dist.get)("_drunkPygmyBanishes") === 10 || saberedMonster === (0,dist.$monster)(_templateObject157 || (_templateObject157 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_saberForceMonsterCount");
  var remainingSaberPygmies = (saberedMonster === (0,dist.$monster)(_templateObject158 || (_templateObject158 = fights_taggedTemplateLiteral(["drunk pygmy"]))) ? (0,dist.get)("_saberForceMonsterCount") : 0) + 2 * clamp(5 - (0,dist.get)("_saberForceUses"), 0, 5);
  return (0,dist.get)("questL11Worship") !== "unstarted" && rightTime && !wrongPygmySabered && drunksCanAppear && remainingSaberPygmies;
}, function () {
  if (((0,dist.get)("_saberForceMonster") !== (0,dist.$monster)(_templateObject159 || (_templateObject159 = fights_taggedTemplateLiteral(["drunk pygmy"]))) || (0,dist.get)("_saberForceMonsterCount") === 1) && (0,dist.get)("_saberForceUses") < 5) {
    //1387, 2
    (0,property.withChoice)(1387, 2, function () {
      (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject160 || (_templateObject160 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject161 || (_templateObject161 = fights_taggedTemplateLiteral(["bowling ball"]))));
      (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject162 || (_templateObject162 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))), (0,dist.$item)(_templateObject163 || (_templateObject163 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
      (0,dist.adventureMacro)((0,dist.$location)(_templateObject164 || (_templateObject164 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.skill("Use the Force"));
    });
  } else {
    if ((0,external_kolmafia_.closetAmount)((0,dist.$item)(_templateObject165 || (_templateObject165 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))) > 0) (0,external_kolmafia_.takeCloset)((0,external_kolmafia_.closetAmount)((0,dist.$item)(_templateObject166 || (_templateObject166 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))), (0,dist.$item)(_templateObject167 || (_templateObject167 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));else (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject168 || (_templateObject168 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
    (0,dist.adventureMacro)((0,dist.$location)(_templateObject169 || (_templateObject169 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
  }
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject170 || (_templateObject170 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      bonusEquip: new Map([[(0,dist.$item)(_templateObject171 || (_templateObject171 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
      preventEquip: (0,dist.$items)(_templateObject172 || (_templateObject172 = fights_taggedTemplateLiteral(["Staff of Queso Escusado, stinky cheese sword"])))
    })];
  }
}), //Finally, saber or not, if we have a drunk pygmy in our crystal ball, let it out.
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("crystalBallMonster") === (0,dist.$monster)(_templateObject173 || (_templateObject173 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_drunkPygmyBanishes") >= 11;
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject174 || (_templateObject174 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject175 || (_templateObject175 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject176 || (_templateObject176 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject177 || (_templateObject177 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.abort());
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject178 || (_templateObject178 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
        return (0,dist.have)(item);
      }),
      bonusEquip: new Map([[(0,dist.$item)(_templateObject179 || (_templateObject179 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
  ...
  return (0,dist.have)((0,dist.$item)(_templateObject181 || (_templateObject181 = fights_taggedTemplateLiteral(["Time-Spinner"])))) && (0,dist.$location)(_templateObject182 || (_templateObject182 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))).combatQueue.includes("drunk pygmy") && (0,dist.get)("_timeSpinnerMinutesUsed") < 8;
}, function () {
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject183 || (_templateObject183 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  combat.Macro.trySkill("Extract").trySkill("Sing Along").setAutoAttack;
  (0,external_kolmafia_.visitUrl)("inv_use.php?whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(_templateObject184 || (_templateObject184 = fights_taggedTemplateLiteral(["Time-Spinner"]))))));
  (0,external_kolmafia_.runChoice)(1);
  (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=1196&monid=".concat((0,dist.$monster)(_templateObject185 || (_templateObject185 = fights_taggedTemplateLiteral(["drunk pygmy"]))).id, "&option=1"));
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      bonusEquip: new Map([[(0,dist.$item)(_templateObject186 || (_templateObject186 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
      preventEquip: (0,dist.$items)(_templateObject187 || (_templateObject187 = fights_taggedTemplateLiteral(["Staff of Queso Escusado, stinky cheese sword"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("_sausageFights") === 0 && (0,dist.have)((0,dist.$item)(_templateObject188 || (_templateObject188 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
}, function () {
  return (0,external_kolmafia_.adv1)(prepWandererZone(), -1, "");
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject189 || (_templateObject189 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("questL11Ron") === "finished" ? 5 - (0,dist.get)("_glarkCableUses") : 0;
}, function () {
  (0,external_kolmafia_.retrieveItem)(5 - (0,dist.get)("_glarkCableUses"), (0,dist.$item)(_templateObject190 || (_templateObject190 = fights_taggedTemplateLiteral(["glark cable"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject191 || (_templateObject191 = fights_taggedTemplateLiteral(["The Red Zeppelin"]))), combat.Macro.item((0,dist.$item)(_templateObject192 || (_templateObject192 = fights_taggedTemplateLiteral(["glark cable"])))));
}), // Mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject193 || (_templateObject193 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,dist.get)("_mushroomGardenFights") === 0;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject194 || (_templateObject194 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject195 || (_templateObject195 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject196 || (_templateObject196 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject197 || (_templateObject197 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject198 || (_templateObject198 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.trySkill("Portscan").meatKill());
  if ((0,dist.have)((0,dist.$item)(_templateObject199 || (_templateObject199 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject200 || (_templateObject200 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject201 || (_templateObject201 = fights_taggedTemplateLiteral(["Robortender"])))) ? (0,dist.$familiar)(_templateObject202 || (_templateObject202 = fights_taggedTemplateLiteral(["Robortender"]))) : null;
  }
}), // Portscan and mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject203 || (_templateObject203 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,external_kolmafia_.getCounters)("portscan.edu", 0, 0) === "portscan.edu" && (0,dist.have)((0,dist.$skill)(_templateObject204 || (_templateObject204 = fights_taggedTemplateLiteral(["Macrometeorite"])))) && (0,dist.get)("_macrometeoriteUses") < 10;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject205 || (_templateObject205 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject206 || (_templateObject206 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject207 || (_templateObject207 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject208 || (_templateObject208 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject209 || (_templateObject209 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.if_("monstername government agent", combat.Macro.skill("Macrometeorite")).if_("monstername piranha plant", combat.Macro.trySkill("Portscan").meatKill()));
  if ((0,dist.have)((0,dist.$item)(_templateObject210 || (_templateObject210 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject211 || (_templateObject211 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject212 || (_templateObject212 = fights_taggedTemplateLiteral(["God Lobster"])))) ? clamp(3 - (0,dist.get)("_godLobsterFights"), 0, 3) : 0;
}, function () {
  return (//
    (0,property.withChoice)(1310, 3, function () {
  ...
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject213 || (_templateObject213 = fights_taggedTemplateLiteral(["God Lobster"])));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject214 || (_templateObject214 = fights_taggedTemplateLiteral(["Machine Elf"])))) ? clamp(5 - (0,dist.get)("_machineTunnelsAdv"), 0, 5) : 0;
}, function () {
  (0,property.withChoice)(1119, 6, function () {
    return (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject215 || (_templateObject215 = fights_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, "");
  });
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject216 || (_templateObject216 = fights_taggedTemplateLiteral(["Machine Elf"])));
  }
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject217 || (_templateObject217 = fights_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), -1, "");
}), new FreeFight(function () {
  ...
  nepQuest();
  (0,property.withChoices)(nepQuestChoices(), function () {
    (0,dist.adventureMacro)((0,dist.$location)(_templateObject218 || (_templateObject218 = fights_taggedTemplateLiteral(["The Neverending Party"]))), combat.Macro.trySkill("Feel Pride").meatKill());
  ...
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.have)((0,dist.$item)(_templateObject219 || (_templateObject219 = fights_taggedTemplateLiteral(["January's Garbage Tote"])))) ? (0,dist.$items)(_templateObject220 || (_templateObject220 = fights_taggedTemplateLiteral(["makeshift garbage shirt"]))) : []
    })];
  }
})];
var freeKillSources = [new FreeFight(function () {
  return !(0,dist.get)("_gingerbreadMobHitUsed") && (0,dist.have)((0,dist.$skill)(_templateObject221 || (_templateObject221 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Gingerbread Mob Hit"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject222 || (_templateObject222 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject223 || (_templateObject223 = fights_taggedTemplateLiteral(["Shattering Punch"])))) ? clamp(3 - (0,dist.get)("_shatteringPunchUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Shattering Punch"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject224 || (_templateObject224 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
new FreeFight(function () {
  return !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject225 || (_templateObject225 = fights_taggedTemplateLiteral(["The Jokester's gun"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Fire the Jokester's Gun"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject226 || (_templateObject226 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject228 || (_templateObject228 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? clamp(3 - (0,dist.get)("_chestXRayUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Chest X-Ray"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject229 || (_templateObject229 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject230 || (_templateObject230 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject231 || (_templateObject231 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))) ? clamp(3 - (0,dist.get)("_usedReplicaBatoomerang"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").item("replica bat-oomerang"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject232 || (_templateObject232 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
  ...
  (0,combat.withMacro)(combat.Macro.skill("Sing Along").skill("Asdon Martin: Missile Launcher"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject233 || (_templateObject233 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
function freeFights() {
  ...
  if (!(0,dist.have)((0,dist.$item)(_templateObject234 || (_templateObject234 = fights_taggedTemplateLiteral(["li'l ninja costume"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject235 || (_templateObject235 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject236 || (_templateObject236 = fights_taggedTemplateLiteral(["The Jokester's gun"]))))) {
    (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
    freeFightMood().execute();
    freeFightOutfit([new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject237 || (_templateObject237 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })]);

    if (questStep("questL08Trapper") >= 2) {
      (0,dist.adventureMacroAuto)((0,dist.$location)(_templateObject238 || (_templateObject238 = fights_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))), combat.Macro.skill("Fire the Jokester's Gun"));
    } else if ((0,dist.have)((0,dist.$skill)(_templateObject239 || (_templateObject239 = fights_taggedTemplateLiteral(["Comprehensive Cartography"])))) && (0,dist.get)("_monstersMapped") < 3) {
      try {
        combat.Macro.skill("Fire the Jokester's Gun").setAutoAttack();
        mapMonster((0,dist.$location)(_templateObject240 || (_templateObject240 = fights_taggedTemplateLiteral(["The Haiku Dungeon"]))), (0,dist.$monster)(_templateObject241 || (_templateObject241 = fights_taggedTemplateLiteral(["amateur ninja"]))));
      } finally {
  ...
  try {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        if (freeKillSource.available()) {
          ...
          ensureEffect((0,dist.$effect)(_templateObject242 || (_templateObject242 = fights_taggedTemplateLiteral(["Feeling Lost"]))));

          if ((0,dist.have)((0,dist.$skill)(_templateObject243 || (_templateObject243 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"])))) && !(0,dist.get)("_steelyEyedSquintUsed")) {
            (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject244 || (_templateObject244 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"]))));
          }
        }
    ...
    if ((0,dist.have)((0,dist.$item)(_templateObject245 || (_templateObject245 = fights_taggedTemplateLiteral(["January's Garbage Tote"]))))) (0,external_kolmafia_.cliExecute)("fold wad of used tape");
  }
}
...
function nepQuestChoices() {
  if (questStep("_questPartyFair") <= 0) {
    ...
    if ((0,dist.get)("_questPartyFairQuest") === "booze") {
      return {
        1324: 3,
        1326: "",
        1327: 3
...
function thesisReady() {
  return !(0,dist.get)("_thesisDelivered") && (0,dist.have)((0,dist.$familiar)(_templateObject246 || (_templateObject246 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject247 || (_templateObject247 = fights_taggedTemplateLiteral(["Pocket Professor"]))).experience >= 400;
}
...
function deliverThesis() {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject248 || (_templateObject248 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
  freeFightMood().execute();
  freeFightOutfit([new Requirement(["100 muscle"], {})]);
  safeRestore();

  if ((0,dist.have)((0,dist.$item)(_templateObject249 || (_templateObject249 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject250 || (_templateObject250 = fights_taggedTemplateLiteral(["Triple-Sized"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") <= 95) {
    (0,external_kolmafia_.cliExecute)("checkpoint");
    (0,external_kolmafia_.equip)((0,dist.$slot)(_templateObject251 || (_templateObject251 = fights_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject252 || (_templateObject252 = fights_taggedTemplateLiteral(["Powerful Glove"]))));
    ensureEffect((0,dist.$effect)(_templateObject253 || (_templateObject253 = fights_taggedTemplateLiteral(["Triple-Sized"]))));
    (0,external_kolmafia_.outfit)("checkpoint");
  }

  (0,external_kolmafia_.cliExecute)("gain 1800 muscle");
  (0,property.withChoices)(nepQuestChoices(), function () {
    (0,dist.adventureMacro)(thesisInNEP ? (0,dist.$location)(_templateObject254 || (_templateObject254 = fights_taggedTemplateLiteral(["The Neverending Party"]))) : (0,dist.$location)(_templateObject255 || (_templateObject255 = fights_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), combat.Macro.skill("Deliver your Thesis"));
  });
}
...
function safeRestore() {
  ...
  if ((0,external_kolmafia_.myMp)() < 50 && (0,external_kolmafia_.myMaxmp)() > 50) {
    if (((0,dist.have)((0,dist.$item)(_templateObject256 || (_templateObject256 = fights_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(_templateObject257 || (_templateObject257 = fights_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject258 || (_templateObject258 = fights_taggedTemplateLiteral(["magical sausage"]))));
    }
...
function doSausage() {
  ...
  (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
  freeFightOutfit([new Requirement([], {
    forceEquip: (0,dist.$items)(_templateObject259 || (_templateObject259 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
  })]);
...
var physicalImmuneMacro = dist.Macro.trySkill("curse of weaksauce").trySkill("sing along").trySkill("extract").externalIf((0,dist.have)((0,dist.$skill)(lib_templateObject12 || (lib_templateObject12 = lib_taggedTemplateLiteral(["Saucestorm"])))), dist.Macro.skill("Saucestorm").repeat()).externalIf((0,dist.have)((0,dist.$skill)(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["Saucegeyser"])))), dist.Macro.skill("Saucegeyser").repeat()).externalIf((0,dist.have)((0,dist.$skill)(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["Cannelloni Cannon"])))), dist.Macro.skill("Cannelloni Cannon").repeat()).externalIf((0,dist.have)((0,dist.$skill)(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["Wave of Sauce"])))), dist.Macro.skill("Wave of Sauce").repeat()).externalIf((0,dist.have)((0,dist.$skill)(lib_templateObject16 || (lib_templateObject16 = lib_taggedTemplateLiteral(["Saucecicle"])))), dist.Macro.skill("Saucecicle").repeat()); //The Freezewoman is spooky-aligned, don't worry
...
var banderRun = new FreeRun(function () {
  return ((0,dist.have)((0,dist.$familiar)(lib_templateObject18 || (lib_templateObject18 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"])))) && ((0,dist.have)((0,dist.$effect)(lib_templateObject19 || (lib_templateObject19 = lib_taggedTemplateLiteral(["Ode to Booze"])))) || (0,dist.getSongCount)() < (0,dist.getSongLimit)()) || (0,dist.have)((0,dist.$familiar)(lib_templateObject20 || (lib_templateObject20 = lib_taggedTemplateLiteral(["Pair of Stomping Boots"]))))) && dist.Bandersnatch.getRemainingRunaways() > 0;
}, function () {
  (0,external_kolmafia_.maximize)("familiar weight", false);
  if ((0,dist.have)((0,dist.$familiar)(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"])))) && ((0,dist.have)((0,dist.$effect)(lib_templateObject22 || (lib_templateObject22 = lib_taggedTemplateLiteral(["Ode to Booze"])))) || (0,dist.getSongCount)() < (0,dist.getSongLimit)())) (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(lib_templateObject23 || (lib_templateObject23 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"]))));else (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(lib_templateObject24 || (lib_templateObject24 = lib_taggedTemplateLiteral(["Pair of Stomping Boots"]))));
  if ((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(lib_templateObject25 || (lib_templateObject25 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"])))) ensureEffect((0,dist.$effect)(lib_templateObject26 || (lib_templateObject26 = lib_taggedTemplateLiteral(["Ode to Booze"]))));
...
banderRun, new FreeRun(function () {
  return (0,dist.get)("_snokebombUsed") < banishesToUse && (0,dist.have)((0,dist.$skill)(lib_templateObject27 || (lib_templateObject27 = lib_taggedTemplateLiteral(["Snokebomb"]))));
}, function () {
  ...
  return (0,dist.get)("_feelHatredUsed") < banishesToUse && (0,dist.have)((0,dist.$skill)(lib_templateObject28 || (lib_templateObject28 = lib_taggedTemplateLiteral(["Emotionally Chipped"]))));
}, function () {
  return;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("feel hatred")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject29 || (lib_templateObject29 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))) && (0,dist.get)("_kgbTranquilizerDartUses") < 3;
}, function () {
  return (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject30 || (lib_templateObject30 = lib_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(lib_templateObject31 || (lib_templateObject31 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("KGB tranquilizer dart")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject32 || (lib_templateObject32 = lib_taggedTemplateLiteral(["latte lovers member's mug"])))) && !(0,dist.get)("_latteBanishUsed");
}, function () {
  return (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject33 || (lib_templateObject33 = lib_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(lib_templateObject34 || (lib_templateObject34 = lib_taggedTemplateLiteral(["latte lovers member's mug"]))));
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Throw Latte on Opponent")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject35 || (lib_templateObject35 = lib_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && (0,dist.get)("_reflexHammerUsed") < 3;
}, function () {
  return (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject36 || (lib_templateObject36 = lib_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(lib_templateObject37 || (lib_templateObject37 = lib_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("reflex hammer")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject38 || (lib_templateObject38 = lib_taggedTemplateLiteral(["mafia middle finger ring"])))) && !(0,dist.get)("_mafiaMiddleFingerRingUsed");
}, function () {
  return (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject39 || (lib_templateObject39 = lib_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(lib_templateObject40 || (lib_templateObject40 = lib_taggedTemplateLiteral(["mafia middle finger ring"]))));
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Show them your ring")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject41 || (lib_templateObject41 = lib_taggedTemplateLiteral(["V for Vivala mask"])))) && !(0,dist.get)("_vmaskBanisherUsed");
}, function () {
  (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject42 || (lib_templateObject42 = lib_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(lib_templateObject43 || (lib_templateObject43 = lib_taggedTemplateLiteral(["V for Vivala mask"]))));
  (0,external_kolmafia_.restoreMp)(30);
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Creepy Grin")), new FreeRun(function () {
  return (0,dist.getFoldGroup)((0,dist.$item)(lib_templateObject44 || (lib_templateObject44 = lib_taggedTemplateLiteral(["stinky cheese diaper"])))).some(function (item) {
    return (0,dist.have)(item);
  }) && !(0,dist.get)("_stinkyCheeseBanisherUsed");
}, function () {
  if (!(0,dist.have)((0,dist.$item)(lib_templateObject45 || (lib_templateObject45 = lib_taggedTemplateLiteral(["stinky cheese eye"]))))) (0,external_kolmafia_.cliExecute)("fold stinky cheese eye");
  (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject46 || (lib_templateObject46 = lib_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(lib_templateObject47 || (lib_templateObject47 = lib_taggedTemplateLiteral(["stinky cheese eye"]))));
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Give Your Opponent the Stinkeye")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject48 || (lib_templateObject48 = lib_taggedTemplateLiteral(["navel ring of navel gazing"])))) && (0,dist.get)("_navelRunaways") < 3;
}, function () {
  return (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject49 || (lib_templateObject49 = lib_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(lib_templateObject50 || (lib_templateObject50 = lib_taggedTemplateLiteral(["navel ring of navel gazing"]))));
}, dist.Macro.step("runaway")), new FreeRun(function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject51 || (lib_templateObject51 = lib_taggedTemplateLiteral(["Greatest American Pants"])))) && (0,dist.get)("_navelRunaways") < 3;
}, function () {
  return (0,external_kolmafia_.equip)((0,dist.$slot)(lib_templateObject52 || (lib_templateObject52 = lib_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(lib_templateObject53 || (lib_templateObject53 = lib_taggedTemplateLiteral(["Greatest American Pants"]))));
}, dist.Macro.step("runaway"))];
function findRun() {
...
var bjornFams = [{
  familiar: (0,dist.$familiar)(lib_templateObject54 || (lib_templateObject54 = lib_taggedTemplateLiteral(["Puck Man"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject55 || (lib_templateObject55 = lib_taggedTemplateLiteral(["yellow pixel"]))));
  },
  probability: 0.25,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject56 || (lib_templateObject56 = lib_taggedTemplateLiteral(["Ms. Puck Man"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject57 || (lib_templateObject57 = lib_taggedTemplateLiteral(["yellow pixel"]))));
  },
  probability: 0.25,
  dropPredicate: function dropPredicate() {
    return (0,dist.get)("_yellowPixelDropsCrown") < 25;
  ...
  familiar: (0,dist.$familiar)(lib_templateObject58 || (lib_templateObject58 = lib_taggedTemplateLiteral(["Grimstone Golem"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject59 || (lib_templateObject59 = lib_taggedTemplateLiteral(["grimstone mask"]))));
  },
  probability: 0.5,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject60 || (lib_templateObject60 = lib_taggedTemplateLiteral(["Knob Goblin Organ Grinder"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject61 || (lib_templateObject61 = lib_taggedTemplateLiteral(["Happy Medium"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject62 || (lib_templateObject62 = lib_taggedTemplateLiteral(["Garbage Fire"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject63 || (lib_templateObject63 = lib_taggedTemplateLiteral(["burning newspaper"]))));
  },
  probability: 0.5,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject64 || (lib_templateObject64 = lib_taggedTemplateLiteral(["Machine Elf"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject65 || (lib_templateObject65 = lib_taggedTemplateLiteral(["abstraction: sensation, abstraction: thought, abstraction: action, abstraction: category, abstraction: perception, abstraction: purpose"])))));
  },
  probability: 0.2,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject66 || (lib_templateObject66 = lib_taggedTemplateLiteral(["Trick-or-Treating Tot"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject67 || (lib_templateObject67 = lib_taggedTemplateLiteral(["hoarded candy wad"]))));
  },
  probability: 0.5,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject68 || (lib_templateObject68 = lib_taggedTemplateLiteral(["Warbear Drone"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject69 || (lib_templateObject69 = lib_taggedTemplateLiteral(["warbear whosit"]))));
  },
  probability: 1 / 4.5
}, {
  familiar: (0,dist.$familiar)(lib_templateObject70 || (lib_templateObject70 = lib_taggedTemplateLiteral(["Li'l Xenomorph"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject71 || (lib_templateObject71 = lib_taggedTemplateLiteral(["lunar isotope"]))));
  },
  probability: 0.05,
  modifier: {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject72 || (lib_templateObject72 = lib_taggedTemplateLiteral(["Pottery Barn Owl"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject73 || (lib_templateObject73 = lib_taggedTemplateLiteral(["volcanic ash"]))));
  },
  probability: 0.1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject74 || (lib_templateObject74 = lib_taggedTemplateLiteral(["Grim Brother"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject75 || (lib_templateObject75 = lib_taggedTemplateLiteral(["grim fairy tale"]))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject76 || (lib_templateObject76 = lib_taggedTemplateLiteral(["Optimistic Candle"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject77 || (lib_templateObject77 = lib_taggedTemplateLiteral(["glob of melted wax"]))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject78 || (lib_templateObject78 = lib_taggedTemplateLiteral(["Adventurous Spelunker"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject79 || (lib_templateObject79 = lib_taggedTemplateLiteral(["teflon ore, velcro ore, vinyl ore, cardboard ore, styrofoam ore, bubblewrap ore"])))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject80 || (lib_templateObject80 = lib_taggedTemplateLiteral(["Twitching Space Critter"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject81 || (lib_templateObject81 = lib_taggedTemplateLiteral(["space beast fur"]))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  familiar: (0,dist.$familiar)(lib_templateObject82 || (lib_templateObject82 = lib_taggedTemplateLiteral(["Party Mouse"]))),
  meatVal: function meatVal() {
    return 50;
  },
  ...
  familiar: (0,dist.$familiar)(lib_templateObject83 || (lib_templateObject83 = lib_taggedTemplateLiteral(["Yule Hound"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject84 || (lib_templateObject84 = lib_taggedTemplateLiteral(["candy cane"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject85 || (lib_templateObject85 = lib_taggedTemplateLiteral(["Gluttonous Green Ghost"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject86 || (lib_templateObject86 = lib_taggedTemplateLiteral(["bean burrito, enchanted bean burrito, jumping bean burrito"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject87 || (lib_templateObject87 = lib_taggedTemplateLiteral(["Reassembled Blackbird"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject88 || (lib_templateObject88 = lib_taggedTemplateLiteral(["blackberry"]))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.ITEM,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject89 || (lib_templateObject89 = lib_taggedTemplateLiteral(["Reconstituted Crow"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject90 || (lib_templateObject90 = lib_taggedTemplateLiteral(["blackberry"]))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.ITEM,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject91 || (lib_templateObject91 = lib_taggedTemplateLiteral(["Hunchbacked Minion"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject92 || (lib_templateObject92 = lib_taggedTemplateLiteral(["disembodied brain, skeleton bone, skeleton bone, skeleton bone, skeleton bone"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject93 || (lib_templateObject93 = lib_taggedTemplateLiteral(["Reanimated Reanimator"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject94 || (lib_templateObject94 = lib_taggedTemplateLiteral(["hot wing, broken skull"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject95 || (lib_templateObject95 = lib_taggedTemplateLiteral(["Attention-Deficit Demon"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject96 || (lib_templateObject96 = lib_taggedTemplateLiteral(["chorizo brownies, white chocolate and tomato pizza, carob chunk noodles"])))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.MEAT,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject97 || (lib_templateObject97 = lib_taggedTemplateLiteral(["Piano Cat"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject98 || (lib_templateObject98 = lib_taggedTemplateLiteral(["beertini, papaya slung, salty slug, tomato daiquiri"])))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.MEAT,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject99 || (lib_templateObject99 = lib_taggedTemplateLiteral(["Golden Monkey"]))),
  meatVal: function meatVal() {
    return 100;
  },
  probability: 0.5,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject100 || (lib_templateObject100 = lib_taggedTemplateLiteral(["Robot Reindeer"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject101 || (lib_templateObject101 = lib_taggedTemplateLiteral(["candy cane, eggnog, fruitcake, gingerbread bugbear"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(lib_templateObject102 || (lib_templateObject102 = lib_taggedTemplateLiteral(["Stocking Mimic"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject103 || (lib_templateObject103 = lib_taggedTemplateLiteral(["Angry Farmer candy, Cold Hots candy, Rock Pops, Tasty Fun Good rice candy, Wint-O-Fresh mint"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(lib_templateObject104 || (lib_templateObject104 = lib_taggedTemplateLiteral(["BRICKO chick"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject105 || (lib_templateObject105 = lib_taggedTemplateLiteral(["BRICKO brick"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject106 || (lib_templateObject106 = lib_taggedTemplateLiteral(["Cotton Candy Carnie"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject107 || (lib_templateObject107 = lib_taggedTemplateLiteral(["cotton candy pinch"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject108 || (lib_templateObject108 = lib_taggedTemplateLiteral(["Untamed Turtle"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject109 || (lib_templateObject109 = lib_taggedTemplateLiteral(["snailmail bits, turtlemail bits, turtle wax"])))));
  },
  probability: 0.35
}, {
  familiar: (0,dist.$familiar)(lib_templateObject110 || (lib_templateObject110 = lib_taggedTemplateLiteral(["Astral Badger"]))),
  meatVal: function meatVal() {
    return 2 * trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject111 || (lib_templateObject111 = lib_taggedTemplateLiteral(["spooky mushroom, Knob mushroom, Knoll mushroom"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject112 || (lib_templateObject112 = lib_taggedTemplateLiteral(["Green Pixie"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject113 || (lib_templateObject113 = lib_taggedTemplateLiteral(["bottle of tequila"]))));
  },
  probability: 0.2
}, {
  familiar: (0,dist.$familiar)(lib_templateObject114 || (lib_templateObject114 = lib_taggedTemplateLiteral(["Angry Goat"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(lib_templateObject115 || (lib_templateObject115 = lib_taggedTemplateLiteral(["goat cheese pizza"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject116 || (lib_templateObject116 = lib_taggedTemplateLiteral(["Adorable Seal Larva"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject117 || (lib_templateObject117 = lib_taggedTemplateLiteral(["stench nuggets, spooky nuggets, hot nuggets, cold nuggets, sleaze nuggets"])))));
  },
  probability: 0.35
}, {
  familiar: (0,dist.$familiar)(lib_templateObject118 || (lib_templateObject118 = lib_taggedTemplateLiteral(["Ancient Yuletide Troll"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject119 || (lib_templateObject119 = lib_taggedTemplateLiteral(["candy cane, eggnog, fruitcake, gingerbread bugbear"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(lib_templateObject120 || (lib_templateObject120 = lib_taggedTemplateLiteral(["Sweet Nutcracker"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, lib_toConsumableArray((0,dist.$items)(lib_templateObject121 || (lib_templateObject121 = lib_taggedTemplateLiteral(["candy cane, eggnog, fruitcake, gingerbread bugbear"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(lib_templateObject122 || (lib_templateObject122 = lib_taggedTemplateLiteral(["Casagnova Gnome"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject123 || (lib_templateObject123 = lib_taggedTemplateLiteral(["Coffee Pixie"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject124 || (lib_templateObject124 = lib_taggedTemplateLiteral(["Dancing Frog"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject125 || (lib_templateObject125 = lib_taggedTemplateLiteral(["Grouper Groupie"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject126 || (lib_templateObject126 = lib_taggedTemplateLiteral(["Hand Turkey"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject127 || (lib_templateObject127 = lib_taggedTemplateLiteral(["Hippo Ballerina"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject128 || (lib_templateObject128 = lib_taggedTemplateLiteral(["Jitterbug"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject129 || (lib_templateObject129 = lib_taggedTemplateLiteral(["Leprechaun"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject130 || (lib_templateObject130 = lib_taggedTemplateLiteral(["Obtuse Angel"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject131 || (lib_templateObject131 = lib_taggedTemplateLiteral(["Psychedelic Bear"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject132 || (lib_templateObject132 = lib_taggedTemplateLiteral(["Robortender"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject133 || (lib_templateObject133 = lib_taggedTemplateLiteral(["Ghost of Crimbo Commerce"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject134 || (lib_templateObject134 = lib_taggedTemplateLiteral(["Hobo Monkey"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject135 || (lib_templateObject135 = lib_taggedTemplateLiteral(["Rockin' Robin"]))),
  meatVal: function meatVal() {
    return 60;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject136 || (lib_templateObject136 = lib_taggedTemplateLiteral(["Feral Kobold"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject137 || (lib_templateObject137 = lib_taggedTemplateLiteral(["Oily Woim"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject138 || (lib_templateObject138 = lib_taggedTemplateLiteral(["Cat Burglar"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject139 || (lib_templateObject139 = lib_taggedTemplateLiteral(["Misshapen Animal Skeleton"]))),
  meatVal: function meatVal() {
    return 30;
  },
  probability: 1,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject140 || (lib_templateObject140 = lib_taggedTemplateLiteral(["Gelatinous Cubeling"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(lib_templateObject141 || (lib_templateObject141 = lib_taggedTemplateLiteral(["Frozen Gravy Fairy"]))),
  // drops a cold nugget every combat, 5 of which can be used to make a cold wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(lib_templateObject142 || (lib_templateObject142 = lib_taggedTemplateLiteral(["cold wad"])))), trueValue((0,dist.$item)(lib_templateObject143 || (lib_templateObject143 = lib_taggedTemplateLiteral(["cold nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject144 || (lib_templateObject144 = lib_taggedTemplateLiteral(["Stinky Gravy Fairy"]))),
  // drops a stench nugget every combat, 5 of which can be used to make a stench wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(lib_templateObject145 || (lib_templateObject145 = lib_taggedTemplateLiteral(["stench wad"])))), trueValue((0,dist.$item)(lib_templateObject146 || (lib_templateObject146 = lib_taggedTemplateLiteral(["stench nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject147 || (lib_templateObject147 = lib_taggedTemplateLiteral(["Sleazy Gravy Fairy"]))),
  // drops a sleaze nugget every combat, 5 of which can be used to make a sleaze wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(lib_templateObject148 || (lib_templateObject148 = lib_taggedTemplateLiteral(["sleaze wad"])))), trueValue((0,dist.$item)(lib_templateObject149 || (lib_templateObject149 = lib_taggedTemplateLiteral(["sleaze nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject150 || (lib_templateObject150 = lib_taggedTemplateLiteral(["Spooky Gravy Fairy"]))),
  // drops a spooky nugget every combat, 5 of which can be used to make a spooky wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(lib_templateObject151 || (lib_templateObject151 = lib_taggedTemplateLiteral(["spooky wad"])))), trueValue((0,dist.$item)(lib_templateObject152 || (lib_templateObject152 = lib_taggedTemplateLiteral(["spooky nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(lib_templateObject153 || (lib_templateObject153 = lib_taggedTemplateLiteral(["Flaming Gravy Fairy"]))),
  // drops a hot nugget every combat, 5 of which can be used to make a hot wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(lib_templateObject154 || (lib_templateObject154 = lib_taggedTemplateLiteral(["hot wad"])))), trueValue((0,dist.$item)(lib_templateObject155 || (lib_templateObject155 = lib_taggedTemplateLiteral(["hot nuggets"])))));
  },
  probability: 1
...
(function (PickBjornMode) {
  ...
  PickBjornMode[PickBjornMode["DMT"] = 3] = "DMT";
...
function generateBjornList(mode) {
  var additionalValue = function additionalValue(familiar) {
    ...
    var meatVal = mode === PickBjornMode.FREE || PickBjornMode.DMT ? 0 : baseMeat + (mode === PickBjornMode.EMBEZZLER ? 750 : 0);
...
function kramcoGuaranteed() {
  return (0,dist.have)((0,dist.$item)(lib_templateObject156 || (lib_templateObject156 = lib_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))) && (0,external_kolmafia_.totalTurnsPlayed)() - (0,dist.get)("_lastSausageMonsterTurn") + 1 >= 5 + 3 * (0,dist.get)("_sausageFights") + Math.pow(Math.max(0, (0,dist.get)("_sausageFights") - 5), 3);
}
...
function runDiet() {
  if ((0,dist.get)("barrelShrineUnlocked") && !(0,dist.get)("_barrelPrayer") && (0,dist.$classes)(diet_templateObject22 || (diet_templateObject22 = diet_taggedTemplateLiteral(["Turtle Tamer, Accordion Thief"]))).includes((0,external_kolmafia_.myClass)())) {
  ...
  var loveChocolateEat = Math.min(loveChocolateCount, (0,external_kolmafia_.itemAmount)((0,dist.$item)(diet_templateObject29 || (diet_templateObject29 = diet_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"])))));
  (0,external_kolmafia_.use)(loveChocolateEat, (0,dist.$item)(diet_templateObject30 || (diet_templateObject30 = diet_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))));
  var choco = new Map([[(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject31 || (diet_templateObject31 = diet_taggedTemplateLiteral(["Seal Clubber"])))), (0,dist.$item)(diet_templateObject32 || (diet_templateObject32 = diet_taggedTemplateLiteral(["chocolate seal-clubbing club"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject33 || (diet_templateObject33 = diet_taggedTemplateLiteral(["Turtle Tamer"])))), (0,dist.$item)(diet_templateObject34 || (diet_templateObject34 = diet_taggedTemplateLiteral(["chocolate turtle totem"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject35 || (diet_templateObject35 = diet_taggedTemplateLiteral(["Pastamancer"])))), (0,dist.$item)(diet_templateObject36 || (diet_templateObject36 = diet_taggedTemplateLiteral(["chocolate pasta spoon"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject37 || (diet_templateObject37 = diet_taggedTemplateLiteral(["Sauceror"])))), (0,dist.$item)(diet_templateObject38 || (diet_templateObject38 = diet_taggedTemplateLiteral(["chocolate saucepan"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject39 || (diet_templateObject39 = diet_taggedTemplateLiteral(["Accordion Thief"])))), (0,dist.$item)(diet_templateObject40 || (diet_templateObject40 = diet_taggedTemplateLiteral(["chocolate stolen accordion"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject41 || (diet_templateObject41 = diet_taggedTemplateLiteral(["Disco Bandit"])))), (0,dist.$item)(diet_templateObject42 || (diet_templateObject42 = diet_taggedTemplateLiteral(["chocolate disco ball"])))]]);
  ...
  if (choco.has((0,external_kolmafia_.toInt)((0,external_kolmafia_.myClass)())) && (0,dist.get)("_chocolatesUsed") < 3) {
    ...
    var item = choco.get((0,external_kolmafia_.toInt)((0,external_kolmafia_.myClass)())) || (0,dist.$item)(diet_templateObject43 || (diet_templateObject43 = diet_taggedTemplateLiteral(["none"])));
    var count = clamp(3 - used, 0, 3);
    (0,external_kolmafia_.use)(count, item);
  }

  useIfUnused((0,dist.$item)(diet_templateObject44 || (diet_templateObject44 = diet_taggedTemplateLiteral(["fancy chocolate sculpture"]))), (0,dist.get)("_chocolateSculpturesUsed") < 1, 5 * MPA + 5000);
  useIfUnused((0,dist.$item)(diet_templateObject45 || (diet_templateObject45 = diet_taggedTemplateLiteral(["essential tofu"]))), "_essentialTofuUsed", 5 * MPA);

  if (!(0,dist.get)("_etchedHourglassUsed") && (0,dist.have)((0,dist.$item)(diet_templateObject46 || (diet_templateObject46 = diet_taggedTemplateLiteral(["etched hourglass"]))))) {
    (0,external_kolmafia_.use)(1, (0,dist.$item)(diet_templateObject47 || (diet_templateObject47 = diet_taggedTemplateLiteral(["etched hourglass"]))));
  }

  if ((0,external_kolmafia_.getProperty)("_timesArrowUsed") !== "true" && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject48 || (diet_templateObject48 = diet_taggedTemplateLiteral(["time's arrow"])))) < 5 * MPA) {
    acquire(1, (0,dist.$item)(diet_templateObject49 || (diet_templateObject49 = diet_taggedTemplateLiteral(["time's arrow"]))), 5 * MPA);
    (0,external_kolmafia_.cliExecute)("csend 1 time's arrow to botticelli");
    (0,external_kolmafia_.setProperty)("_timesArrowUsed", "true");
  }

  if ((0,dist.have)((0,dist.$skill)(diet_templateObject50 || (diet_templateObject50 = diet_taggedTemplateLiteral(["Ancestral Recall"])))) && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject51 || (diet_templateObject51 = diet_taggedTemplateLiteral(["blue mana"])))) < 3 * MPA) {
    var casts = Math.max(10 - (0,dist.get)("_ancestralRecallCasts"), 0);
    acquire(casts, (0,dist.$item)(diet_templateObject52 || (diet_templateObject52 = diet_taggedTemplateLiteral(["blue mana"]))), 3 * MPA);
    (0,external_kolmafia_.useSkill)(casts, (0,dist.$skill)(diet_templateObject53 || (diet_templateObject53 = diet_taggedTemplateLiteral(["Ancestral Recall"]))));
  }

  if (globalOptions.ascending) useIfUnused((0,dist.$item)(diet_templateObject54 || (diet_templateObject54 = diet_taggedTemplateLiteral(["borrowed time"]))), "_borrowedTimeUsed", 5 * MPA);
  fillSomeSpleen();
  fillStomach();
  fillLiver();

  if (!(0,dist.get)("_distentionPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(diet_templateObject55 || (diet_templateObject55 = diet_taggedTemplateLiteral(["distention pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(diet_templateObject56 || (diet_templateObject56 = diet_taggedTemplateLiteral(["distention pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject57 || (diet_templateObject57 = diet_taggedTemplateLiteral(["distention pill"]))))) {
  ...
  if (!(0,dist.get)("_syntheticDogHairPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(diet_templateObject58 || (diet_templateObject58 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(diet_templateObject59 || (diet_templateObject59 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject60 || (diet_templateObject60 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))))) {
  ...
  acquire(mojoFilterCount, (0,dist.$item)(diet_templateObject61 || (diet_templateObject61 = diet_taggedTemplateLiteral(["mojo filter"]))), valuePerSpleen(bestSpleenItem), false);

  if ((0,dist.have)((0,dist.$item)(diet_templateObject62 || (diet_templateObject62 = diet_taggedTemplateLiteral(["mojo filter"]))))) {
    (0,external_kolmafia_.use)(Math.min(mojoFilterCount, (0,external_kolmafia_.availableAmount)((0,dist.$item)(diet_templateObject63 || (diet_templateObject63 = diet_taggedTemplateLiteral(["mojo filter"]))))), (0,dist.$item)(diet_templateObject64 || (diet_templateObject64 = diet_taggedTemplateLiteral(["mojo filter"]))));
    fillSomeSpleen();
  }

  while ((0,external_kolmafia_.myFullness)() < (0,external_kolmafia_.fullnessLimit)()) {
    if ((0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject65 || (diet_templateObject65 = diet_taggedTemplateLiteral(["fudge spork"])))) < 3 * MPA && !(0,dist.get)("_fudgeSporkUsed")) (0,external_kolmafia_.eat)(1, (0,dist.$item)(diet_templateObject66 || (diet_templateObject66 = diet_taggedTemplateLiteral(["fudge spork"]))));
    mindMayo(Mayo.zapine, 1);
    eatSafe(1, (0,dist.$item)(diet_templateObject67 || (diet_templateObject67 = diet_taggedTemplateLiteral(["jumping horseradish"]))));
  }

  while ((0,external_kolmafia_.myInebriety)() < (0,external_kolmafia_.inebrietyLimit)()) {
    drinkSafe(1, (0,dist.$item)(diet_templateObject68 || (diet_templateObject68 = diet_taggedTemplateLiteral(["Ambitious Turkey"]))));
  }
}
function horseradish() {
  if ((0,external_kolmafia_.myFullness)() < (0,external_kolmafia_.fullnessLimit)()) {
    if ((0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject69 || (diet_templateObject69 = diet_taggedTemplateLiteral(["fudge spork"])))) < 3 * MPA && !(0,dist.get)("_fudgeSporkUsed")) (0,external_kolmafia_.eat)(1, (0,dist.$item)(diet_templateObject70 || (diet_templateObject70 = diet_taggedTemplateLiteral(["fudge spork"]))));
    mindMayo(Mayo.zapine, 1);
    eatSafe(1, (0,dist.$item)(diet_templateObject71 || (diet_templateObject71 = diet_taggedTemplateLiteral(["jumping horseradish"]))));
  }
}
var Mayo = {
...
function volcanoDailies() {
  ...
  if (!(0,dist.get)("_infernoDiscoVisited")) {
    (0,dist.$items)(dailies_templateObject51 || (dailies_templateObject51 = dailies_taggedTemplateLiteral(["smooth velvet pocket square, smooth velvet socks, smooth velvet hat, smooth velvet shirt, smooth velvet hanky, smooth velvet pants"]))).forEach(function (discoEquip) {
  ...
  if ((0,dist.have)((0,dist.$skill)(dailies_templateObject52 || (dailies_templateObject52 = dailies_taggedTemplateLiteral(["Unaccompanied Miner"])))) && (0,dist.get)("_unaccompaniedMinerUsed") < 5) {
...
function checkVolcanoQuest() {
  ...
  var volcanoItems = [dist.property.getItem("_volcanoItem1") || (0,dist.$item)(dailies_templateObject53 || (dailies_templateObject53 = dailies_taggedTemplateLiteral(["none"]))), dist.property.getItem("_volcanoItem2") || (0,dist.$item)(dailies_templateObject54 || (dailies_templateObject54 = dailies_taggedTemplateLiteral(["none"]))), dist.property.getItem("_volcanoItem3") || (0,dist.$item)(dailies_templateObject55 || (dailies_templateObject55 = dailies_taggedTemplateLiteral(["none"])))];
  var volcanoWhatToDo = new Map([[(0,dist.$item)(dailies_templateObject56 || (dailies_templateObject56 = dailies_taggedTemplateLiteral(["New Age healing crystal"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject57 || (dailies_templateObject57 = dailies_taggedTemplateLiteral(["New Age healing crystal"])))) >= 5) return true;else {
      return (0,external_kolmafia_.buy)(5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject58 || (dailies_templateObject58 = dailies_taggedTemplateLiteral(["New Age healing crystal"])))), (0,dist.$item)(dailies_templateObject59 || (dailies_templateObject59 = dailies_taggedTemplateLiteral(["New Age healing crystal"]))), 1000) === 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject60 || (dailies_templateObject60 = dailies_taggedTemplateLiteral(["New Age healing crystal"]))));
    }
  }], [(0,dist.$item)(dailies_templateObject61 || (dailies_templateObject61 = dailies_taggedTemplateLiteral(["SMOOCH bottlecap"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject62 || (dailies_templateObject62 = dailies_taggedTemplateLiteral(["SMOOCH bottlecap"])))) > 0) return true;else return (0,external_kolmafia_.buy)(1, (0,dist.$item)(dailies_templateObject63 || (dailies_templateObject63 = dailies_taggedTemplateLiteral(["SMOOCH bottlecap"]))), 5000) === 1;
  }], [(0,dist.$item)(dailies_templateObject64 || (dailies_templateObject64 = dailies_taggedTemplateLiteral(["gooey lava globs"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject65 || (dailies_templateObject65 = dailies_taggedTemplateLiteral(["gooey lava globs"])))) >= 5) {
      return true;
    } else {
      var toBuy = 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject66 || (dailies_templateObject66 = dailies_taggedTemplateLiteral(["gooey lava globs"]))));
      return (0,external_kolmafia_.buy)(toBuy, (0,dist.$item)(dailies_templateObject67 || (dailies_templateObject67 = dailies_taggedTemplateLiteral(["gooey lava globs"]))), 5000) === toBuy;
    }
  }], [(0,dist.$item)(dailies_templateObject68 || (dailies_templateObject68 = dailies_taggedTemplateLiteral(["fused fuse"]))), function () {
    return (0,dist.have)((0,dist.$item)(dailies_templateObject69 || (dailies_templateObject69 = dailies_taggedTemplateLiteral(["Clara's bell"]))));
  }], [(0,dist.$item)(dailies_templateObject70 || (dailies_templateObject70 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject71 || (dailies_templateObject71 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) < 3) {
      (0,external_kolmafia_.cliExecute)("acquire ".concat((3 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject72 || (dailies_templateObject72 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))))).toString(), " smooth velvet bra"));
    }

    return (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject73 || (dailies_templateObject73 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) >= 3;
  }], [(0,dist.$item)(dailies_templateObject74 || (dailies_templateObject74 = dailies_taggedTemplateLiteral(["SMOOCH bracers"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject75 || (dailies_templateObject75 = dailies_taggedTemplateLiteral(["SMOOCH bracers"])))) < 3) {
      (0,external_kolmafia_.cliExecute)("acquire ".concat((3 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject76 || (dailies_templateObject76 = dailies_taggedTemplateLiteral(["SMOOCH bracers"]))))).toString(), " smooch bracers"));
    }

    return (0,external_kolmafia_.availableAmount)((0,dist.$item)(dailies_templateObject77 || (dailies_templateObject77 = dailies_taggedTemplateLiteral(["SMOOCH bracers"])))) >= 3;
  }]]);
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (volcanoItems.includes(volcanoItem)) {
        if (tryToGetIt()) {
          if (volcanoItem !== (0,dist.$item)(dailies_templateObject78 || (dailies_templateObject78 = dailies_taggedTemplateLiteral(["fused fuse"])))) {
            (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
...
function cheat() {
  if ((0,dist.have)((0,dist.$item)(dailies_templateObject79 || (dailies_templateObject79 = dailies_taggedTemplateLiteral(["Deck of Every Card"]))))) {
...
function jellyfish() {
  if (!(0,dist.have)((0,dist.$familiar)(dailies_templateObject82 || (dailies_templateObject82 = dailies_taggedTemplateLiteral(["Space Jellyfish"])))) || !((0,dist.have)((0,dist.$skill)(dailies_templateObject83 || (dailies_templateObject83 = dailies_taggedTemplateLiteral(["Meteor Lore"])))) && (0,dist.get)("_macrometeoriteUses") < 10 || (0,dist.have)((0,dist.$item)(dailies_templateObject84 || (dailies_templateObject84 = dailies_taggedTemplateLiteral(["Powerful Glove"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") < 91)) {
    return;
  }

  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(dailies_templateObject85 || (dailies_templateObject85 = dailies_taggedTemplateLiteral(["Space Jellyfish"]))));
  (0,external_kolmafia_.setAutoAttack)(0);
  freeFightOutfit();

  while (findRun(false) && (0,dist.have)((0,dist.$skill)(dailies_templateObject86 || (dailies_templateObject86 = dailies_taggedTemplateLiteral(["Meteor Lore"])))) && (0,dist.get)("_macrometeoriteUses") < 10) {
  ...
  if ((0,dist.have)((0,dist.$item)(dailies_templateObject88 || (dailies_templateObject88 = dailies_taggedTemplateLiteral(["Powerful Glove"]))))) {
    freeFightOutfit();
    (0,external_kolmafia_.equip)((0,dist.$slot)(dailies_templateObject89 || (dailies_templateObject89 = dailies_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(dailies_templateObject90 || (dailies_templateObject90 = dailies_taggedTemplateLiteral(["Powerful Glove"]))));
...
function barfTurn() {
  var startTurns = (0,external_kolmafia_.totalTurnsPlayed)();
  horseradish();
  if ((0,dist.have)((0,dist.$effect)(src_templateObject10 || (src_templateObject10 = src_taggedTemplateLiteral(["Beaten Up"]))))) throw "Hey, you're beaten up, and that's a bad thing. Lick your wounds, handle your problems, and run me again when you feel ready.";

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(src_templateObject11 || (src_templateObject11 = src_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(src_templateObject12 || (src_templateObject12 = src_taggedTemplateLiteral(["Digitize"])))]);
  }

  if ((0,dist.have)((0,dist.$item)(src_templateObject13 || (src_templateObject13 = src_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) && ((0,dist.get)("retroCapeSuperhero") !== "robot" || (0,dist.get)("retroCapeWashingInstructions") !== "kill")) {
  ...
  var location = embezzlerUp ? prepWandererZone() : (0,dist.$location)(src_templateObject14 || (src_templateObject14 = src_taggedTemplateLiteral(["Barf Mountain"])));

  if (!(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || waterBreathingEquipment.some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || familiarWaterBreathingEquipment.some(dist.have)) && ((0,dist.have)((0,dist.$effect)(src_templateObject15 || (src_templateObject15 = src_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(src_templateObject16 || (src_templateObject16 = src_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(src_templateObject17 || (src_templateObject17 = src_taggedTemplateLiteral(["envyfish egg"])))) && embezzlerUp) {
    // now fight one underwater
    if ((0,dist.get)("questS01OldGuy") === "unstarted") {
      (0,external_kolmafia_.visitUrl)("place.php?whichplace=sea_oldman&action=oldman_oldman");
    }

    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(src_templateObject18 || (src_templateObject18 = src_taggedTemplateLiteral(["pulled green taffy"]))));
    if (!(0,dist.have)((0,dist.$effect)(src_templateObject19 || (src_templateObject19 = src_taggedTemplateLiteral(["Fishy"]))))) (0,external_kolmafia_.use)((0,dist.$item)(src_templateObject20 || (src_templateObject20 = src_taggedTemplateLiteral(["fishy pipe"]))));
    location = (0,dist.$location)(src_templateObject21 || (src_templateObject21 = src_taggedTemplateLiteral(["The Briny Deeps"])));
  }

  var underwater = location === (0,dist.$location)(src_templateObject22 || (src_templateObject22 = src_taggedTemplateLiteral(["The Briny Deeps"])));
  ...
  if ((0,dist.have)((0,dist.$item)(src_templateObject23 || (src_templateObject23 = src_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("_envyfishEggUsed")) {
    meatOutfit(true);
    ...
    (0,dist.adventureMacroAuto)(location, combat.Macro.externalIf(underwater, combat.Macro.if_("monsterid ".concat((0,dist.$monster)(src_templateObject29 || (src_templateObject29 = src_taggedTemplateLiteral(["Knob Goblin Embezzler"]))).id), combat.Macro.item("pulled green taffy"))).meatKill(), combat.Macro.if_("(monsterid ".concat((0,dist.$monster)(src_templateObject30 || (src_templateObject30 = src_taggedTemplateLiteral(["Knob Goblin Embezzler"]))).id, ") && !gotjump && !(pastround 2)"), combat.Macro.externalIf(underwater, combat.Macro.item("pulled green taffy")).meatKill()).abort());
  }
  ...
  if ((0,external_kolmafia_.myAdventures)() === 1) {
    if (((0,dist.have)((0,dist.$item)(src_templateObject31 || (src_templateObject31 = src_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(src_templateObject32 || (src_templateObject32 = src_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(src_templateObject33 || (src_templateObject33 = src_taggedTemplateLiteral(["magical sausage"]))));
    }
  }
...
function main() {
  ...
  var gardens = (0,dist.$items)(src_templateObject34 || (src_templateObject34 = src_taggedTemplateLiteral(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores"])));
  ...
  try {
    ...
    if ((0,dist.have)((0,dist.$item)(src_templateObject35 || (src_templateObject35 = src_taggedTemplateLiteral(["packet of tall grass seeds"])))) && (0,external_kolmafia_.myGardenType)() !== "grass") (0,external_kolmafia_.use)((0,dist.$item)(src_templateObject36 || (src_templateObject36 = src_taggedTemplateLiteral(["packet of tall grass seeds"]))));
    (0,external_kolmafia_.setAutoAttack)(0);
    ...
    (0,property.withProperties)({
      ...
      if ((0,external_kolmafia_.myClass)() === (0,dist.$class)(src_templateObject37 || (src_templateObject37 = src_taggedTemplateLiteral(["Seal Clubber"]))) && !(0,dist.have)((0,dist.$skill)(src_templateObject38 || (src_templateObject38 = src_taggedTemplateLiteral(["Furious Wallop"])))) && (0,external_kolmafia_.guildStoreAvailable)()) {
        (0,external_kolmafia_.visitUrl)("guild.php?action=buyskill&skillid=32", true);
      }

      var stashItems = (0,dist.$items)(src_templateObject39 || (src_templateObject39 = src_taggedTemplateLiteral(["repaid diaper, Buddy Bjorn, Crown of Thrones, origami pasties, Pantsgiving"])));
      if ((0,external_kolmafia_.myInebriety)() <= (0,external_kolmafia_.inebrietyLimit)() && ((0,external_kolmafia_.myClass)() !== (0,dist.$class)(src_templateObject40 || (src_templateObject40 = src_taggedTemplateLiteral(["Seal Clubber"]))) || !(0,dist.have)((0,dist.$skill)(src_templateObject41 || (src_templateObject41 = src_taggedTemplateLiteral(["Furious Wallop"])))))) stashItems.push((0,dist.$item)(src_templateObject42 || (src_templateObject42 = src_taggedTemplateLiteral(["haiku katana"])))); // FIXME: Dynamically figure out pointer ring approach.
      ...
      withStash(stashItems, function () {
        withVIPClan(function () {
          ...
          (0,dist.setDefaultMaximizeOptions)({
            preventEquip: (0,dist.$items)(src_templateObject43 || (src_templateObject43 = src_taggedTemplateLiteral(["broken champagne bottle, Spooky Putty snake, Spooky Putty mitre, Spooky Putty leotard, Spooky Putty ball, papier-mitre"])))
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 3253);
