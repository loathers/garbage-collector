...
var Macro = /*#__PURE__*/function (_LibramMacro) {
  ...
  _createClass(Macro, [{
    ...
    value: function meatStasis(checkPassive) {
      ...
      if (!checkPassive) {
        return this.trySkill((0,libram__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["Pocket Crumbs"])))).trySkill((0,libram__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral(["Extract"])))).externalIf((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myFamiliar)() === (0,libram__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["Hobo Monkey"]))), Macro.while_("!match \"shoulder, and hands you some Meat.\" && !pastround 20 && !hppercentbelow 25", Macro.item((0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["seal tooth"])))))).externalIf([(0,libram__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["Cocoabo"]))), (0,libram__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral(["Feather Boa Constrictor"]))), (0,libram__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["Ninja Pirate Zombie Robot"]))), (0,libram__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["Stocking Mimic"])))].includes((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myFamiliar)()), Macro.while_("!pastround 10 && !hppercentbelow 25", Macro.item((0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral(["seal tooth"])))))).externalIf((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEquipped)((0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["Buddy Bjorn"])))) || (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEquipped)((0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["Crown of Thrones"])))), Macro.while_("!pastround 3 && !hppercentbelow 25", Macro.item((0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral(["seal tooth"])))))).tryItem((0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral(["porquoise-handled sixgun"]))));
...
function testZoneAndUsePotionToAccess() {
  ...
  var blacklist = (0,dist.$locations)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["The Oasis, The Bubblin' Caldera, Barrrney's Barrr, The F'c'le, The Poop Deck, Belowdecks, 8-Bit Realm, Madness Bakery, The Secret Government Laboratory"])));
...
function testZoneForBackups(location) {
  var backupBlacklist = (0,dist.$locations)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["The Overgrown Lot, The Skeleton Store, The Mansion of Dr. Weirdeaux"])));
  return !backupBlacklist.includes(location) && location.combatPercent >= 100;
}

function testZoneForWanderers(location) {
  var wandererBlacklist = (0,dist.$locations)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["The Batrat and Ratbat Burrow, Guano Junction, The Beanbat Chamber"])));
...
function determineDraggableZoneAndEnsureAccess() {
  ...
  var defaultLocation = (0,dist.get)("_spookyAirportToday") || (0,dist.get)("spookyAirportAlways") ? (0,dist.$location)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["The Deep Dark Jungle"]))) : (0,dist.$location)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["Noob Cave"])));
  if (!dist.Guzzlr.have()) return defaultLocation;
  var predictedWanderers = digitizedMonstersRemaining() + ((0,dist.have)((0,dist.$item)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\"I Voted!\" sticker"])))) ? (0,dist.clamp)(3 - (0,dist.get)("_voteFreeFights"), 0, 3) : 0);
  var predictedBackups = (0,dist.have)((0,dist.$item)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["backup camera"])))) ? (0,dist.clamp)(11 - (0,dist.get)("_backUpUses"), 0, 11) : 0;
  ...
  var currentGuzzlrZone = dist.Guzzlr.getLocation() || (0,dist.$location)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["none"])));
...
function checkFax() {
  if (!(0,dist.have)((0,dist.$item)(embezzler_templateObject || (embezzler_templateObject = embezzler_taggedTemplateLiteral(["photocopied monster"]))))) (0,external_kolmafia_.cliExecute)("fax receive");
...
var embezzlerMacro = function embezzlerMacro() {
  return combat.Macro.if_("monstername Knob Goblin Embezzler", combat.Macro.if_("snarfblat 186", combat.Macro.tryCopier((0,dist.$item)(embezzler_templateObject2 || (embezzler_templateObject2 = embezzler_taggedTemplateLiteral(["pulled green taffy"]))))).trySkill((0,dist.$skill)(embezzler_templateObject3 || (embezzler_templateObject3 = embezzler_taggedTemplateLiteral(["Wink at"])))).trySkill((0,dist.$skill)(embezzler_templateObject4 || (embezzler_templateObject4 = embezzler_taggedTemplateLiteral(["Fire a badly romantic arrow"])))).externalIf((0,dist.get)("_sourceTerminalDigitizeMonster") !== (0,dist.$monster)(embezzler_templateObject5 || (embezzler_templateObject5 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))), combat.Macro.tryCopier((0,dist.$skill)(embezzler_templateObject6 || (embezzler_templateObject6 = embezzler_taggedTemplateLiteral(["Digitize"]))))).tryCopier((0,dist.$item)(embezzler_templateObject7 || (embezzler_templateObject7 = embezzler_taggedTemplateLiteral(["Spooky Putty sheet"])))).tryCopier((0,dist.$item)(embezzler_templateObject8 || (embezzler_templateObject8 = embezzler_taggedTemplateLiteral(["Rain-Doh black box"])))).tryCopier((0,dist.$item)(embezzler_templateObject9 || (embezzler_templateObject9 = embezzler_taggedTemplateLiteral(["4-d camera"])))).tryCopier((0,dist.$item)(embezzler_templateObject10 || (embezzler_templateObject10 = embezzler_taggedTemplateLiteral(["unfinished ice sculpture"])))).externalIf((0,dist.get)("_enamorangs") === 0, combat.Macro.tryCopier((0,dist.$item)(embezzler_templateObject11 || (embezzler_templateObject11 = embezzler_taggedTemplateLiteral(["LOV Enamorang"]))))).meatKill()).abort();
};
var embezzlerSources = [new EmbezzlerFight("Digitize", function () {
  return (0,dist.get)("_sourceTerminalDigitizeMonster") === (0,dist.$monster)(embezzler_templateObject12 || (embezzler_templateObject12 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,external_kolmafia_.getCounters)("Digitize Monster", 0, 0).trim() !== "";
}, function () {
  ...
  return (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject16 || (_templateObject16 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,dist.have)((0,dist.$item)(_templateObject17 || (_templateObject17 = embezzler_taggedTemplateLiteral(["backup camera"])))) && (0,dist.get)("_backUpUses") < 11;
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject18 || (_templateObject18 = embezzler_taggedTemplateLiteral(["backup camera"])))) ? 11 - (0,dist.get)("_backUpUses") : 0;
}, function (options) {
  ...
  (0,dist.adventureMacro)(realLocation, combat.Macro.if_("!monstername Knob Goblin Embezzler", combat.Macro.skill((0,dist.$skill)(_templateObject19 || (_templateObject19 = embezzler_taggedTemplateLiteral(["Back-Up to your Last Enemy"]))))).step(options.macro || embezzlerMacro()));
}, [new dist.Requirement([], {
  forceEquip: (0,dist.$items)(_templateObject20 || (_templateObject20 = embezzler_taggedTemplateLiteral(["backup camera"]))),
  bonusEquip: new Map([[(0,dist.$item)(_templateObject21 || (_templateObject21 = embezzler_taggedTemplateLiteral(["backup camera"]))), 5000]])
})], true), new EmbezzlerFight("Fax", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject22 || (_templateObject22 = embezzler_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject23 || (_templateObject23 = embezzler_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed") ? 1 : 0;
}, function () {
  faxEmbezzler();
  (0,external_kolmafia_.use)((0,dist.$item)(_templateObject24 || (_templateObject24 = embezzler_taggedTemplateLiteral(["photocopied monster"]))));
}), new EmbezzlerFight("Pillkeeper Semirare", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject25 || (_templateObject25 = embezzler_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(_templateObject26 || (_templateObject26 = embezzler_taggedTemplateLiteral(["Cobb's Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject27 || (_templateObject27 = embezzler_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(_templateObject28 || (_templateObject28 = embezzler_taggedTemplateLiteral(["Cobb's Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed") ? 1 : 0;
}, function () {
  (0,external_kolmafia_.cliExecute)("pillkeeper semirare");
  (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject29 || (_templateObject29 = embezzler_taggedTemplateLiteral(["Cobb's Knob Treasury"]))));
}), new EmbezzlerFight("Chateau Painting", function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(_templateObject30 || (_templateObject30 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(_templateObject31 || (_templateObject31 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) ? 1 : 0;
}, function () {
  return dist.ChateauMantegna.fightPainting();
}), new EmbezzlerFight("Spooky Putty & Rain-Doh", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject32 || (_templateObject32 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"])))) && (0,dist.get)("spookyPuttyMonster") === (0,dist.$monster)(_templateObject33 || (_templateObject33 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) || (0,dist.have)((0,dist.$item)(_templateObject34 || (_templateObject34 = embezzler_taggedTemplateLiteral(["Rain-Doh box full of monster"])))) && (0,dist.get)("rainDohMonster") === (0,dist.$monster)(_templateObject35 || (_templateObject35 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  if (((0,dist.have)((0,dist.$item)(_templateObject36 || (_templateObject36 = embezzler_taggedTemplateLiteral(["Spooky Putty sheet"])))) || (0,dist.have)((0,dist.$item)(_templateObject37 || (_templateObject37 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"]))))) && ((0,dist.have)((0,dist.$item)(_templateObject38 || (_templateObject38 = embezzler_taggedTemplateLiteral(["Rain-Doh black box"])))) || (0,dist.have)((0,dist.$item)(_templateObject39 || (_templateObject39 = embezzler_taggedTemplateLiteral(["Rain-Doh box full of monster"])))))) {
    return 6 - (0,dist.get)("spookyPuttyCopiesMade") - (0,dist.get)("_raindohCopiesMade") + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject40 || (_templateObject40 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"])))) + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject41 || (_templateObject41 = embezzler_taggedTemplateLiteral(["Rain-Doh box full of monster"]))));
  } else if ((0,dist.have)((0,dist.$item)(_templateObject42 || (_templateObject42 = embezzler_taggedTemplateLiteral(["Spooky Putty sheet"])))) || (0,dist.have)((0,dist.$item)(_templateObject43 || (_templateObject43 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"]))))) {
    return 5 - (0,dist.get)("spookyPuttyCopiesMade") + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject44 || (_templateObject44 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"]))));
  } else if ((0,dist.have)((0,dist.$item)(_templateObject45 || (_templateObject45 = embezzler_taggedTemplateLiteral(["Rain-Doh black box"])))) || (0,dist.have)((0,dist.$item)(_templateObject46 || (_templateObject46 = embezzler_taggedTemplateLiteral(["Rain-Doh box full of monster"]))))) {
    return 5 - (0,dist.get)("_raindohCopiesMade") + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject47 || (_templateObject47 = embezzler_taggedTemplateLiteral(["Rain-Doh box full of monster"]))));
  }

  return 0;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject48 || (_templateObject48 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"]))))) return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject49 || (_templateObject49 = embezzler_taggedTemplateLiteral(["Spooky Putty monster"]))));
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject50 || (_templateObject50 = embezzler_taggedTemplateLiteral(["Rain-Doh box full of monster"]))));
}), new EmbezzlerFight("4-d Camera", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject51 || (_templateObject51 = embezzler_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(_templateObject52 || (_templateObject52 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject53 || (_templateObject53 = embezzler_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(_templateObject54 || (_templateObject54 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject55 || (_templateObject55 = embezzler_taggedTemplateLiteral(["shaking 4-d camera"]))));
}), new EmbezzlerFight("Ice Sculpture", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject56 || (_templateObject56 = embezzler_taggedTemplateLiteral(["ice sculpture"])))) && (0,dist.get)("iceSculptureMonster") === (0,dist.$monster)(_templateObject57 || (_templateObject57 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_iceSculptureUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject58 || (_templateObject58 = embezzler_taggedTemplateLiteral(["ice sculpture"])))) && (0,dist.get)("iceSculptureMonster") === (0,dist.$monster)(_templateObject59 || (_templateObject59 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_iceSculptureUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject60 || (_templateObject60 = embezzler_taggedTemplateLiteral(["ice sculpture"]))));
}), new EmbezzlerFight("Green Taffy", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject61 || (_templateObject61 = embezzler_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(_templateObject62 || (_templateObject62 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject63 || (_templateObject63 = embezzler_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(_templateObject64 || (_templateObject64 = embezzler_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject65 || (_templateObject65 = embezzler_taggedTemplateLiteral(["envyfish egg"]))));
}), new EmbezzlerFight("Professor MeatChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject66 || (_templateObject66 = embezzler_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false) ? 10 : 0;
}, function () {
  return;
}), new EmbezzlerFight("Professor WeightChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject67 || (_templateObject67 = embezzler_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false) ? 5 : 0;
}, function () {
  return;
})];
function embezzlerCount() {
  return (0,dist.sum)(embezzlerSources, function (source) {
    return source.potential();
  });
}
function estimatedTurns() {
  var turns;
  if (globalOptions.stopTurncount) turns = globalOptions.stopTurncount - (0,external_kolmafia_.myTurncount)();else if (globalOptions.noBarf) turns = embezzlerCount();else turns = ((0,external_kolmafia_.myAdventures)() + (globalOptions.ascending && (0,external_kolmafia_.myInebriety)() <= (0,external_kolmafia_.inebrietyLimit)() ? 60 : 0)) * ((0,dist.have)((0,dist.$item)(_templateObject68 || (_templateObject68 = embezzler_taggedTemplateLiteral(["mafia thumb ring"])))) ? 1.04 : 1);
  return turns;
}
;// CONCATENATED MODULE: ./src/lib.ts
var lib_templateObject, lib_templateObject2, lib_templateObject3, lib_templateObject4, lib_templateObject5, lib_templateObject6, lib_templateObject7, lib_templateObject8, lib_templateObject9, lib_templateObject10, lib_templateObject11, lib_templateObject12, lib_templateObject13, lib_templateObject14, lib_templateObject15, lib_templateObject16, lib_templateObject17, lib_templateObject18, lib_templateObject19, lib_templateObject20, lib_templateObject21, lib_templateObject22, lib_templateObject23, lib_templateObject24, lib_templateObject25, lib_templateObject26, lib_templateObject27, lib_templateObject28, lib_templateObject29, lib_templateObject30, lib_templateObject31, lib_templateObject32, lib_templateObject33, lib_templateObject34, lib_templateObject35, lib_templateObject36, lib_templateObject37, lib_templateObject38, lib_templateObject39, lib_templateObject40, lib_templateObject41, lib_templateObject42, lib_templateObject43, lib_templateObject44, lib_templateObject45, lib_templateObject46, lib_templateObject47, lib_templateObject48, lib_templateObject49, lib_templateObject50, lib_templateObject51, lib_templateObject52, lib_templateObject53, lib_templateObject54, lib_templateObject55, lib_templateObject56, lib_templateObject57, lib_templateObject58, lib_templateObject59, lib_templateObject60, lib_templateObject61, lib_templateObject62, lib_templateObject63, lib_templateObject64, lib_templateObject65, lib_templateObject66, lib_templateObject67;
...
function tryFeast(familiar) {
  if ((0,dist.have)(familiar)) {
    ...
    (0,external_kolmafia_.use)((0,dist.$item)(lib_templateObject3 || (lib_templateObject3 = lib_taggedTemplateLiteral(["moveable feast"]))));
  }
}
var FreeRun = function FreeRun(name, available, macro, requirement, prepare) {
...
new FreeRun("Bander", function () {
  return (0,dist.have)((0,dist.$familiar)(lib_templateObject4 || (lib_templateObject4 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"])))) && ((0,dist.have)((0,dist.$effect)(lib_templateObject5 || (lib_templateObject5 = lib_taggedTemplateLiteral(["Ode to Booze"])))) || (0,dist.getSongCount)() < (0,dist.getSongLimit)()) && dist.Bandersnatch.getRemainingRunaways() > 0;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject6 || (lib_templateObject6 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).step("runaway"), new dist.Requirement(["Familiar Weight"], {}), function () {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(lib_templateObject7 || (lib_templateObject7 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  (0,dist.ensureEffect)((0,dist.$effect)(lib_templateObject8 || (lib_templateObject8 = lib_taggedTemplateLiteral(["Ode to Booze"]))));
}), new FreeRun("Boots", function () {
  return (0,dist.have)((0,dist.$familiar)(lib_templateObject9 || (lib_templateObject9 = lib_taggedTemplateLiteral(["Pair of Stomping Boots"])))) && dist.Bandersnatch.getRemainingRunaways() > 0;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject10 || (lib_templateObject10 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).step("runaway"), new dist.Requirement(["Familiar Weight"], {}), function () {
  return (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(lib_templateObject11 || (lib_templateObject11 = lib_taggedTemplateLiteral(["Pair of Stomping Boots"]))));
}), new FreeRun("Snokebomb", function () {
  return (0,dist.get)("_snokebombUsed") < banishesToUse && (0,dist.have)((0,dist.$skill)(lib_templateObject12 || (lib_templateObject12 = lib_taggedTemplateLiteral(["Snokebomb"]))));
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill((0,dist.$skill)(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["Snokebomb"])))), undefined, function () {
  return (0,external_kolmafia_.restoreMp)(50);
}), new FreeRun("Hatred", function () {
  return (0,dist.get)("_feelHatredUsed") < banishesToUse && (0,dist.have)((0,dist.$skill)(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["Emotionally Chipped"]))));
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject16 || (lib_templateObject16 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill((0,dist.$skill)(lib_templateObject17 || (lib_templateObject17 = lib_taggedTemplateLiteral(["Feel Hatred"]))))), new FreeRun("KGB", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject18 || (lib_templateObject18 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))) && (0,dist.get)("_kgbTranquilizerDartUses") < 3;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject19 || (lib_templateObject19 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill((0,dist.$skill)(lib_templateObject20 || (lib_templateObject20 = lib_taggedTemplateLiteral(["KGB tranquilizer dart"])))), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))
})), new FreeRun("Latte", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject22 || (lib_templateObject22 = lib_taggedTemplateLiteral(["latte lovers member's mug"])))) && !(0,dist.get)("_latteBanishUsed");
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject23 || (lib_templateObject23 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill("Throw Latte on Opponent"), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject24 || (lib_templateObject24 = lib_taggedTemplateLiteral(["latte lovers member's mug"])))
})), new FreeRun("Docbag", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject25 || (lib_templateObject25 = lib_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && (0,dist.get)("_reflexHammerUsed") < 3;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject26 || (lib_templateObject26 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill((0,dist.$skill)(lib_templateObject27 || (lib_templateObject27 = lib_taggedTemplateLiteral(["Reflex Hammer"])))), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject28 || (lib_templateObject28 = lib_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
})), new FreeRun("Middle Finger", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject29 || (lib_templateObject29 = lib_taggedTemplateLiteral(["mafia middle finger ring"])))) && !(0,dist.get)("_mafiaMiddleFingerRingUsed");
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject30 || (lib_templateObject30 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill((0,dist.$skill)(lib_templateObject31 || (lib_templateObject31 = lib_taggedTemplateLiteral(["Show them your ring"])))), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject32 || (lib_templateObject32 = lib_taggedTemplateLiteral(["mafia middle finger ring"])))
})), new FreeRun("VMask", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject33 || (lib_templateObject33 = lib_taggedTemplateLiteral(["V for Vivala mask"])))) && !(0,dist.get)("_vmaskBanisherUsed");
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject34 || (lib_templateObject34 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill((0,dist.$skill)(lib_templateObject35 || (lib_templateObject35 = lib_taggedTemplateLiteral(["Creepy Grin"])))), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject36 || (lib_templateObject36 = lib_taggedTemplateLiteral(["V for Vivala mask"])))
}), function () {
  return (0,external_kolmafia_.restoreMp)(30);
}), new FreeRun("Stinkeye", function () {
  return (0,dist.getFoldGroup)((0,dist.$item)(lib_templateObject37 || (lib_templateObject37 = lib_taggedTemplateLiteral(["stinky cheese diaper"])))).some(function (item) {
    return (0,dist.have)(item);
  }) && !(0,dist.get)("_stinkyCheeseBanisherUsed");
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject38 || (lib_templateObject38 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill("Give Your Opponent the Stinkeye"), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject39 || (lib_templateObject39 = lib_taggedTemplateLiteral(["stinky cheese eye"])))
}), function () {
  if (!(0,dist.have)((0,dist.$item)(lib_templateObject40 || (lib_templateObject40 = lib_taggedTemplateLiteral(["stinky cheese eye"]))))) (0,external_kolmafia_.cliExecute)("fold stinky cheese eye");
}), new FreeRun("Navel Ring", function () {
...
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject42 || (lib_templateObject42 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).step("runaway"), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject43 || (lib_templateObject43 = lib_taggedTemplateLiteral(["navel ring of navel gazing"])))
})), new FreeRun("GAP", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject44 || (lib_templateObject44 = lib_taggedTemplateLiteral(["Greatest American Pants"])))) && (0,dist.get)("_navelRunaways") < 3;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject45 || (lib_templateObject45 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).step("runaway"), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject46 || (lib_templateObject46 = lib_taggedTemplateLiteral(["Greatest American Pants"])))
})), new FreeRun("Scrapbook", function () {
  (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=463063785");
  return (0,dist.have)((0,dist.$item)(lib_templateObject47 || (lib_templateObject47 = lib_taggedTemplateLiteral(["familiar scrapbook"])))) && (0,dist.get)("scrapbookCharges") >= 100;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject48 || (lib_templateObject48 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill("Show Your Boring Familiar Pictures"), new dist.Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject49 || (lib_templateObject49 = lib_taggedTemplateLiteral(["familiar scrapbook"])))
})), new FreeRun("Parasol", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject50 || (lib_templateObject50 = lib_taggedTemplateLiteral(["peppermint parasol"])))) && globalOptions.ascending && (0,dist.get)("parasolUsed") < 9 && (0,dist.get)("_navelRunaways") < 3;
}, dist.Macro.trySkill((0,dist.$skill)(lib_templateObject51 || (lib_templateObject51 = lib_taggedTemplateLiteral(["Asdon Martin: Spring-Loaded Front Bumper"])))).item((0,dist.$item)(lib_templateObject52 || (lib_templateObject52 = lib_taggedTemplateLiteral(["peppermint parasol"])))))];
function findRun() {
  var useFamiliar = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
...
var ltbRun = new FreeRun("LTB", function () {
  return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(lib_templateObject53 || (lib_templateObject53 = lib_taggedTemplateLiteral(["Louder Than Bomb"]))));
}, dist.Macro.item((0,dist.$item)(lib_templateObject54 || (lib_templateObject54 = lib_taggedTemplateLiteral(["Louder Than Bomb"])))), new dist.Requirement([], {}), function () {
  return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(lib_templateObject55 || (lib_templateObject55 = lib_taggedTemplateLiteral(["Louder Than Bomb"]))));
});
function coinmasterPrice(item) {
  // TODO: Get this from coinmasters.txt if more are needed
  switch (item) {
    case (0,dist.$item)(lib_templateObject56 || (lib_templateObject56 = lib_taggedTemplateLiteral(["viral video"]))):
      return 20;

    case (0,dist.$item)(lib_templateObject57 || (lib_templateObject57 = lib_taggedTemplateLiteral(["plus one"]))):
      return 74;

    case (0,dist.$item)(lib_templateObject58 || (lib_templateObject58 = lib_taggedTemplateLiteral(["gallon of milk"]))):
      return 100;

    case (0,dist.$item)(lib_templateObject59 || (lib_templateObject59 = lib_taggedTemplateLiteral(["print screen button"]))):
      return 111;

    case (0,dist.$item)(lib_templateObject60 || (lib_templateObject60 = lib_taggedTemplateLiteral(["daily dungeon malware"]))):
      return 150;
  }
...
function kramcoGuaranteed() {
  return (0,dist.have)((0,dist.$item)(lib_templateObject61 || (lib_templateObject61 = lib_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))) && (0,dist.getKramcoWandererChance)() >= 1;
}
function leprechaunMultiplier(familiar) {
  if (familiar === (0,dist.$familiar)(lib_templateObject62 || (lib_templateObject62 = lib_taggedTemplateLiteral(["Mutant Cactus Bud"])))) return (0,external_kolmafia_.numericModifier)(familiar, "Leprechaun Effectiveness", 1, (0,dist.$item)(lib_templateObject63 || (lib_templateObject63 = lib_taggedTemplateLiteral(["none"]))));
  var meatBonus = (0,external_kolmafia_.numericModifier)(familiar, "Meat Drop", 1, (0,dist.$item)(lib_templateObject64 || (lib_templateObject64 = lib_taggedTemplateLiteral(["none"]))));
  return Math.pow(Math.sqrt(meatBonus / 2 + 55 / 4 + 3) - Math.sqrt(55) / 2, 2);
}
function fairyMultiplier(familiar) {
  if (familiar === (0,dist.$familiar)(lib_templateObject65 || (lib_templateObject65 = lib_taggedTemplateLiteral(["Mutant Fire Ant"])))) return (0,external_kolmafia_.numericModifier)(familiar, "Fairy Effectiveness", 1, (0,dist.$item)(lib_templateObject66 || (lib_templateObject66 = lib_taggedTemplateLiteral(["none"]))));
  var itemBonus = (0,external_kolmafia_.numericModifier)(familiar, "Item Drop", 1, (0,dist.$item)(lib_templateObject67 || (lib_templateObject67 = lib_taggedTemplateLiteral(["none"]))));
...
function runDiet() {
  ...
  if ((0,dist.have)((0,dist.$skill)(diet_templateObject67 || (diet_templateObject67 = diet_taggedTemplateLiteral(["Ancestral Recall"])))) && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject68 || (diet_templateObject68 = diet_taggedTemplateLiteral(["blue mana"])))) < 3 * MPA) {
    ...
    acquire(casts, (0,dist.$item)(_templateObject69 || (_templateObject69 = diet_taggedTemplateLiteral(["blue mana"]))), 3 * MPA);
    (0,external_kolmafia_.useSkill)(casts, (0,dist.$skill)(_templateObject70 || (_templateObject70 = diet_taggedTemplateLiteral(["Ancestral Recall"]))));
  }

  if (globalOptions.ascending) useIfUnused((0,dist.$item)(_templateObject71 || (_templateObject71 = diet_taggedTemplateLiteral(["borrowed time"]))), "_borrowedTimeUsed", 5 * MPA);
  fillSomeSpleen();
  fillStomach();
  fillLiver();

  if (!(0,dist.get)("_distentionPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(_templateObject72 || (_templateObject72 = diet_taggedTemplateLiteral(["distention pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(_templateObject73 || (_templateObject73 = diet_taggedTemplateLiteral(["distention pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(_templateObject74 || (_templateObject74 = diet_taggedTemplateLiteral(["distention pill"]))))) {
  ...
  if (!(0,dist.get)("_syntheticDogHairPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(_templateObject75 || (_templateObject75 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(_templateObject76 || (_templateObject76 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(_templateObject77 || (_templateObject77 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))))) {
  ...
  acquire(mojoFilterCount, (0,dist.$item)(_templateObject78 || (_templateObject78 = diet_taggedTemplateLiteral(["mojo filter"]))), valuePerSpleen(bestSpleenItem), false);

  if ((0,dist.have)((0,dist.$item)(_templateObject79 || (_templateObject79 = diet_taggedTemplateLiteral(["mojo filter"]))))) {
    (0,external_kolmafia_.use)(Math.min(mojoFilterCount, (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject80 || (_templateObject80 = diet_taggedTemplateLiteral(["mojo filter"]))))), (0,dist.$item)(_templateObject81 || (_templateObject81 = diet_taggedTemplateLiteral(["mojo filter"]))));
    fillSomeSpleen();
  }

  while ((0,external_kolmafia_.myFullness)() < (0,external_kolmafia_.fullnessLimit)()) {
    if ((0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject82 || (_templateObject82 = diet_taggedTemplateLiteral(["fudge spork"])))) < 3 * MPA && !(0,dist.get)("_fudgeSporkUsed")) (0,external_kolmafia_.eat)(1, (0,dist.$item)(_templateObject83 || (_templateObject83 = diet_taggedTemplateLiteral(["fudge spork"]))));
...
function pantsgiving() {
  ...
  var expectedUseableSinusTurns = globalOptions.ascending ? Math.min(estimatedTurns() - (0,external_kolmafia_.haveEffect)((0,dist.$effect)(outfit_templateObject72 || (outfit_templateObject72 = outfit_taggedTemplateLiteral(["Kicked in the Sinuses"])))), expectedSinusTurns, estimatedTurns() - (turns - count)) : expectedSinusTurns;
...
function cheeses(embezzlerUp) {
  return haveSomeCheese && !globalOptions.ascending && (0,dist.get)("_stinkyCheeseCount") < 100 && estimatedTurns() >= 100 - (0,dist.get)("_stinkyCheeseCount") && !embezzlerUp ? new Map((0,dist.getFoldGroup)((0,dist.$item)(outfit_templateObject77 || (outfit_templateObject77 = outfit_taggedTemplateLiteral(["stinky cheese diaper"])))).filter(function (item) {
...
new FreeRunFight(function () {
  ...
  requirements: function requirements() {
    ...
    return [new dist.Requirement((_zone$maximize = zone === null || zone === void 0 ? void 0 : zone.maximize) !== null && _zone$maximize !== void 0 ? _zone$maximize : [], {
      forceEquip: (0,dist.$items)(_templateObject324 || (_templateObject324 = fights_taggedTemplateLiteral(["industrial fire extinguisher"])))
    })];
  }
}), // Try for mini-hipster\goth kid free fights with any remaining non-familiar free runs
new FreeRunFight(function () {
  return (0,dist.get)("_hipsterAdv") < 7 && ((0,dist.have)((0,dist.$familiar)(_templateObject325 || (_templateObject325 = fights_taggedTemplateLiteral(["Mini-Hipster"])))) || (0,dist.have)((0,dist.$familiar)(_templateObject326 || (_templateObject326 = fights_taggedTemplateLiteral(["Artistic Goth Kid"])))));
}, function (runSource) {
  ...
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject327 || (_templateObject327 = fights_taggedTemplateLiteral(["Mini-Hipster"])))) ? (0,dist.$familiar)(_templateObject328 || (_templateObject328 = fights_taggedTemplateLiteral(["Mini-Hipster"]))) : (0,dist.$familiar)(_templateObject329 || (_templateObject329 = fights_taggedTemplateLiteral(["Artistic Goth Kid"])));
  },
  requirements: function requirements() {
    return [new dist.Requirement([], {
      bonusEquip: new Map((0,dist.have)((0,dist.$familiar)(_templateObject330 || (_templateObject330 = fights_taggedTemplateLiteral(["Mini-Hipster"])))) ? [[(0,dist.$item)(_templateObject331 || (_templateObject331 = fights_taggedTemplateLiteral(["ironic moustache"]))), (0,dist.getSaleValue)((0,dist.$item)(_templateObject332 || (_templateObject332 = fights_taggedTemplateLiteral(["mole skin notebook"]))))], [(0,dist.$item)(_templateObject333 || (_templateObject333 = fights_taggedTemplateLiteral(["chiptune guitar"]))), (0,dist.getSaleValue)((0,dist.$item)(_templateObject334 || (_templateObject334 = fights_taggedTemplateLiteral(["ironic knit cap"]))))], [(0,dist.$item)(_templateObject335 || (_templateObject335 = fights_taggedTemplateLiteral(["fixed-gear bicycle"]))), (0,dist.getSaleValue)((0,dist.$item)(_templateObject336 || (_templateObject336 = fights_taggedTemplateLiteral(["ironic oversized sunglasses"]))))]] : [])
    })];
  }
}), // Try for an ultra-rare with mayfly runs ;)
new FreeRunFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject337 || (_templateObject337 = fights_taggedTemplateLiteral(["mayfly bait necklace"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(_templateObject338 || (_templateObject338 = fights_taggedTemplateLiteral(["Cobb's Knob Menagerie, Level 1"]))), false) && (0,dist.get)("_mayflySummons") < 30;
}, function (runSource) {
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject339 || (_templateObject339 = fights_taggedTemplateLiteral(["Cobb's Knob Menagerie, Level 1"]))), combat.Macro.if_("monstername ".concat((0,dist.$monster)(_templateObject340 || (_templateObject340 = fights_taggedTemplateLiteral(["QuickBASIC Elemental"])))), combat.Macro.basicCombat()).if_("monstername ".concat((0,dist.$monster)(_templateObject341 || (_templateObject341 = fights_taggedTemplateLiteral(["BASIC Elemental"])))), combat.Macro.trySkill((0,dist.$skill)(_templateObject342 || (_templateObject342 = fights_taggedTemplateLiteral(["Summon Mayfly Swarm"]))))).step(runSource.macro));
}, {
  requirements: function requirements() {
    return [new dist.Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject343 || (_templateObject343 = fights_taggedTemplateLiteral(["mayfly bait necklace"])))
    })];
  }
})];
var freeKillSources = [new FreeFight(function () {
  return !(0,dist.get)("_gingerbreadMobHitUsed") && (0,dist.have)((0,dist.$skill)(_templateObject344 || (_templateObject344 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"]))));
}, function () {
  ensureBeachAccess();
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject345 || (_templateObject345 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject346 || (_templateObject346 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"])))), function () {
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject348 || (_templateObject348 = fights_taggedTemplateLiteral(["Shattering Punch"])))) ? (0,dist.clamp)(3 - (0,dist.get)("_shatteringPunchUsed"), 0, 3) : 0;
}, function () {
  ensureBeachAccess();
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject349 || (_templateObject349 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject350 || (_templateObject350 = fights_taggedTemplateLiteral(["Shattering Punch"])))), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject351 || (_templateObject351 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
new FreeFight(function () {
  return !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject352 || (_templateObject352 = fights_taggedTemplateLiteral(["The Jokester's gun"]))));
}, function () {
  ensureBeachAccess();
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject353 || (_templateObject353 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject354 || (_templateObject354 = fights_taggedTemplateLiteral(["Fire the Jokester's Gun"])))), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject355 || (_templateObject355 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
    return [new dist.Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject356 || (_templateObject356 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })];
  }
}), // 22	3	0	0	Chest X-Ray	combat skill	must have a Lil' Doctor™ bag equipped
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject357 || (_templateObject357 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? (0,dist.clamp)(3 - (0,dist.get)("_chestXRayUsed"), 0, 3) : 0;
}, function () {
  ensureBeachAccess();
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject358 || (_templateObject358 = fights_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(_templateObject359 || (_templateObject359 = fights_taggedTemplateLiteral(["Chest X-Ray"])))), function () {
  ...
  requirements: function requirements() {
    return [new dist.Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject361 || (_templateObject361 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject362 || (_templateObject362 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))) ? (0,dist.clamp)(3 - (0,dist.get)("_usedReplicaBatoomerang"), 0, 3) : 0;
}, function () {
  ensureBeachAccess();
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject363 || (_templateObject363 = fights_taggedTemplateLiteral(["Sing Along"])))).item((0,dist.$item)(_templateObject364 || (_templateObject364 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))), function () {
  ...
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject366 || (_templateObject366 = fights_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(_templateObject367 || (_templateObject367 = fights_taggedTemplateLiteral(["Asdon Martin: Missile Launcher"])))), function () {
  ...
  ensureBeachAccess();
  (0,combat.withMacro)(combat.Macro.trySkill((0,dist.$skill)(_templateObject369 || (_templateObject369 = fights_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(_templateObject370 || (_templateObject370 = fights_taggedTemplateLiteral(["Shocking Lick"])))), function () {
...
function freeFights() {
  ...
  if ((0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(_templateObject372 || (_templateObject372 = fights_taggedTemplateLiteral(["The Red Zeppelin"]))), false) && !(0,dist.have)((0,dist.$item)(_templateObject373 || (_templateObject373 = fights_taggedTemplateLiteral(["glark cable"]))), (0,dist.clamp)(5 - (0,dist.get)("_glarkCableUses"), 0, 5))) {
    (0,external_kolmafia_.buy)((0,dist.clamp)(5 - (0,dist.get)("_glarkCableUses"), 0, 5), (0,dist.$item)(_templateObject374 || (_templateObject374 = fights_taggedTemplateLiteral(["glark cable"]))), (0,dist.get)("garbo_valueOfFreeFight", 2000));
  }

  var stashRun = (0,external_kolmafia_.stashAmount)((0,dist.$item)(_templateObject375 || (_templateObject375 = fights_taggedTemplateLiteral(["navel ring of navel gazing"])))) ? (0,dist.$items)(_templateObject376 || (_templateObject376 = fights_taggedTemplateLiteral(["navel ring of navel gazing"]))) : (0,external_kolmafia_.stashAmount)((0,dist.$item)(_templateObject377 || (_templateObject377 = fights_taggedTemplateLiteral(["Greatest American Pants"])))) ? (0,dist.$items)(_templateObject378 || (_templateObject378 = fights_taggedTemplateLiteral(["Greatest American Pants"]))) : [];
  (0,external_kolmafia_.refreshStash)();
  ...
  try {
    ...
    try {
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
        ...
        if (freeKillSource.available()) {
          ...
          if ((0,dist.have)((0,dist.$skill)(_templateObject379 || (_templateObject379 = fights_taggedTemplateLiteral(["Emotionally Chipped"])))) && (0,dist.get)("_feelLostUsed") < 3) {
            (0,dist.ensureEffect)((0,dist.$effect)(_templateObject380 || (_templateObject380 = fights_taggedTemplateLiteral(["Feeling Lost"]))));
          }

          if ((0,dist.have)((0,dist.$skill)(_templateObject381 || (_templateObject381 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"])))) && !(0,dist.get)("_steelyEyedSquintUsed")) {
            (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject382 || (_templateObject382 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"]))));
          }
        }
    ...
    if ((0,dist.have)((0,dist.$item)(_templateObject383 || (_templateObject383 = fights_taggedTemplateLiteral(["January's Garbage Tote"]))))) (0,external_kolmafia_.cliExecute)("fold wad of used tape");
  }
}

function setNepQuestChoicesAndPrepItems() {
  if ((0,dist.get)("_questPartyFair") === "unstarted") {
    (0,external_kolmafia_.visitUrl)((0,external_kolmafia_.toUrl)((0,dist.$location)(_templateObject384 || (_templateObject384 = fights_taggedTemplateLiteral(["The Neverending Party"])))));
  ...
  if (quest === "food") {
    ...
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject385 || (_templateObject385 = fights_taggedTemplateLiteral(["cosmetic football"]))));

    if (!(0,dist.get)("_garbo_nepUsedElectronicsKit", false)) {
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject386 || (_templateObject386 = fights_taggedTemplateLiteral(["electronics kit"]))));
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject387 || (_templateObject387 = fights_taggedTemplateLiteral(["very small red dress"]))));
      setChoice(1324, 1); // Head upstairs

      setChoice(1325, 5); // Toss the red dress on the lamp

      if ((0,dist.have)((0,dist.$item)(_templateObject388 || (_templateObject388 = fights_taggedTemplateLiteral(["Clara's bell"])))) && !(0,dist.get)("_claraBellUsed")) {
        // We've used one item, ready to use the other - skip to next NC.
        (0,external_kolmafia_.use)((0,dist.$item)(_templateObject389 || (_templateObject389 = fights_taggedTemplateLiteral(["Clara's bell"]))));
      }
    }
  } else {
...
function thesisReady() {
  return !(0,dist.get)("_thesisDelivered") && (0,dist.have)((0,dist.$familiar)(_templateObject390 || (_templateObject390 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject391 || (_templateObject391 = fights_taggedTemplateLiteral(["Pocket Professor"]))).experience >= 400;
}
...
function deliverThesis() {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject392 || (_templateObject392 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
  freeFightMood().execute();
  freeFightOutfit([new dist.Requirement(["100 muscle"], {})]);
  safeRestore();

  if ((0,dist.have)((0,dist.$item)(_templateObject393 || (_templateObject393 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject394 || (_templateObject394 = fights_taggedTemplateLiteral(["Triple-Sized"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") <= 95) {
    (0,external_kolmafia_.cliExecute)("checkpoint");
    (0,external_kolmafia_.equip)((0,dist.$slot)(_templateObject395 || (_templateObject395 = fights_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject396 || (_templateObject396 = fights_taggedTemplateLiteral(["Powerful Glove"]))));
    (0,dist.ensureEffect)((0,dist.$effect)(_templateObject397 || (_templateObject397 = fights_taggedTemplateLiteral(["Triple-Sized"]))));
    (0,external_kolmafia_.outfit)("checkpoint");
  }

  (0,external_kolmafia_.cliExecute)("gain 1800 muscle");
  var thesisLocation = (0,dist.$location)(_templateObject398 || (_templateObject398 = fights_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"])));

  if (thesisInNEP) {
    //Set up NEP if we haven't yet
    setNepQuestChoicesAndPrepItems();
    thesisLocation = (0,dist.$location)(_templateObject399 || (_templateObject399 = fights_taggedTemplateLiteral(["The Neverending Party"])));
      ...
      if (!(0,dist.have)((0,dist.$item)(_templateObject400 || (_templateObject400 = fights_taggedTemplateLiteral(["transporter transponder"]))))) {
        acquire(1, (0,dist.$item)(_templateObject401 || (_templateObject401 = fights_taggedTemplateLiteral(["transporter transponder"]))), 10000);
      }

      (0,external_kolmafia_.use)((0,dist.$item)(_templateObject402 || (_templateObject402 = fights_taggedTemplateLiteral(["transporter transponder"]))));
      thesisLocation = (0,dist.$location)(_templateObject403 || (_templateObject403 = fights_taggedTemplateLiteral(["Hamburglaris Shield Generator"])));
    }

  (0,dist.adventureMacro)(thesisLocation, combat.Macro.if_("monsterid ".concat((0,external_kolmafia_.toInt)((0,dist.$monster)(_templateObject404 || (_templateObject404 = fights_taggedTemplateLiteral(["time-spinner prank"]))))), combat.Macro.basicCombat()).skill((0,dist.$skill)(_templateObject405 || (_templateObject405 = fights_taggedTemplateLiteral(["deliver your thesis!"])))));
}
...
function safeRestore() {
  ...
  if ((0,external_kolmafia_.myMp)() < 50 && (0,external_kolmafia_.myMaxmp)() > 50) {
    if (((0,dist.have)((0,dist.$item)(_templateObject406 || (_templateObject406 = fights_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(_templateObject407 || (_templateObject407 = fights_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject408 || (_templateObject408 = fights_taggedTemplateLiteral(["magical sausage"]))));
    }
...
function doSausage() {
  ...
  freeFightOutfit([new dist.Requirement([], {
    forceEquip: (0,dist.$items)(_templateObject409 || (_templateObject409 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
  })]);
...
function ensureBeachAccess() {
  ...
  /*Actually Ed the Undying*/
      ...
      (0,external_kolmafia_.cliExecute)("create ".concat((0,dist.$item)(_templateObject410 || (_templateObject410 = fights_taggedTemplateLiteral(["bitchin' meatcar"])))));
    }
}

var fireExtinguishZones = [{
  location: (0,dist.$location)(_templateObject411 || (_templateObject411 = fights_taggedTemplateLiteral(["The Deep Dark Jungle"]))),
  monster: (0,dist.$monster)(_templateObject412 || (_templateObject412 = fights_taggedTemplateLiteral(["smoke monster"]))),
  item: (0,dist.$item)(_templateObject413 || (_templateObject413 = fights_taggedTemplateLiteral(["transdermal smoke patch"]))),
  dropRate: 1,
  maximize: [],
  open: function open() {
  ...
  location: (0,dist.$location)(_templateObject414 || (_templateObject414 = fights_taggedTemplateLiteral(["The Ice Hotel"]))),
  monster: (0,dist.$monster)(_templateObject415 || (_templateObject415 = fights_taggedTemplateLiteral(["ice bartender"]))),
  item: (0,dist.$item)(_templateObject416 || (_templateObject416 = fights_taggedTemplateLiteral(["perfect ice cube"]))),
  dropRate: 1,
  maximize: [],
  open: function open() {
  ...
  location: (0,dist.$location)(_templateObject417 || (_templateObject417 = fights_taggedTemplateLiteral(["The Haunted Library"]))),
  monster: (0,dist.$monster)(_templateObject418 || (_templateObject418 = fights_taggedTemplateLiteral(["bookbat"]))),
  item: (0,dist.$item)(_templateObject419 || (_templateObject419 = fights_taggedTemplateLiteral(["tattered scrap of paper"]))),
  dropRate: 1,
  maximize: ["99 monster level 100 max"],
  // Bookbats need up to +100 ML to survive the polar vortices
  open: function open() {
    return (0,dist.have)((0,dist.$item)(_templateObject420 || (_templateObject420 = fights_taggedTemplateLiteral(["[7302]Spookyraven library key"]))));
  }
}, {
  location: (0,dist.$location)(_templateObject421 || (_templateObject421 = fights_taggedTemplateLiteral(["Twin Peak"]))),
  monster: (0,dist.$monster)(_templateObject422 || (_templateObject422 = fights_taggedTemplateLiteral(["bearpig topiary animal"]))),
  item: (0,dist.$item)(_templateObject423 || (_templateObject423 = fights_taggedTemplateLiteral(["rusty hedge trimmers"]))),
  dropRate: 0.5,
  maximize: ["99 monster level 11 max"],
  // Topiary animals need an extra 11 HP to survive polar vortices
  open: function open() {
    return (0,external_kolmafia_.myLevel)() >= 9 && (0,dist.get)("chasmBridgeProgress") >= 30 && (0,dist.get)("twinPeakProgress") >= 15;
  }
}];
...
function voterSetup() {
  ...
  var voterValueTable = [{
    monster: (0,dist.$monster)(dailies_templateObject13 || (dailies_templateObject13 = dailies_taggedTemplateLiteral(["terrible mutant"]))),
    value: (0,dist.getSaleValue)((0,dist.$item)(dailies_templateObject14 || (dailies_templateObject14 = dailies_taggedTemplateLiteral(["glob of undifferentiated tissue"])))) + 10
  }, {
    monster: (0,dist.$monster)(dailies_templateObject15 || (dailies_templateObject15 = dailies_taggedTemplateLiteral(["angry ghost"]))),
    value: (0,dist.getSaleValue)((0,dist.$item)(dailies_templateObject16 || (dailies_templateObject16 = dailies_taggedTemplateLiteral(["ghostly ectoplasm"])))) * 1.11
  }, {
    monster: (0,dist.$monster)(dailies_templateObject17 || (dailies_templateObject17 = dailies_taggedTemplateLiteral(["government bureaucrat"]))),
    value: (0,dist.getSaleValue)((0,dist.$item)(dailies_templateObject18 || (dailies_templateObject18 = dailies_taggedTemplateLiteral(["absentee voter ballot"])))) * 0.05 + 75 * 0.25 + 50
  }, {
    monster: (0,dist.$monster)(dailies_templateObject19 || (dailies_templateObject19 = dailies_taggedTemplateLiteral(["annoyed snake"]))),
    value: 25 * 0.5 + 25
  }, {
    monster: (0,dist.$monster)(dailies_templateObject20 || (dailies_templateObject20 = dailies_taggedTemplateLiteral(["slime blob"]))),
...
function configureGear() {
  if ((0,dist.have)((0,dist.$familiar)(dailies_templateObject21 || (dailies_templateObject21 = dailies_taggedTemplateLiteral(["Cornbeefadon"])))) && !(0,dist.have)((0,dist.$item)(dailies_templateObject22 || (dailies_templateObject22 = dailies_taggedTemplateLiteral(["amulet coin"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(dailies_templateObject23 || (dailies_templateObject23 = dailies_taggedTemplateLiteral(["Cornbeefadon"]))));
    (0,external_kolmafia_.use)((0,dist.$item)(dailies_templateObject24 || (dailies_templateObject24 = dailies_taggedTemplateLiteral(["box of Familiar Jacks"]))));
  }

  if ((0,dist.have)((0,dist.$item)(dailies_templateObject25 || (dailies_templateObject25 = dailies_taggedTemplateLiteral(["portable pantogram"])))) && !(0,dist.have)((0,dist.$item)(dailies_templateObject26 || (dailies_templateObject26 = dailies_taggedTemplateLiteral(["pantogram pants"]))))) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(dailies_templateObject27 || (dailies_templateObject27 = dailies_taggedTemplateLiteral(["ten-leaf clover"]))));
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(dailies_templateObject28 || (dailies_templateObject28 = dailies_taggedTemplateLiteral(["porquoise"]))));
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(dailies_templateObject29 || (dailies_templateObject29 = dailies_taggedTemplateLiteral(["bubblin' crude"]))));
    var m = new Map([[(0,dist.$stat)(dailies_templateObject30 || (dailies_templateObject30 = dailies_taggedTemplateLiteral(["Muscle"]))), 1], [(0,dist.$stat)(dailies_templateObject31 || (dailies_templateObject31 = dailies_taggedTemplateLiteral(["Mysticality"]))), 2], [(0,dist.$stat)(dailies_templateObject32 || (dailies_templateObject32 = dailies_taggedTemplateLiteral(["Moxie"]))), 3]]).get((0,external_kolmafia_.myPrimestat)());
  ...
  if ((0,dist.have)((0,dist.$item)(dailies_templateObject33 || (dailies_templateObject33 = dailies_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) && (0,dist.get)("_saberMod") === 0) {
    // Get familiar weight.
    (0,external_kolmafia_.visitUrl)("main.php?action=may4");
    (0,external_kolmafia_.runChoice)(4);
  }

  if ((0,dist.have)((0,dist.$item)(dailies_templateObject34 || (dailies_templateObject34 = dailies_taggedTemplateLiteral(["Bastille Battalion control rig"])))) && (0,dist.get)("_bastilleGames") === 0) {
    (0,external_kolmafia_.cliExecute)("bastille myst brutalist gesture");
  }
}

function prepFamiliars() {
  if ((0,dist.have)((0,dist.$familiar)(dailies_templateObject35 || (dailies_templateObject35 = dailies_taggedTemplateLiteral(["Robortender"]))))) {
    var _iterator = dailies_createForOfIteratorHelper((0,dist.$items)(dailies_templateObject36 || (dailies_templateObject36 = dailies_taggedTemplateLiteral(["Newark, drive-by shooting, Feliz Navidad, single entendre, Bloody Nora"])))),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(dailies_templateObject37 || (dailies_templateObject37 = dailies_taggedTemplateLiteral(["Robortender"]))));
  ...
  if ((0,dist.have)((0,dist.$item)(dailies_templateObject38 || (dailies_templateObject38 = dailies_taggedTemplateLiteral(["mumming trunk"])))) && !(0,dist.get)("_mummeryMods").includes("Meat Drop")) {
    (0,external_kolmafia_.useFamiliar)(meatFamiliar());
    (0,external_kolmafia_.cliExecute)("mummery meat");
  }

  if ((0,dist.have)((0,dist.$item)(dailies_templateObject39 || (dailies_templateObject39 = dailies_taggedTemplateLiteral(["mumming trunk"])))) && !(0,dist.get)("_mummeryMods").includes("Item Drop") && (0,dist.have)((0,dist.$familiar)(dailies_templateObject40 || (dailies_templateObject40 = dailies_taggedTemplateLiteral(["Trick-or-Treating Tot"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(dailies_templateObject41 || (dailies_templateObject41 = dailies_taggedTemplateLiteral(["Trick-or-Treating Tot"]))));
    (0,external_kolmafia_.cliExecute)("mummery item");
  }

  if ((0,dist.get)("_feastUsed") === 0) {
    withStash((0,dist.$items)(dailies_templateObject42 || (dailies_templateObject42 = dailies_taggedTemplateLiteral(["moveable feast"]))), function () {
      if ((0,dist.have)((0,dist.$item)(dailies_templateObject43 || (dailies_templateObject43 = dailies_taggedTemplateLiteral(["moveable feast"]))))) [].concat(dailies_toConsumableArray((0,dist.$familiars)(dailies_templateObject44 || (dailies_templateObject44 = dailies_taggedTemplateLiteral(["Pocket Professor, Frumious Bandersnatch, Pair of Stomping Boots"])))), [meatFamiliar()]).forEach(tryFeast);
    });
  }
}
...
function dailyBuffs() {
  if (!(0,dist.get)("_clanFortuneBuffUsed") && (0,dist.have)((0,dist.$item)(dailies_templateObject45 || (dailies_templateObject45 = dailies_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && (0,external_kolmafia_.getClanLounge)()["Clan Carnival Game"] !== undefined) {
  ...
  if (!(0,dist.get)("_madTeaParty")) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(dailies_templateObject46 || (dailies_templateObject46 = dailies_taggedTemplateLiteral(["filthy knitted dread sack"]))));
    (0,dist.ensureEffect)((0,dist.$effect)(dailies_templateObject47 || (dailies_templateObject47 = dailies_taggedTemplateLiteral(["Down the Rabbit Hole"]))));
...
function configureMisc() {
  ...
  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(dailies_templateObject48 || (dailies_templateObject48 = dailies_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(dailies_templateObject49 || (dailies_templateObject49 = dailies_taggedTemplateLiteral(["Digitize"])))]);
    dist.SourceTerminal.enquiry((0,dist.$effect)(dailies_templateObject50 || (dailies_templateObject50 = dailies_taggedTemplateLiteral(["familiar.enq"]))));
  }

  var _iterator2 = dailies_createForOfIteratorHelper([[(0,dist.$item)(dailies_templateObject52 || (dailies_templateObject52 = dailies_taggedTemplateLiteral(["BittyCar MeatCar"]))), "meatcar"], [(0,dist.$item)(dailies_templateObject53 || (dailies_templateObject53 = dailies_taggedTemplateLiteral(["BittyCar SoulCar"]))), "soulcar"]]),
      _step2;
  ...
  if ((0,external_kolmafia_.getClanLounge)()["Olympic-sized Clan crate"] !== undefined && !(0,dist.get)("_olympicSwimmingPoolItemFound") && (0,dist.have)((0,dist.$item)(dailies_templateObject51 || (dailies_templateObject51 = dailies_taggedTemplateLiteral(["Clan VIP Lounge key"]))))) {
...
function configureThrall() {
  if ((0,external_kolmafia_.myClass)() === (0,dist.$class)(dailies_templateObject54 || (dailies_templateObject54 = dailies_taggedTemplateLiteral(["Pastamancer"]))) && (0,external_kolmafia_.myThrall)() !== (0,dist.$thrall)(dailies_templateObject55 || (dailies_templateObject55 = dailies_taggedTemplateLiteral(["Lasagmbie"]))) && (0,external_kolmafia_.haveSkill)((0,dist.$skill)(dailies_templateObject56 || (dailies_templateObject56 = dailies_taggedTemplateLiteral(["Bind Lasagmbie"]))))) {
    (0,external_kolmafia_.useSkill)((0,dist.$skill)(dailies_templateObject57 || (dailies_templateObject57 = dailies_taggedTemplateLiteral(["Bind Lasagmbie"]))));
  }

  if ((0,external_kolmafia_.myClass)() === (0,dist.$class)(dailies_templateObject58 || (dailies_templateObject58 = dailies_taggedTemplateLiteral(["Pastamancer"]))) && (0,dist.have)((0,dist.$item)(dailies_templateObject59 || (dailies_templateObject59 = dailies_taggedTemplateLiteral(["experimental carbon fiber pasta additive"])))) && !(0,dist.get)("_pastaAdditive") && (0,external_kolmafia_.myThrall)().level < 10) {
    (0,external_kolmafia_.use)((0,dist.$item)(dailies_templateObject60 || (dailies_templateObject60 = dailies_taggedTemplateLiteral(["experimental carbon fiber pasta additive"]))));
  }
}
...
function configureVykea() {
  if ((0,dist.get)("_VYKEACompanionLevel") === 0) {
    ...
    var vykeaProfit = function vykeaProfit(level, cost) {
      return estimatedTurns() * baseMeat * 0.1 * level - (5 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject61 || (dailies_templateObject61 = dailies_taggedTemplateLiteral(["VYKEA rail"])))) + cost * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject62 || (dailies_templateObject62 = dailies_taggedTemplateLiteral(["VYKEA dowel"])))) + 5 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject63 || (dailies_templateObject63 = dailies_taggedTemplateLiteral(["VYKEA plank"])))) + 1 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject64 || (dailies_templateObject64 = dailies_taggedTemplateLiteral(["VYKEA instructions"])))));
    };
    ...
    if (vykeas.some(function (_ref) {
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(dailies_templateObject65 || (dailies_templateObject65 = dailies_taggedTemplateLiteral(["VYKEA hex key"]))));
...
function volcanoDailies() {
  ...
  if (!(0,dist.get)("_infernoDiscoVisited")) {
    (0,dist.$items)(dailies_templateObject66 || (dailies_templateObject66 = dailies_taggedTemplateLiteral(["smooth velvet pocket square, smooth velvet socks, smooth velvet hat, smooth velvet shirt, smooth velvet hanky, smooth velvet pants"]))).forEach(function (discoEquip) {
  ...
  if ((0,dist.have)((0,dist.$skill)(dailies_templateObject67 || (dailies_templateObject67 = dailies_taggedTemplateLiteral(["Unaccompanied Miner"])))) && (0,dist.get)("_unaccompaniedMinerUsed") < 5) {
    (0,external_kolmafia_.restoreHp)((0,external_kolmafia_.myMaxhp)() * 0.9);
    (0,external_kolmafia_.cliExecute)("minevolcano.ash ".concat(5 - (0,dist.get)("_unaccompaniedMinerUsed")));

    if ((0,dist.have)((0,dist.$effect)(dailies_templateObject68 || (dailies_templateObject68 = dailies_taggedTemplateLiteral(["Beaten Up"]))))) {
      (0,dist.uneffect)((0,dist.$effect)(dailies_templateObject69 || (dailies_templateObject69 = dailies_taggedTemplateLiteral(["Beaten Up"]))));
    }
...
function checkVolcanoQuest() {
  ...
  var volcoinoValue = 1 / 3 * (0,dist.getSaleValue)((0,dist.$item)(dailies_templateObject70 || (dailies_templateObject70 = dailies_taggedTemplateLiteral(["one-day ticket to That 70s Volcano"]))));
  var volcanoProperties = new Map([[dist.property.getItem("_volcanoItem1") || (0,dist.$item)(dailies_templateObject71 || (dailies_templateObject71 = dailies_taggedTemplateLiteral(["none"]))), (0,dist.get)("_volcanoItemCount1")], [dist.property.getItem("_volcanoItem2") || (0,dist.$item)(dailies_templateObject72 || (dailies_templateObject72 = dailies_taggedTemplateLiteral(["none"]))), (0,dist.get)("_volcanoItemCount2")], [dist.property.getItem("_volcanoItem3") || (0,dist.$item)(dailies_templateObject73 || (dailies_templateObject73 = dailies_taggedTemplateLiteral(["none"]))), (0,dist.get)("_volcanoItemCount3")]]);
  var volcanoItems = [{
    item: (0,dist.$item)(dailies_templateObject74 || (dailies_templateObject74 = dailies_taggedTemplateLiteral(["New Age healing crystal"]))),
    price: 5 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject75 || (dailies_templateObject75 = dailies_taggedTemplateLiteral(["New Age healing crystal"])))),
    numberNeeded: 5
  }, {
    item: (0,dist.$item)(dailies_templateObject76 || (dailies_templateObject76 = dailies_taggedTemplateLiteral(["SMOOCH bottlecap"]))),
    price: 1 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject77 || (dailies_templateObject77 = dailies_taggedTemplateLiteral(["SMOOCH bottlecap"])))),
    numberNeeded: 1
  }, {
    item: (0,dist.$item)(dailies_templateObject78 || (dailies_templateObject78 = dailies_taggedTemplateLiteral(["gooey lava globs"]))),
    price: 5 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject79 || (dailies_templateObject79 = dailies_taggedTemplateLiteral(["gooey lava globs"])))),
    numberNeeded: 5
  }, {
    item: (0,dist.$item)(dailies_templateObject80 || (dailies_templateObject80 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))),
    price: 3 * Math.min((0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject81 || (dailies_templateObject81 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))), 3 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject82 || (dailies_templateObject82 = dailies_taggedTemplateLiteral(["unsmoothed velvet"]))))),
    numberNeeded: 3 * ((0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject83 || (dailies_templateObject83 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) > 3 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject84 || (dailies_templateObject84 = dailies_taggedTemplateLiteral(["unsmoothed velvet"])))) ? 3 : 1)
  }, {
    item: (0,dist.$item)(dailies_templateObject85 || (dailies_templateObject85 = dailies_taggedTemplateLiteral(["SMOOCH bracers"]))),
    price: 5 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject86 || (dailies_templateObject86 = dailies_taggedTemplateLiteral(["superheated metal"])))),
    numberNeeded: 25
  }].concat(dailies_toConsumableArray((0,dist.have)((0,dist.$item)(dailies_templateObject87 || (dailies_templateObject87 = dailies_taggedTemplateLiteral(["Clara's bell"])))) && !(0,dist.get)("_claraBellUsed") ? [{
    item: (0,dist.$item)(dailies_templateObject88 || (dailies_templateObject88 = dailies_taggedTemplateLiteral(["fused fuse"]))),
  ...
  if (volcanoItems.length) {
    ...
    if (chosenItem.item === (0,dist.$item)(dailies_templateObject89 || (dailies_templateObject89 = dailies_taggedTemplateLiteral(["fused fuse"])))) {
...
function cheat() {
  if ((0,dist.have)((0,dist.$item)(dailies_templateObject90 || (dailies_templateObject90 = dailies_taggedTemplateLiteral(["Deck of Every Card"]))))) {
    [(0,dist.getSaleValue)((0,dist.$item)(dailies_templateObject91 || (dailies_templateObject91 = dailies_taggedTemplateLiteral(["gift card"])))) >= (0,dist.getSaleValue)((0,dist.$item)(dailies_templateObject92 || (dailies_templateObject92 = dailies_taggedTemplateLiteral(["1952 Mickey Mantle card"])))) ? "Gift Card" : "1952 Mickey Mantle", "Island", "Ancestral Recall"].forEach(function (card) {
...
function tomeSummons() {
  var tomes = (0,dist.$skills)(dailies_templateObject93 || (dailies_templateObject93 = dailies_taggedTemplateLiteral(["Summon Snowcones, Summon Stickers, Summon Sugar Sheets, Summon Rad Libs, Summon Smithsness"])));
  ...
  if ((0,dist.have)((0,dist.$skill)(dailies_templateObject94 || (dailies_templateObject94 = dailies_taggedTemplateLiteral(["Summon Clip Art"])))) && (0,dist.$skill)(dailies_templateObject95 || (dailies_templateObject95 = dailies_taggedTemplateLiteral(["Summon Clip Art"]))).dailylimit > 0) {
    var best = (0,dist.$item)(dailies_templateObject96 || (dailies_templateObject96 = dailies_taggedTemplateLiteral(["none"])));
    ...
    if (best !== (0,dist.$item)(dailies_templateObject97 || (dailies_templateObject97 = dailies_taggedTemplateLiteral(["none"])))) {
      (0,external_kolmafia_.cliExecute)("try; create ".concat((0,dist.$skill)(dailies_templateObject98 || (dailies_templateObject98 = dailies_taggedTemplateLiteral(["Summon Clip Art"]))).dailylimit, " ").concat(best));
    }
  }
}

function gin() {
  if ((0,dist.have)((0,dist.$item)(dailies_templateObject99 || (dailies_templateObject99 = dailies_taggedTemplateLiteral(["Time-Spinner"]))))) {
...
function internetMemeShop() {
  var baconValue = (0,external_kolmafia_.mallPrice)((0,dist.$item)(dailies_templateObject100 || (dailies_templateObject100 = dailies_taggedTemplateLiteral(["BACON"]))));
  var internetMemeShopProperties = {
    _internetViralVideoBought: (0,dist.$item)(dailies_templateObject101 || (dailies_templateObject101 = dailies_taggedTemplateLiteral(["viral video"]))),
    _internetPlusOneBought: (0,dist.$item)(dailies_templateObject102 || (dailies_templateObject102 = dailies_taggedTemplateLiteral(["plus one"]))),
    _internetGallonOfMilkBought: (0,dist.$item)(dailies_templateObject103 || (dailies_templateObject103 = dailies_taggedTemplateLiteral(["gallon of milk"]))),
    _internetPrintScreenButtonBought: (0,dist.$item)(dailies_templateObject104 || (dailies_templateObject104 = dailies_taggedTemplateLiteral(["print screen button"]))),
    _internetDailyDungeonMalwareBought: (0,dist.$item)(dailies_templateObject105 || (dailies_templateObject105 = dailies_taggedTemplateLiteral(["daily dungeon malware"])))
  };
...
function implement() {
  if (!(0,dist.have)((0,dist.$item)(dailies_templateObject110 || (dailies_templateObject110 = dailies_taggedTemplateLiteral(["[glitch season reward name]"])))) || (0,dist.get)("_glitchItemImplemented")) return;
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(dailies_templateObject111 || (dailies_templateObject111 = dailies_taggedTemplateLiteral(["[glitch season reward name]"]))));
...
function barfTurn() {
  ...
  } else if ((0,external_kolmafia_.myInebriety)() <= (0,external_kolmafia_.inebrietyLimit)() && (0,dist.have)((0,dist.$item)(src_templateObject10 || (src_templateObject10 = src_taggedTemplateLiteral(["\"I Voted!\" sticker"])))) && (0,external_kolmafia_.totalTurnsPlayed)() % 11 === 1 && (0,dist.get)("lastVoteMonsterTurn") < (0,external_kolmafia_.totalTurnsPlayed)() && (0,dist.get)("_voteFreeFights") < 3) {
    (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
    freeFightOutfit([new dist.Requirement([], {
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 474);
