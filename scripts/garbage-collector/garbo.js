...
var secondChainMacro = function secondChainMacro() {
  return combat.Macro.if_("monstername Knob Goblin Embezzler", combat.Macro.externalIf((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(fights_templateObject7 || (fights_templateObject7 = fights_taggedTemplateLiteral(["Pocket Professor"]))), combat.Macro.if_("!hasskill Lecture on Relativity", combat.Macro.if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(fights_templateObject8 || (fights_templateObject8 = fights_taggedTemplateLiteral(["Meteor Shower"]))))), combat.Macro.step("skill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(fights_templateObject9 || (fights_templateObject9 = fights_taggedTemplateLiteral(["Meteor Shower"])))))))) //fix when libram is updated
  .if_("!hasskill Lecture on Relativity", combat.Macro.externalIf((0,dist.get)("_sourceTerminalDigitizeMonster") !== (0,dist.$monster)(fights_templateObject10 || (fights_templateObject10 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))), combat.Macro.tryCopier((0,dist.$skill)(fights_templateObject11 || (fights_templateObject11 = fights_taggedTemplateLiteral(["Digitize"]))))).tryCopier((0,dist.$item)(fights_templateObject12 || (fights_templateObject12 = fights_taggedTemplateLiteral(["Spooky Putty sheet"])))).tryCopier((0,dist.$item)(fights_templateObject13 || (fights_templateObject13 = fights_taggedTemplateLiteral(["Rain-Doh black box"])))).tryCopier((0,dist.$item)(fights_templateObject14 || (fights_templateObject14 = fights_taggedTemplateLiteral(["4-d camera"]))))).trySkill("Lecture on Relativity")).meatKill()).abort();
};
...
var embezzlerSources = [new EmbezzlerFight("Digitize", function () {
  return (0,dist.get)("_sourceTerminalDigitizeMonster") === (0,dist.$monster)(fights_templateObject21 || (fights_templateObject21 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,external_kolmafia_.getCounters)("Digitize Monster", 0, 0).trim() !== "";
}, function () {
  return dist.SourceTerminal.have() && (0,dist.get)("_sourceTerminalDigitizeUses") === 0 ? 1 : 0;
}, function (options) {
  (0,external_kolmafia_.adv1)(options.location || (0,dist.$location)(fights_templateObject22 || (fights_templateObject22 = fights_taggedTemplateLiteral(["Noob Cave"]))));
}, [], true), new EmbezzlerFight("Backup", function () {
  return (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(fights_templateObject23 || (fights_templateObject23 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,dist.have)((0,dist.$item)(fights_templateObject24 || (fights_templateObject24 = fights_taggedTemplateLiteral(["backup camera"])))) && (0,dist.get)("_backUpUses") < 11;
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject25 || (fights_templateObject25 = fights_taggedTemplateLiteral(["backup camera"])))) ? 11 - (0,dist.get)("_backUpUses") : 0;
}, function (options) {
  var realLocation = options.location && options.location.combatPercent >= 100 ? options.location : (0,dist.$location)(fights_templateObject26 || (fights_templateObject26 = fights_taggedTemplateLiteral(["Noob Cave"])));
  ...
  forceEquip: (0,dist.$items)(fights_templateObject27 || (fights_templateObject27 = fights_taggedTemplateLiteral(["backup camera"]))),
  bonusEquip: new Map([[(0,dist.$item)(fights_templateObject28 || (fights_templateObject28 = fights_taggedTemplateLiteral(["backup camera"]))), 5000]])
})], true), new EmbezzlerFight("Fax", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject29 || (fights_templateObject29 = fights_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject30 || (fights_templateObject30 = fights_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed") ? 1 : 0;
}, function () {
  faxEmbezzler();
  (0,external_kolmafia_.use)((0,dist.$item)(_templateObject31 || (_templateObject31 = fights_taggedTemplateLiteral(["photocopied monster"]))));
}), new EmbezzlerFight("Pillkeeper Semirare", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject32 || (_templateObject32 = fights_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(_templateObject33 || (_templateObject33 = fights_taggedTemplateLiteral(["Cobb's Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject34 || (_templateObject34 = fights_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(_templateObject35 || (_templateObject35 = fights_taggedTemplateLiteral(["Cobb's Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed") ? 1 : 0;
}, function () {
  (0,external_kolmafia_.cliExecute)("pillkeeper semirare");
  (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject36 || (_templateObject36 = fights_taggedTemplateLiteral(["Cobb's Knob Treasury"]))));
}), new EmbezzlerFight("Chateau Painting", function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(_templateObject37 || (_templateObject37 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(_templateObject38 || (_templateObject38 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) ? 1 : 0;
}, function () {
  return dist.ChateauMantegna.fightPainting();
}), new EmbezzlerFight("Spooky Putty & Rain-Doh", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject39 || (_templateObject39 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) && (0,dist.get)("spookyPuttyMonster") === (0,dist.$monster)(_templateObject40 || (_templateObject40 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) || (0,dist.have)((0,dist.$item)(_templateObject41 || (_templateObject41 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"])))) && (0,dist.get)("rainDohMonster") === (0,dist.$monster)(_templateObject42 || (_templateObject42 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  if (((0,dist.have)((0,dist.$item)(_templateObject43 || (_templateObject43 = fights_taggedTemplateLiteral(["Spooky Putty sheet"])))) || (0,dist.have)((0,dist.$item)(_templateObject44 || (_templateObject44 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))))) && ((0,dist.have)((0,dist.$item)(_templateObject45 || (_templateObject45 = fights_taggedTemplateLiteral(["Rain-Doh black box"])))) || (0,dist.have)((0,dist.$item)(_templateObject46 || (_templateObject46 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"])))))) {
    return 6 - (0,dist.get)("spookyPuttyCopiesMade") - (0,dist.get)("_raindohCopiesMade") + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject47 || (_templateObject47 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject48 || (_templateObject48 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))));
  } else if ((0,dist.have)((0,dist.$item)(_templateObject49 || (_templateObject49 = fights_taggedTemplateLiteral(["Spooky Putty sheet"])))) || (0,dist.have)((0,dist.$item)(_templateObject50 || (_templateObject50 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))))) {
    return 5 - (0,dist.get)("spookyPuttyCopiesMade") + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject51 || (_templateObject51 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))));
  } else if ((0,dist.have)((0,dist.$item)(_templateObject52 || (_templateObject52 = fights_taggedTemplateLiteral(["Rain-Doh black box"])))) || (0,dist.have)((0,dist.$item)(_templateObject53 || (_templateObject53 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))))) {
    return 5 - (0,dist.get)("_raindohCopiesMade") + (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject54 || (_templateObject54 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))));
  }

  return 0;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject55 || (_templateObject55 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))))) return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject56 || (_templateObject56 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))));
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject57 || (_templateObject57 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))));
}), new EmbezzlerFight("4-d Camera", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject58 || (_templateObject58 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(_templateObject59 || (_templateObject59 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject60 || (_templateObject60 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(_templateObject61 || (_templateObject61 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject62 || (_templateObject62 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))));
}), new EmbezzlerFight("Green Taffy", function () {
  return (0,dist.have)((0,dist.$item)(_templateObject63 || (_templateObject63 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(_templateObject64 || (_templateObject64 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(_templateObject65 || (_templateObject65 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(_templateObject66 || (_templateObject66 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject67 || (_templateObject67 = fights_taggedTemplateLiteral(["envyfish egg"]))));
}), new EmbezzlerFight("Professor MeatChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject68 || (_templateObject68 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false) ? 10 : 0;
}, function () {
  return;
}), new EmbezzlerFight("Professor WeightChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject69 || (_templateObject69 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false) ? 5 : 0;
}, function () {
  return;
})];
...
function embezzlerSetup() {
  ...
  safeRestore();
  if ((0,external_kolmafia_.mySpleenUse)() < (0,external_kolmafia_.spleenLimit)()) ensureEffect((0,dist.$effect)(_templateObject70 || (_templateObject70 = fights_taggedTemplateLiteral(["Eau d' Clochard"]))));

  if ((0,external_kolmafia_.mySpleenUse)() < (0,external_kolmafia_.spleenLimit)() && (0,dist.have)((0,dist.$item)(_templateObject71 || (_templateObject71 = fights_taggedTemplateLiteral(["body spradium"]))))) {
    ensureEffect((0,dist.$effect)(_templateObject72 || (_templateObject72 = fights_taggedTemplateLiteral(["Boxing Day Glow"]))));
  }

  freeFightMood().execute(50);
  withStash((0,dist.$items)(_templateObject73 || (_templateObject73 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))), function () {
    if ((0,dist.have)((0,dist.$item)(_templateObject74 || (_templateObject74 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(_templateObject75 || (_templateObject75 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))));
    }
  });
  if ((0,dist.have)((0,dist.$item)(_templateObject76 || (_templateObject76 = fights_taggedTemplateLiteral(["License to Chill"])))) && !(0,dist.get)("_licenseToChillUsed")) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject77 || (_templateObject77 = fights_taggedTemplateLiteral(["License to Chill"]))));
  bathroomFinance(embezzlerCount());
  if (dist.SourceTerminal.have()) dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject78 || (_templateObject78 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject79 || (_templateObject79 = fights_taggedTemplateLiteral(["Digitize"])))]);

  if (!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(_templateObject80 || (_templateObject80 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))))) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject81 || (_templateObject81 = fights_taggedTemplateLiteral(["4-d camera"]))));
  } // Fix invalid copiers (caused by ascending or combat text-effects)


  if ((0,dist.have)((0,dist.$item)(_templateObject82 || (_templateObject82 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) && !(0,dist.get)("spookyPuttyMonster")) {
    // Visit the description to update the monster as it may be valid but not tracked correctly
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(_templateObject83 || (_templateObject83 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))).descid), false, false);

    if (!(0,dist.get)("spookyPuttyMonster")) {
      // Still invalid, use it to turn back into the spooky putty sheet
      (0,external_kolmafia_.use)((0,dist.$item)(_templateObject84 || (_templateObject84 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))));
    }
  }

  if ((0,dist.have)((0,dist.$item)(_templateObject85 || (_templateObject85 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"])))) && !(0,dist.get)("rainDohMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(_templateObject86 || (_templateObject86 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(_templateObject87 || (_templateObject87 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && !(0,dist.get)("cameraMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(_templateObject88 || (_templateObject88 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(_templateObject89 || (_templateObject89 = fights_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("envyfishMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(_templateObject90 || (_templateObject90 = fights_taggedTemplateLiteral(["envyfish egg"]))).descid), false, false);
  }
}
...
function getEmbezzlerFight() {
  ...
  if (potentials && (0,dist.get)("_genieFightsUsed") < 3 && (0,external_kolmafia_.userConfirm)("Garbo has detected you have potential ways to copy an Embezzler, but no way to start a fight with one. Should we wish for an Embezzler?")) {
    return new EmbezzlerFight("Pocket Wish", function () {
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject91 || (_templateObject91 = fights_taggedTemplateLiteral(["pocket wish"]))));
  ...
  if ((0,external_kolmafia_.getCounters)("Digitize Monster", 0, 100).trim() === "" && (0,dist.get)("_sourceTerminalDigitizeUses") !== 0) {
    do {
      var run = findRun() || new FreeRun("LTB", function () {
        return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject93 || (_templateObject93 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
      }, combat.Macro.item("Louder Than Bomb"), new Requirement([], {}), function () {
        return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject94 || (_templateObject94 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
      });
      if (run.prepare) run.prepare();
      freeFightOutfit(fights_toConsumableArray(run.requirement ? [run.requirement] : []));
      (0,dist.adventureMacro)((0,dist.$location)(_templateObject95 || (_templateObject95 = fights_taggedTemplateLiteral(["Noob Cave"]))), run.macro);
    } while ((0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject92 || (_templateObject92 = fights_taggedTemplateLiteral(["Government agent"]))));
  }
}

var witchessPieces = [{
  piece: (0,dist.$monster)(_templateObject96 || (_templateObject96 = fights_taggedTemplateLiteral(["Witchess Bishop"]))),
  drop: (0,dist.$item)(_templateObject97 || (_templateObject97 = fights_taggedTemplateLiteral(["Sacramento wine"])))
}, {
  piece: (0,dist.$monster)(_templateObject98 || (_templateObject98 = fights_taggedTemplateLiteral(["Witchess Knight"]))),
  drop: (0,dist.$item)(_templateObject99 || (_templateObject99 = fights_taggedTemplateLiteral(["jumping horseradish"])))
}, {
  piece: (0,dist.$monster)(_templateObject100 || (_templateObject100 = fights_taggedTemplateLiteral(["Witchess Pawn"]))),
  drop: (0,dist.$item)(_templateObject101 || (_templateObject101 = fights_taggedTemplateLiteral(["armored prawn"])))
}, {
  piece: (0,dist.$monster)(_templateObject102 || (_templateObject102 = fights_taggedTemplateLiteral(["Witchess Rook"]))),
  drop: (0,dist.$item)(_templateObject103 || (_templateObject103 = fights_taggedTemplateLiteral(["Greek fire"])))
}];
...
function dailyFights() {
  if (embezzlerSources.some(function (source) {
    ...
    withStash((0,dist.$items)(_templateObject104 || (_templateObject104 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))), function () {
      embezzlerSetup(); // FIRST EMBEZZLER CHAIN

      if ((0,dist.have)((0,dist.$familiar)(_templateObject105 || (_templateObject105 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false)) {
        var startLectures = (0,dist.get)("_pocketProfessorLectures");
        var fightSource = getEmbezzlerFight();
        if (!fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject106 || (_templateObject106 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        meatOutfit(true, [].concat(fights_toConsumableArray(fightSource.requirements), [new Requirement([], {
          forceEquip: (0,dist.$items)(_templateObject107 || (_templateObject107 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
        })]));
      ...
      if ((0,dist.have)((0,dist.$familiar)(_templateObject108 || (_templateObject108 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false)) {
        var _startLectures = (0,dist.get)("_pocketProfessorLectures");

        var _fightSource = getEmbezzlerFight();

        if (!_fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject109 || (_templateObject109 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        var requirements = Requirement.merge([new Requirement(["Familiar Weight"], {
          forceEquip: (0,dist.$items)(_templateObject110 || (_templateObject110 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
      ...
      while (nextFight !== null) {
        ...
        if ((0,dist.have)((0,dist.$skill)(_templateObject111 || (_templateObject111 = fights_taggedTemplateLiteral(["Musk of the Moose"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject112 || (_templateObject112 = fights_taggedTemplateLiteral(["Musk of the Moose"]))))) (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject113 || (_templateObject113 = fights_taggedTemplateLiteral(["Musk of the Moose"]))));
        (0,combat.withMacro)(embezzlerMacro(), function () {
          if (nextFight) {
            (0,external_kolmafia_.useFamiliar)(meatFamiliar());

            if (((0,dist.have)((0,dist.$familiar)(_templateObject114 || (_templateObject114 = fights_taggedTemplateLiteral(["Reanimated Reanimator"])))) || (0,dist.have)((0,dist.$familiar)(_templateObject115 || (_templateObject115 = fights_taggedTemplateLiteral(["Obtuse Angel"]))))) && (0,dist.get)("_badlyRomanticArrows") === 0 && !nextFight.draggable) {
              if ((0,dist.have)((0,dist.$familiar)(_templateObject116 || (_templateObject116 = fights_taggedTemplateLiteral(["Obtuse Angel"]))))) (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject117 || (_templateObject117 = fights_taggedTemplateLiteral(["Obtuse Angel"]))));else (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject118 || (_templateObject118 = fights_taggedTemplateLiteral(["Reanimated Reanimator"]))));
            }

            if (nextFight.draggable && !(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || waterBreathingEquipment.some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || familiarWaterBreathingEquipment.some(dist.have)) && ((0,dist.have)((0,dist.$effect)(_templateObject119 || (_templateObject119 = fights_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(_templateObject120 || (_templateObject120 = fights_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(_templateObject121 || (_templateObject121 = fights_taggedTemplateLiteral(["envyfish egg"]))))) {
              (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject122 || (_templateObject122 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
              ...
              (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject123 || (_templateObject123 = fights_taggedTemplateLiteral(["pulled green taffy"]))));
              if (!(0,dist.have)((0,dist.$effect)(_templateObject124 || (_templateObject124 = fights_taggedTemplateLiteral(["Fishy"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject125 || (_templateObject125 = fights_taggedTemplateLiteral(["fishy pipe"]))));
              nextFight.run({
                location: (0,dist.$location)(_templateObject126 || (_templateObject126 = fights_taggedTemplateLiteral(["The Briny Deeps"])))
              });
              ...
              (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject127 || (_templateObject127 = fights_taggedTemplateLiteral(["Noob Cave"]))));
              meatOutfit(true, nextFight.requirements);
              nextFight.run({
                location: (0,dist.$location)(_templateObject128 || (_templateObject128 = fights_taggedTemplateLiteral(["Noob Cave"])))
              });
            }
          }
        });

        if ((0,external_kolmafia_.totalTurnsPlayed)() - startTurns === 1 && (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject129 || (_templateObject129 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (nextFight.name === "Backup" || (0,dist.get)("lastEncounter") === "Knob Goblin Embezzler")) {
...
function bestFairy() {
  if ((0,dist.have)((0,dist.$familiar)(_templateObject130 || (_templateObject130 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && (0,dist.have)((0,dist.$item)(_templateObject131 || (_templateObject131 = fights_taggedTemplateLiteral(["li'l ninja costume"]))))) return (0,dist.$familiar)(_templateObject132 || (_templateObject132 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])));
  if ((0,dist.get)("_cheerleaderSteam") > 100 && (0,dist.have)((0,dist.$familiar)(_templateObject133 || (_templateObject133 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"]))))) return (0,dist.$familiar)(_templateObject134 || (_templateObject134 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"])));

  if (!bestNonCheerleaderFairy) {
    (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject135 || (_templateObject135 = fights_taggedTemplateLiteral(["Noob Cave"]))));
    var bestNonCheerleaderFairies = Familiar.all().filter(function (familiar) {
      return (0,dist.have)(familiar) && familiar !== (0,dist.$familiar)(_templateObject136 || (_templateObject136 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"])));
    }).sort(function (a, b) {
      return (0,external_kolmafia_.numericModifier)(b, "Fairy", 1, (0,dist.$item)(_templateObject137 || (_templateObject137 = fights_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Fairy", 1, (0,dist.$item)(_templateObject138 || (_templateObject138 = fights_taggedTemplateLiteral(["none"]))));
    });
    var bestFairyMult = (0,external_kolmafia_.numericModifier)(bestNonCheerleaderFairies[0], "Fairy", 1, (0,dist.$item)(_templateObject139 || (_templateObject139 = fights_taggedTemplateLiteral(["none"]))));
    bestNonCheerleaderFairy = bestNonCheerleaderFairies.filter(function (fairy) {
      return (0,external_kolmafia_.numericModifier)(fairy, "Fairy", 1, (0,dist.$item)(_templateObject140 || (_templateObject140 = fights_taggedTemplateLiteral(["none"])))) === bestFairyMult;
    }).sort(function (a, b) {
      return (0,external_kolmafia_.numericModifier)(b, "Leprechaun", 1, (0,dist.$item)(_templateObject141 || (_templateObject141 = fights_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Leprechaun", 1, (0,dist.$item)(_templateObject142 || (_templateObject142 = fights_taggedTemplateLiteral(["none"]))));
    })[0];
  }
...
var pygmyMacro = combat.Macro.if_("monstername pygmy bowler", combat.Macro.trySkill("Snokebomb").item((0,dist.$item)(_templateObject143 || (_templateObject143 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))))).if_("monstername pygmy orderlies", combat.Macro.trySkill("Feel Hatred").item((0,dist.$item)(_templateObject144 || (_templateObject144 = fights_taggedTemplateLiteral(["divine champagne popper"]))))).if_("monstername pygmy janitor", combat.Macro.item((0,dist.$item)(_templateObject145 || (_templateObject145 = fights_taggedTemplateLiteral(["tennis ball"]))))).if_("monstername time-spinner prank", combat.Macro.meatKill()).abort();
var freeFightSources = [// Get a Fish Head from our robortender if available
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject146 || (_templateObject146 = fights_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject147 || (_templateObject147 = fights_taggedTemplateLiteral(["Robortender"])))) && !(0,dist.get)("_cargoPocketEmptied") && String((0,dist.get)("cargoPocketsEmptied", "")).indexOf("428") === -1;
}, function () {
  return (0,external_kolmafia_.cliExecute)("cargo monster Mob Penguin Thug");
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject148 || (_templateObject148 = fights_taggedTemplateLiteral(["Robortender"])));
  }
}), new FreeFight(function () {
  ...
  var haveEldritchEssence = (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject149 || (_templateObject149 = fights_taggedTemplateLiteral(["eldritch essence"])))) !== 0;
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject150 || (_templateObject150 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"])))) && !(0,dist.get)("_eldritchHorrorEvoked");
}, function () {
  return (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject151 || (_templateObject151 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
}), new FreeFight(function () {
  return clamp(3 - (0,dist.get)("_lynyrdSnareUses"), 0, 3);
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject152 || (_templateObject152 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject153 || (_templateObject153 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject154 || (_templateObject154 = fights_taggedTemplateLiteral(["[glitch season reward name]"])))) && !(0,dist.get)("_glitchMonsterFights");
}, function () {
...
new FreeFight(function () {
  var maxSeals = (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject155 || (_templateObject155 = fights_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) ? 10 : 5;
  var maxSealsAvailable = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? maxSeals : Math.min(maxSeals, Math.floor((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject156 || (_templateObject156 = fights_taggedTemplateLiteral(["seal-blubber candle"])))) / 3));
  return (0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject157 || (_templateObject157 = fights_taggedTemplateLiteral(["Seal Clubber"]))) ? Math.max(maxSealsAvailable - (0,dist.get)("_sealsSummoned"), 0) : 0;
}, function () {
  var figurine = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? (0,dist.$item)(_templateObject158 || (_templateObject158 = fights_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))) : (0,dist.$item)(_templateObject159 || (_templateObject159 = fights_taggedTemplateLiteral(["figurine of an ancient seal"])));
  (0,external_kolmafia_.retrieveItem)(1, figurine);
  (0,external_kolmafia_.retrieveItem)((0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? 1 : 3, (0,dist.$item)(_templateObject160 || (_templateObject160 = fights_taggedTemplateLiteral(["seal-blubber candle"]))));
  ...
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject161 || (_templateObject161 = fights_taggedTemplateLiteral(["BRICKO ooze"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject162 || (_templateObject162 = fights_taggedTemplateLiteral(["BRICKO eye brick"])))) + 2 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject163 || (_templateObject163 = fights_taggedTemplateLiteral(["BRICKO brick"]))));
  }
}), //Initial 9 Pygmy fights
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" ? clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9) : 0;
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject164 || (_templateObject164 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject165 || (_templateObject165 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)(clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9), (0,dist.$item)(_templateObject166 || (_templateObject166 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject167 || (_templateObject167 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject168 || (_templateObject168 = fights_taggedTemplateLiteral(["tennis ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject169 || (_templateObject169 = fights_taggedTemplateLiteral(["divine champagne popper"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject170 || (_templateObject170 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject171 || (_templateObject171 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject172 || (_templateObject172 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject173 || (_templateObject173 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject174 || (_templateObject174 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject175 || (_templateObject175 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
...
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("_drunkPygmyBanishes") === 10 && !(0,dist.have)((0,dist.$item)(_templateObject176 || (_templateObject176 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
}, function () {
  ...
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject179 || (_templateObject179 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject180 || (_templateObject180 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
...
new FreeFight(function () {
  ...
  var remainingSaberPygmies = (saberedMonster === (0,dist.$monster)(_templateObject184 || (_templateObject184 = fights_taggedTemplateLiteral(["drunk pygmy"]))) ? (0,dist.get)("_saberForceMonsterCount") : 0) + 2 * clamp(5 - (0,dist.get)("_saberForceUses"), 0, 5);
  ...
  if (((0,dist.get)("_saberForceMonster") !== (0,dist.$monster)(_templateObject185 || (_templateObject185 = fights_taggedTemplateLiteral(["drunk pygmy"]))) || (0,dist.get)("_saberForceMonsterCount") === 1) && (0,dist.get)("_saberForceUses") < 5) {
    ...
    (0,property.withChoice)(1387, 2, function () {
      ...
      (0,dist.adventureMacro)((0,dist.$location)(_templateObject190 || (_templateObject190 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.skill("Use the Force"));
    });
  } else {
    if ((0,external_kolmafia_.closetAmount)((0,dist.$item)(_templateObject191 || (_templateObject191 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))) > 0) (0,external_kolmafia_.takeCloset)((0,external_kolmafia_.closetAmount)((0,dist.$item)(_templateObject192 || (_templateObject192 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))), (0,dist.$item)(_templateObject193 || (_templateObject193 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));else (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject194 || (_templateObject194 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
    (0,dist.adventureMacro)((0,dist.$location)(_templateObject195 || (_templateObject195 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
  }
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject196 || (_templateObject196 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      bonusEquip: new Map([[(0,dist.$item)(_templateObject197 || (_templateObject197 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
      preventEquip: (0,dist.$items)(_templateObject198 || (_templateObject198 = fights_taggedTemplateLiteral(["Staff of Queso Escusado, stinky cheese sword"])))
    })];
  }
}), //Finally, saber or not, if we have a drunk pygmy in our crystal ball, let it out.
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("crystalBallMonster") === (0,dist.$monster)(_templateObject199 || (_templateObject199 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_drunkPygmyBanishes") >= 11;
}, function () {
  ...
  (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject202 || (_templateObject202 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject203 || (_templateObject203 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.abort());
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      ...
      bonusEquip: new Map([[(0,dist.$item)(_templateObject205 || (_templateObject205 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
      preventEquip: (0,dist.$items)(_templateObject206 || (_templateObject206 = fights_taggedTemplateLiteral(["Staff of Queso Escusado, stinky cheese sword"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject207 || (_templateObject207 = fights_taggedTemplateLiteral(["Time-Spinner"])))) && (0,dist.$location)(_templateObject208 || (_templateObject208 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))).combatQueue.includes("drunk pygmy") && (0,dist.get)("_timeSpinnerMinutesUsed") < 8;
}, function () {
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject209 || (_templateObject209 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  combat.Macro.trySkill("Extract").trySkill("Sing Along").setAutoAttack;
  (0,external_kolmafia_.visitUrl)("inv_use.php?whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(_templateObject210 || (_templateObject210 = fights_taggedTemplateLiteral(["Time-Spinner"]))))));
  (0,external_kolmafia_.runChoice)(1);
  (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=1196&monid=".concat((0,dist.$monster)(_templateObject211 || (_templateObject211 = fights_taggedTemplateLiteral(["drunk pygmy"]))).id, "&option=1"));
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      bonusEquip: new Map([[(0,dist.$item)(_templateObject212 || (_templateObject212 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
      preventEquip: (0,dist.$items)(_templateObject213 || (_templateObject213 = fights_taggedTemplateLiteral(["Staff of Queso Escusado, stinky cheese sword"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("_sausageFights") === 0 && (0,dist.have)((0,dist.$item)(_templateObject214 || (_templateObject214 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
}, function () {
  return (0,external_kolmafia_.adv1)(prepWandererZone(), -1, "");
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject215 || (_templateObject215 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("questL11Ron") === "finished" ? 5 - (0,dist.get)("_glarkCableUses") : 0;
}, function () {
  (0,external_kolmafia_.retrieveItem)(5 - (0,dist.get)("_glarkCableUses"), (0,dist.$item)(_templateObject216 || (_templateObject216 = fights_taggedTemplateLiteral(["glark cable"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject217 || (_templateObject217 = fights_taggedTemplateLiteral(["The Red Zeppelin"]))), combat.Macro.item((0,dist.$item)(_templateObject218 || (_templateObject218 = fights_taggedTemplateLiteral(["glark cable"])))));
}), // Mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject219 || (_templateObject219 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,dist.get)("_mushroomGardenFights") === 0;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject220 || (_templateObject220 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject221 || (_templateObject221 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject222 || (_templateObject222 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject223 || (_templateObject223 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject224 || (_templateObject224 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.trySkill("Portscan").meatKill());
  if ((0,dist.have)((0,dist.$item)(_templateObject225 || (_templateObject225 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject226 || (_templateObject226 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject227 || (_templateObject227 = fights_taggedTemplateLiteral(["Robortender"])))) ? (0,dist.$familiar)(_templateObject228 || (_templateObject228 = fights_taggedTemplateLiteral(["Robortender"]))) : null;
  }
}), // Portscan and mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject229 || (_templateObject229 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,external_kolmafia_.getCounters)("portscan.edu", 0, 0) === "portscan.edu" && (0,dist.have)((0,dist.$skill)(_templateObject230 || (_templateObject230 = fights_taggedTemplateLiteral(["Macrometeorite"])))) && (0,dist.get)("_macrometeoriteUses") < 10;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject231 || (_templateObject231 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject232 || (_templateObject232 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject233 || (_templateObject233 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject234 || (_templateObject234 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject235 || (_templateObject235 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.if_("monstername government agent", combat.Macro.skill("Macrometeorite")).if_("monstername piranha plant", combat.Macro.trySkill("Portscan").meatKill()));
  if ((0,dist.have)((0,dist.$item)(_templateObject236 || (_templateObject236 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject237 || (_templateObject237 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject238 || (_templateObject238 = fights_taggedTemplateLiteral(["God Lobster"])))) ? clamp(3 - (0,dist.get)("_godLobsterFights"), 0, 3) : 0;
}, function () {
  return (//
  ...
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject239 || (_templateObject239 = fights_taggedTemplateLiteral(["God Lobster"])));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject240 || (_templateObject240 = fights_taggedTemplateLiteral(["Machine Elf"])))) ? clamp(5 - (0,dist.get)("_machineTunnelsAdv"), 0, 5) : 0;
}, function () {
  (0,property.withChoice)(1119, 6, function () {
    return (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject241 || (_templateObject241 = fights_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, "");
  });
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject242 || (_templateObject242 = fights_taggedTemplateLiteral(["Machine Elf"])));
  }
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject243 || (_templateObject243 = fights_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), -1, "");
}), new FreeFight(function () {
  ...
  (0,property.withChoices)(nepQuestChoices(), function () {
    (0,dist.adventureMacro)((0,dist.$location)(_templateObject244 || (_templateObject244 = fights_taggedTemplateLiteral(["The Neverending Party"]))), combat.Macro.trySkill("Feel Pride").meatKill());
  ...
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.have)((0,dist.$item)(_templateObject245 || (_templateObject245 = fights_taggedTemplateLiteral(["January's Garbage Tote"])))) ? (0,dist.$items)(_templateObject246 || (_templateObject246 = fights_taggedTemplateLiteral(["makeshift garbage shirt"]))) : []
    })];
  }
})];
var freeKillSources = [new FreeFight(function () {
  return !(0,dist.get)("_gingerbreadMobHitUsed") && (0,dist.have)((0,dist.$skill)(_templateObject247 || (_templateObject247 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Gingerbread Mob Hit"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject248 || (_templateObject248 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject249 || (_templateObject249 = fights_taggedTemplateLiteral(["Shattering Punch"])))) ? clamp(3 - (0,dist.get)("_shatteringPunchUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Shattering Punch"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject250 || (_templateObject250 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
new FreeFight(function () {
  return !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject251 || (_templateObject251 = fights_taggedTemplateLiteral(["The Jokester's gun"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Fire the Jokester's Gun"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject252 || (_templateObject252 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject253 || (_templateObject253 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })];
  }
}), // 22	3	0	0	Chest X-Ray	combat skill	must have a Lil' Doctor™ bag equipped
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject254 || (_templateObject254 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? clamp(3 - (0,dist.get)("_chestXRayUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Chest X-Ray"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject255 || (_templateObject255 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject256 || (_templateObject256 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject257 || (_templateObject257 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))) ? clamp(3 - (0,dist.get)("_usedReplicaBatoomerang"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").item("replica bat-oomerang"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject258 || (_templateObject258 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
  ...
  (0,combat.withMacro)(combat.Macro.skill("Sing Along").skill("Asdon Martin: Missile Launcher"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject259 || (_templateObject259 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
function freeFights() {
  ...
  if (!(0,dist.have)((0,dist.$item)(_templateObject260 || (_templateObject260 = fights_taggedTemplateLiteral(["li'l ninja costume"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject261 || (_templateObject261 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject262 || (_templateObject262 = fights_taggedTemplateLiteral(["The Jokester's gun"]))))) {
    (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
    freeFightMood().execute();
    freeFightOutfit([new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject263 || (_templateObject263 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })]);

    if (questStep("questL08Trapper") >= 2) {
      (0,dist.adventureMacroAuto)((0,dist.$location)(_templateObject264 || (_templateObject264 = fights_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))), combat.Macro.skill("Fire the Jokester's Gun"));
    } else if ((0,dist.have)((0,dist.$skill)(_templateObject265 || (_templateObject265 = fights_taggedTemplateLiteral(["Comprehensive Cartography"])))) && (0,dist.get)("_monstersMapped") < 3) {
      try {
        combat.Macro.skill("Fire the Jokester's Gun").setAutoAttack();
        mapMonster((0,dist.$location)(_templateObject266 || (_templateObject266 = fights_taggedTemplateLiteral(["The Haiku Dungeon"]))), (0,dist.$monster)(_templateObject267 || (_templateObject267 = fights_taggedTemplateLiteral(["amateur ninja"]))));
      } finally {
  ...
  try {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        if (freeKillSource.available()) {
          ...
          ensureEffect((0,dist.$effect)(_templateObject268 || (_templateObject268 = fights_taggedTemplateLiteral(["Feeling Lost"]))));

          if ((0,dist.have)((0,dist.$skill)(_templateObject269 || (_templateObject269 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"])))) && !(0,dist.get)("_steelyEyedSquintUsed")) {
            (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject270 || (_templateObject270 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"]))));
          }
        }
    ...
    if ((0,dist.have)((0,dist.$item)(_templateObject271 || (_templateObject271 = fights_taggedTemplateLiteral(["January's Garbage Tote"]))))) (0,external_kolmafia_.cliExecute)("fold wad of used tape");
  }
}
...
function thesisReady() {
  return !(0,dist.get)("_thesisDelivered") && (0,dist.have)((0,dist.$familiar)(_templateObject272 || (_templateObject272 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject273 || (_templateObject273 = fights_taggedTemplateLiteral(["Pocket Professor"]))).experience >= 400;
}
...
function deliverThesis() {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject274 || (_templateObject274 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
  freeFightMood().execute();
  freeFightOutfit([new Requirement(["100 muscle"], {})]);
  safeRestore();

  if ((0,dist.have)((0,dist.$item)(_templateObject275 || (_templateObject275 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject276 || (_templateObject276 = fights_taggedTemplateLiteral(["Triple-Sized"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") <= 95) {
    (0,external_kolmafia_.cliExecute)("checkpoint");
    (0,external_kolmafia_.equip)((0,dist.$slot)(_templateObject277 || (_templateObject277 = fights_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject278 || (_templateObject278 = fights_taggedTemplateLiteral(["Powerful Glove"]))));
    ensureEffect((0,dist.$effect)(_templateObject279 || (_templateObject279 = fights_taggedTemplateLiteral(["Triple-Sized"]))));
    (0,external_kolmafia_.outfit)("checkpoint");
  }

  (0,external_kolmafia_.cliExecute)("gain 1800 muscle");
  (0,property.withChoices)(nepQuestChoices(), function () {
    (0,dist.adventureMacro)(thesisInNEP ? (0,dist.$location)(_templateObject280 || (_templateObject280 = fights_taggedTemplateLiteral(["The Neverending Party"]))) : (0,dist.$location)(_templateObject281 || (_templateObject281 = fights_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), combat.Macro.skill("Deliver your Thesis"));
  });
}
...
function safeRestore() {
  ...
  if ((0,external_kolmafia_.myMp)() < 50 && (0,external_kolmafia_.myMaxmp)() > 50) {
    if (((0,dist.have)((0,dist.$item)(_templateObject282 || (_templateObject282 = fights_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(_templateObject283 || (_templateObject283 = fights_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject284 || (_templateObject284 = fights_taggedTemplateLiteral(["magical sausage"]))));
    }
...
function doSausage() {
  ...
  (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
  freeFightOutfit([new Requirement([], {
    forceEquip: (0,dist.$items)(_templateObject285 || (_templateObject285 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
  })]);
...
var bjornFams = [{
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject2 || (bjorn_templateObject2 = bjorn_taggedTemplateLiteral(["yellow pixel"]))));
  },
  probability: 0.25,
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject4 || (bjorn_templateObject4 = bjorn_taggedTemplateLiteral(["yellow pixel"]))));
  },
  probability: 0.25,
  dropPredicate: function dropPredicate() {
    return (0,dist.get)("_yellowPixelDropsCrown") < 25;
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject6 || (bjorn_templateObject6 = bjorn_taggedTemplateLiteral(["grimstone mask"]))));
  },
  probability: 0.5,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject10 || (bjorn_templateObject10 = bjorn_taggedTemplateLiteral(["burning newspaper"]))));
  },
  probability: 0.5,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject12 || (bjorn_templateObject12 = bjorn_taggedTemplateLiteral(["abstraction: sensation, abstraction: thought, abstraction: action, abstraction: category, abstraction: perception, abstraction: purpose"])))));
  },
  probability: 0.2,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject14 || (bjorn_templateObject14 = bjorn_taggedTemplateLiteral(["hoarded candy wad"]))));
  },
  probability: 0.5,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject16 || (bjorn_templateObject16 = bjorn_taggedTemplateLiteral(["warbear whosit"]))));
  },
  probability: 1 / 4.5
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject17 || (bjorn_templateObject17 = bjorn_taggedTemplateLiteral(["Li'l Xenomorph"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject18 || (bjorn_templateObject18 = bjorn_taggedTemplateLiteral(["lunar isotope"]))));
  },
  probability: 0.05,
  modifier: {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject20 || (bjorn_templateObject20 = bjorn_taggedTemplateLiteral(["volcanic ash"]))));
  },
  probability: 0.1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject21 || (bjorn_templateObject21 = bjorn_taggedTemplateLiteral(["Grim Brother"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject22 || (bjorn_templateObject22 = bjorn_taggedTemplateLiteral(["grim fairy tale"]))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject24 || (bjorn_templateObject24 = bjorn_taggedTemplateLiteral(["glob of melted wax"]))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject26 || (bjorn_templateObject26 = bjorn_taggedTemplateLiteral(["teflon ore, velcro ore, vinyl ore, cardboard ore, styrofoam ore, bubblewrap ore"])))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject28 || (bjorn_templateObject28 = bjorn_taggedTemplateLiteral(["space beast fur"]))));
  },
  probability: 1,
  dropPredicate: function dropPredicate() {
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject31 || (bjorn_templateObject31 = bjorn_taggedTemplateLiteral(["candy cane"]))));
  },
  probability: 1
}, {
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject33 || (bjorn_templateObject33 = bjorn_taggedTemplateLiteral(["bean burrito, enchanted bean burrito, jumping bean burrito"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject34 || (bjorn_templateObject34 = bjorn_taggedTemplateLiteral(["Reassembled Blackbird"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject35 || (bjorn_templateObject35 = bjorn_taggedTemplateLiteral(["blackberry"]))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.ITEM,
  ...
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject37 || (bjorn_templateObject37 = bjorn_taggedTemplateLiteral(["blackberry"]))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.ITEM,
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject39 || (bjorn_templateObject39 = bjorn_taggedTemplateLiteral(["disembodied brain, skeleton bone, skeleton bone, skeleton bone, skeleton bone"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject40 || (bjorn_templateObject40 = bjorn_taggedTemplateLiteral(["Reanimated Reanimator"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject41 || (bjorn_templateObject41 = bjorn_taggedTemplateLiteral(["hot wing, broken skull"])))));
  },
  probability: 1
}, {
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject43 || (bjorn_templateObject43 = bjorn_taggedTemplateLiteral(["chorizo brownies, white chocolate and tomato pizza, carob chunk noodles"])))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.MEAT,
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject45 || (bjorn_templateObject45 = bjorn_taggedTemplateLiteral(["beertini, papaya slung, salty slug, tomato daiquiri"])))));
  },
  probability: 1,
  modifier: {
    type: BjornModifierType.MEAT,
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject48 || (bjorn_templateObject48 = bjorn_taggedTemplateLiteral(["candy cane, eggnog, fruitcake, gingerbread bugbear"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject49 || (bjorn_templateObject49 = bjorn_taggedTemplateLiteral(["Stocking Mimic"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject50 || (bjorn_templateObject50 = bjorn_taggedTemplateLiteral(["Angry Farmer candy, Cold Hots candy, Rock Pops, Tasty Fun Good rice candy, Wint-O-Fresh mint"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject51 || (bjorn_templateObject51 = bjorn_taggedTemplateLiteral(["BRICKO chick"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject52 || (bjorn_templateObject52 = bjorn_taggedTemplateLiteral(["BRICKO brick"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject53 || (bjorn_templateObject53 = bjorn_taggedTemplateLiteral(["Cotton Candy Carnie"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject54 || (bjorn_templateObject54 = bjorn_taggedTemplateLiteral(["cotton candy pinch"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject55 || (bjorn_templateObject55 = bjorn_taggedTemplateLiteral(["Untamed Turtle"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject56 || (bjorn_templateObject56 = bjorn_taggedTemplateLiteral(["snailmail bits, turtlemail bits, turtle wax"])))));
  },
  probability: 0.35
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject57 || (bjorn_templateObject57 = bjorn_taggedTemplateLiteral(["Astral Badger"]))),
  meatVal: function meatVal() {
    return 2 * trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject58 || (bjorn_templateObject58 = bjorn_taggedTemplateLiteral(["spooky mushroom, Knob mushroom, Knoll mushroom"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject59 || (bjorn_templateObject59 = bjorn_taggedTemplateLiteral(["Green Pixie"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject60 || (bjorn_templateObject60 = bjorn_taggedTemplateLiteral(["bottle of tequila"]))));
  },
  probability: 0.2
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject61 || (bjorn_templateObject61 = bjorn_taggedTemplateLiteral(["Angry Goat"]))),
  meatVal: function meatVal() {
    return trueValue((0,dist.$item)(bjorn_templateObject62 || (bjorn_templateObject62 = bjorn_taggedTemplateLiteral(["goat cheese pizza"]))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject63 || (bjorn_templateObject63 = bjorn_taggedTemplateLiteral(["Adorable Seal Larva"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject64 || (bjorn_templateObject64 = bjorn_taggedTemplateLiteral(["stench nuggets, spooky nuggets, hot nuggets, cold nuggets, sleaze nuggets"])))));
  },
  probability: 0.35
}, {
  ...
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject66 || (bjorn_templateObject66 = bjorn_taggedTemplateLiteral(["candy cane, eggnog, fruitcake, gingerbread bugbear"])))));
  },
  probability: 0.3
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject67 || (bjorn_templateObject67 = bjorn_taggedTemplateLiteral(["Sweet Nutcracker"]))),
  meatVal: function meatVal() {
    return trueValue.apply(void 0, bjorn_toConsumableArray((0,dist.$items)(bjorn_templateObject68 || (bjorn_templateObject68 = bjorn_taggedTemplateLiteral(["candy cane, eggnog, fruitcake, gingerbread bugbear"])))));
  },
  probability: 0.3
}, {
  ...
  familiar: (0,dist.$familiar)(bjorn_templateObject87 || (bjorn_templateObject87 = bjorn_taggedTemplateLiteral(["Gelatinous Cubeling"]))),
  meatVal: function meatVal() {
    return 0;
  },
  probability: 0,
  ...
  familiar: (0,dist.$familiar)(bjorn_templateObject88 || (bjorn_templateObject88 = bjorn_taggedTemplateLiteral(["Frozen Gravy Fairy"]))),
  // drops a cold nugget every combat, 5 of which can be used to make a cold wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(bjorn_templateObject89 || (bjorn_templateObject89 = bjorn_taggedTemplateLiteral(["cold wad"])))), trueValue((0,dist.$item)(bjorn_templateObject90 || (bjorn_templateObject90 = bjorn_taggedTemplateLiteral(["cold nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject91 || (bjorn_templateObject91 = bjorn_taggedTemplateLiteral(["Stinky Gravy Fairy"]))),
  // drops a stench nugget every combat, 5 of which can be used to make a stench wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(bjorn_templateObject92 || (bjorn_templateObject92 = bjorn_taggedTemplateLiteral(["stench wad"])))), trueValue((0,dist.$item)(bjorn_templateObject93 || (bjorn_templateObject93 = bjorn_taggedTemplateLiteral(["stench nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject94 || (bjorn_templateObject94 = bjorn_taggedTemplateLiteral(["Sleazy Gravy Fairy"]))),
  // drops a sleaze nugget every combat, 5 of which can be used to make a sleaze wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(bjorn_templateObject95 || (bjorn_templateObject95 = bjorn_taggedTemplateLiteral(["sleaze wad"])))), trueValue((0,dist.$item)(bjorn_templateObject96 || (bjorn_templateObject96 = bjorn_taggedTemplateLiteral(["sleaze nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject97 || (bjorn_templateObject97 = bjorn_taggedTemplateLiteral(["Spooky Gravy Fairy"]))),
  // drops a spooky nugget every combat, 5 of which can be used to make a spooky wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(bjorn_templateObject98 || (bjorn_templateObject98 = bjorn_taggedTemplateLiteral(["spooky wad"])))), trueValue((0,dist.$item)(bjorn_templateObject99 || (bjorn_templateObject99 = bjorn_taggedTemplateLiteral(["spooky nuggets"])))));
  },
  probability: 1
}, {
  familiar: (0,dist.$familiar)(bjorn_templateObject100 || (bjorn_templateObject100 = bjorn_taggedTemplateLiteral(["Flaming Gravy Fairy"]))),
  // drops a hot nugget every combat, 5 of which can be used to make a hot wad
  meatVal: function meatVal() {
    return Math.max(0.2 * trueValue((0,dist.$item)(bjorn_templateObject101 || (bjorn_templateObject101 = bjorn_taggedTemplateLiteral(["hot wad"])))), trueValue((0,dist.$item)(bjorn_templateObject102 || (bjorn_templateObject102 = bjorn_taggedTemplateLiteral(["hot nuggets"])))));
  },
  probability: 1
...
function generateBjornList(mode) {
  var additionalValue = function additionalValue(familiar) {
    ...
    var meatVal = [PickBjornMode.DMT, PickBjornMode.FREE].includes(mode) ? 0 : baseMeat + (mode === PickBjornMode.EMBEZZLER ? 750 : 0);
...
function meatOutfit(embezzlerUp) {
  ...
  if ((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(outfit_templateObject31 || (outfit_templateObject31 = outfit_taggedTemplateLiteral(["Obtuse Angel"])))) {
    forceEquip.push((0,dist.$item)(outfit_templateObject32 || (outfit_templateObject32 = outfit_taggedTemplateLiteral(["quake of arrows"]))));
    if (!(0,dist.have)((0,dist.$item)(outfit_templateObject33 || (outfit_templateObject33 = outfit_taggedTemplateLiteral(["quake of arrows"]))))) (0,external_kolmafia_.retrieveItem)((0,dist.$item)(outfit_templateObject34 || (outfit_templateObject34 = outfit_taggedTemplateLiteral(["quake of arrows"]))));
  }
  ...
  var bjornAlike = (0,dist.have)((0,dist.$item)(outfit_templateObject35 || (outfit_templateObject35 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) && !forceEquip.some(function (item) {
    return (0,external_kolmafia_.toSlot)(item) === (0,dist.$slot)(outfit_templateObject36 || (outfit_templateObject36 = outfit_taggedTemplateLiteral(["back"])));
  }) ? (0,dist.$item)(outfit_templateObject37 || (outfit_templateObject37 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) : (0,dist.$item)(outfit_templateObject38 || (outfit_templateObject38 = outfit_taggedTemplateLiteral(["Crown of Thrones"])));
  var compiledRequirements = Requirement.merge([].concat(outfit_toConsumableArray(requirements), [new Requirement(["".concat(((embezzlerUp ? baseMeat + 750 : baseMeat) / 100).toFixed(2), " Meat Drop"), "".concat(embezzlerUp ? 0 : 0.72, " Item Drop")].concat(additionalRequirements), {
    ...
    preventEquip: [].concat(outfit_toConsumableArray((0,dist.$items)(outfit_templateObject39 || (outfit_templateObject39 = outfit_taggedTemplateLiteral(["broken champagne bottle, unwrapped knock-off retro superhero cape"])))), outfit_toConsumableArray(embezzlerUp ? (0,dist.$items)(outfit_templateObject40 || (outfit_templateObject40 = outfit_taggedTemplateLiteral(["cheap sunglasses"]))) : []), [bjornAlike === (0,dist.$item)(outfit_templateObject41 || (outfit_templateObject41 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) ? (0,dist.$item)(outfit_templateObject42 || (outfit_templateObject42 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) : (0,dist.$item)(outfit_templateObject43 || (outfit_templateObject43 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))]),
    bonusEquip: new Map([[(0,dist.$item)(outfit_templateObject44 || (outfit_templateObject44 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(outfit_templateObject45 || (outfit_templateObject45 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))), 300], [(0,dist.$item)(outfit_templateObject46 || (outfit_templateObject46 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(outfit_templateObject47 || (outfit_templateObject47 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180]].concat(outfit_toConsumableArray(embezzlerUp ? [] : pantsgiving()), outfit_toConsumableArray(cheeses(embezzlerUp)), [[bjornAlike, !bjornChoice.dropPredicate || bjornChoice.dropPredicate() ? bjornChoice.meatVal() * bjornChoice.probability : 0]]))
  })]));
  (0,dist.maximizeCached)(compiledRequirements.maximizeParameters(), compiledRequirements.maximizeOptions());

  if ((0,external_kolmafia_.equippedAmount)((0,dist.$item)(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["ice nine"])))) > 0) {
    (0,external_kolmafia_.equip)((0,dist.$item)(outfit_templateObject50 || (outfit_templateObject50 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
  }

  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject51 || (outfit_templateObject51 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_.bjornifyFamiliar)(bjornChoice.familiar);
  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_.enthroneFamiliar)(bjornChoice.familiar);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if ((0,dist.have)(airSource)) {
            if (airSource === (0,dist.$item)(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying"])))) (0,external_kolmafia_.cliExecute)("edpiece fish");
...
var waterBreathingEquipment = (0,dist.$items)(outfit_templateObject54 || (outfit_templateObject54 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying, aerated diving helmet, crappy Mer-kin mask, Mer-kin gladiator mask, Mer-kin scholar mask, old SCUBA tank"])));
var familiarWaterBreathingEquipment = (0,dist.$items)(outfit_templateObject55 || (outfit_templateObject55 = outfit_taggedTemplateLiteral(["das boot, little bitty bathysphere"])));

function pantsgiving() {
  if (!(0,dist.have)((0,dist.$item)(outfit_templateObject56 || (outfit_templateObject56 = outfit_taggedTemplateLiteral(["Pantsgiving"]))))) return new Map();
  ...
  var fullnessValue = sinusVal + (0,dist.get)("valueOfAdventure") * 6.5 - ((0,external_kolmafia_.mallPrice)((0,dist.$item)(outfit_templateObject57 || (outfit_templateObject57 = outfit_taggedTemplateLiteral(["jumping horseradish"])))) + (0,external_kolmafia_.mallPrice)((0,dist.$item)(outfit_templateObject58 || (outfit_templateObject58 = outfit_taggedTemplateLiteral(["Special Seasoning"])))));
  return new Map([[(0,dist.$item)(outfit_templateObject59 || (outfit_templateObject59 = outfit_taggedTemplateLiteral(["Pantsgiving"]))), fullnessValue / (turns * 0.9)]]);
}

var haveSomeCheese = (0,dist.getFoldGroup)((0,dist.$item)(outfit_templateObject60 || (outfit_templateObject60 = outfit_taggedTemplateLiteral(["stinky cheese diaper"])))).some(function (item) {
  return (0,dist.have)(item);
});

function cheeses(embezzlerUp) {
  return haveSomeCheese && !globalOptions.ascending && (0,dist.get)("_stinkyCheeseCount") < 100 && estimatedTurns() >= 100 - (0,dist.get)("_stinkyCheeseCount") && !embezzlerUp ? new Map((0,dist.getFoldGroup)((0,dist.$item)(outfit_templateObject61 || (outfit_templateObject61 = outfit_taggedTemplateLiteral(["stinky cheese diaper"])))).map(function (item) {
    return [item, (0,dist.get)("valueOfAdventure") * (10 - bestAdventuresFromPants) * (1 / 100)];
  })) : [];
}
;// CONCATENATED MODULE: ./src/lib.ts
var lib_templateObject, lib_templateObject2, lib_templateObject3, lib_templateObject4, lib_templateObject5, lib_templateObject6, lib_templateObject7, lib_templateObject8, lib_templateObject9, lib_templateObject10, lib_templateObject11, lib_templateObject12, lib_templateObject13, lib_templateObject14, lib_templateObject15, lib_templateObject16, lib_templateObject17, lib_templateObject18, lib_templateObject19, lib_templateObject20, lib_templateObject21, lib_templateObject22, lib_templateObject23, lib_templateObject24, lib_templateObject25, lib_templateObject26, lib_templateObject27, lib_templateObject28, lib_templateObject29, lib_templateObject30, lib_templateObject31, lib_templateObject32, lib_templateObject33, lib_templateObject34, lib_templateObject35, lib_templateObject36, lib_templateObject37, lib_templateObject38, lib_templateObject39, lib_templateObject40, lib_templateObject41, lib_templateObject42, lib_templateObject43, lib_templateObject44, lib_templateObject45;
...
new FreeRun("Bander", function () {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(lib_templateObject20 || (lib_templateObject20 = lib_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ensureEffect((0,dist.$effect)(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["Ode to Booze"]))));
}), new FreeRun("Boots", function () {
  return (0,dist.have)((0,dist.$familiar)(lib_templateObject22 || (lib_templateObject22 = lib_taggedTemplateLiteral(["Pair of Stomping Boots"])))) && dist.Bandersnatch.getRemainingRunaways() > 0;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").step("runaway"), new Requirement(["Familiar Weight"], {}), function () {
  return (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(lib_templateObject23 || (lib_templateObject23 = lib_taggedTemplateLiteral(["Pair of Stomping Boots"]))));
}), new FreeRun("Snokebomb", function () {
  return (0,dist.get)("_snokebombUsed") < banishesToUse && (0,dist.have)((0,dist.$skill)(lib_templateObject24 || (lib_templateObject24 = lib_taggedTemplateLiteral(["Snokebomb"]))));
  ...
  return (0,dist.get)("_feelHatredUsed") < banishesToUse && (0,dist.have)((0,dist.$skill)(lib_templateObject25 || (lib_templateObject25 = lib_taggedTemplateLiteral(["Emotionally Chipped"]))));
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("feel hatred")), new FreeRun("KGB", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject26 || (lib_templateObject26 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))) && (0,dist.get)("_kgbTranquilizerDartUses") < 3;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("KGB tranquilizer dart"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject27 || (lib_templateObject27 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))
})), new FreeRun("Latte", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject28 || (lib_templateObject28 = lib_taggedTemplateLiteral(["latte lovers member's mug"])))) && !(0,dist.get)("_latteBanishUsed");
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Throw Latte on Opponent"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject29 || (lib_templateObject29 = lib_taggedTemplateLiteral(["latte lovers member's mug"])))
})), new FreeRun("Docbag", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject30 || (lib_templateObject30 = lib_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && (0,dist.get)("_reflexHammerUsed") < 3;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("reflex hammer"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject31 || (lib_templateObject31 = lib_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
})), new FreeRun("Middle Finger", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject32 || (lib_templateObject32 = lib_taggedTemplateLiteral(["mafia middle finger ring"])))) && !(0,dist.get)("_mafiaMiddleFingerRingUsed");
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Show them your ring"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject33 || (lib_templateObject33 = lib_taggedTemplateLiteral(["mafia middle finger ring"])))
})), new FreeRun("VMask", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject34 || (lib_templateObject34 = lib_taggedTemplateLiteral(["V for Vivala mask"])))) && !(0,dist.get)("_vmaskBanisherUsed");
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Creepy Grin"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject35 || (lib_templateObject35 = lib_taggedTemplateLiteral(["V for Vivala mask"])))
}), function () {
  return (0,external_kolmafia_.restoreMp)(30);
}), new FreeRun("Stinkeye", function () {
  return (0,dist.getFoldGroup)((0,dist.$item)(lib_templateObject36 || (lib_templateObject36 = lib_taggedTemplateLiteral(["stinky cheese diaper"])))).some(function (item) {
    return (0,dist.have)(item);
  ...
  forceEquip: (0,dist.$items)(lib_templateObject37 || (lib_templateObject37 = lib_taggedTemplateLiteral(["stinky cheese eye"])))
}), function () {
  if (!(0,dist.have)((0,dist.$item)(lib_templateObject38 || (lib_templateObject38 = lib_taggedTemplateLiteral(["stinky cheese eye"]))))) (0,external_kolmafia_.cliExecute)("fold stinky cheese eye");
}), new FreeRun("Scrapbook", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject39 || (lib_templateObject39 = lib_taggedTemplateLiteral(["familiar scrapbook"])))) && (0,dist.get)("scrapbookCharges") >= 100;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").skill("Show Your Boring Familiar Pictures"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject40 || (lib_templateObject40 = lib_taggedTemplateLiteral(["familiar scrapbook"])))
})), new FreeRun("Navel Ring", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject41 || (lib_templateObject41 = lib_taggedTemplateLiteral(["navel ring of navel gazing"])))) && (0,dist.get)("_navelRunaways") < 3;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").step("runaway"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject42 || (lib_templateObject42 = lib_taggedTemplateLiteral(["navel ring of navel gazing"])))
})), new FreeRun("GAP", function () {
  return (0,dist.have)((0,dist.$item)(lib_templateObject43 || (lib_templateObject43 = lib_taggedTemplateLiteral(["Greatest American Pants"])))) && (0,dist.get)("_navelRunaways") < 3;
}, dist.Macro.trySkill("Asdon Martin: Spring-Loaded Front Bumper").step("runaway"), new Requirement([], {
  forceEquip: (0,dist.$items)(lib_templateObject44 || (lib_templateObject44 = lib_taggedTemplateLiteral(["Greatest American Pants"])))
}))];
function findRun() {
...
function kramcoGuaranteed() {
  return (0,dist.have)((0,dist.$item)(lib_templateObject45 || (lib_templateObject45 = lib_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))) && (0,external_kolmafia_.totalTurnsPlayed)() - (0,dist.get)("_lastSausageMonsterTurn") + 1 >= 5 + 3 * (0,dist.get)("_sausageFights") + Math.pow(Math.max(0, (0,dist.get)("_sausageFights") - 5), 3);
}
...
function gingerbreadPrepNoon() {
  ...
  while (findRun() && (0,dist.get)("_gingerbreadCityTurns") + ((0,dist.get)("_gingerbreadClockAdvanced") ? 5 : 0) < 9) {
    ...
    (0,dist.adventureMacro)((0,dist.$location)(dailies_templateObject92 || (dailies_templateObject92 = dailies_taggedTemplateLiteral(["Gingerbread Civic Center"]))), run.macro);
    ...
    if (["Even Tamer Than Usual", "Never Break the Chain", "Close, but Yes Cigar", "Armchair Quarterback"].includes((0,dist.get)("lastEncounter"))) {
      (0,property.set)("_gingerbreadCityTurns", 1 + (0,dist.get)("_gingerbreadCityTurns"));
    }
  }
}
