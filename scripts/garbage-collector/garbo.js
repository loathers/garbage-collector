...
function embezzlerSetup() {
  ...
  if (globalvars/* globalOptions.ascending */.Xe.ascending && (0,lib/* questStep */.cL)("questM16Temple") > 0 && (0,dist.get)("lastTempleAdventures") < (0,external_kolmafia_.myAscensions)() && acquire(1, (0,dist.$item)(fights_templateObject89 || (fights_templateObject89 = fights_taggedTemplateLiteral(["stone wool"]))), 3 * (0,dist.get)("valueOfAdventure") + 100, false) > 0) {
    ...
    while ((0,dist.get)("lastTempleAdventures") < (0,external_kolmafia_.myAscensions)()) {
      ...
      freeFightOutfit(fights_toConsumableArray(_runSource.requirement ? [_runSource.requirement] : []));
...
function runDiet() {
  ...
  if (choco.has((0,external_kolmafia_.toInt)((0,external_kolmafia_.myClass)())) && (0,dist.get)("_chocolatesUsed") < 3) {
    ...
    var count = (0,lib/* clamp */.uZ)(3 - used, 0, 3);
  ...
  if (globalvars/* globalOptions.ascending */.Xe.ascending) useIfUnused((0,dist.$item)(diet_templateObject65 || (diet_templateObject65 = diet_taggedTemplateLiteral(["borrowed time"]))), "_borrowedTimeUsed", 5 * MPA);
  fillSomeSpleen();
  fillStomach();
  fillLiver();
