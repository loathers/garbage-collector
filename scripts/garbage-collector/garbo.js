...
function embezzlerSetup() {
  ...
  if (dist.SourceTerminal.have()) dist.SourceTerminal.educate([(0,dist.$skill)(fights_templateObject84 || (fights_templateObject84 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(fights_templateObject85 || (fights_templateObject85 = fights_taggedTemplateLiteral(["Digitize"])))]);

  if (!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject86 || (fights_templateObject86 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && averageEmbezzlerNet - averageTouristNet > (0,external_kolmafia_.mallPrice)((0,dist.$item)(fights_templateObject87 || (fights_templateObject87 = fights_taggedTemplateLiteral(["4-d camera"]))))) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject88 || (fights_templateObject88 = fights_taggedTemplateLiteral(["4-d camera"]))));
  }

  if (!(0,dist.get)("_iceSculptureUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject89 || (fights_templateObject89 = fights_taggedTemplateLiteral(["ice sculpture"])))) && averageEmbezzlerNet - averageTouristNet > (0,external_kolmafia_.mallPrice)((0,dist.$item)(fights_templateObject90 || (fights_templateObject90 = fights_taggedTemplateLiteral(["snow berries"])))) + (0,external_kolmafia_.mallPrice)((0,dist.$item)(fights_templateObject91 || (fights_templateObject91 = fights_taggedTemplateLiteral(["ice harvest"])))) * 3) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject92 || (fights_templateObject92 = fights_taggedTemplateLiteral(["unfinished ice sculpture"]))));
  } // Fix invalid copiers (caused by ascending or combat text-effects)


  if ((0,dist.have)((0,dist.$item)(fights_templateObject93 || (fights_templateObject93 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) && !(0,dist.get)("spookyPuttyMonster")) {
    // Visit the description to update the monster as it may be valid but not tracked correctly
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject94 || (fights_templateObject94 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))).descid), false, false);

    if (!(0,dist.get)("spookyPuttyMonster")) {
      // Still invalid, use it to turn back into the spooky putty sheet
      (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject95 || (fights_templateObject95 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))));
    }
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject96 || (fights_templateObject96 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"])))) && !(0,dist.get)("rainDohMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject97 || (fights_templateObject97 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject98 || (fights_templateObject98 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && !(0,dist.get)("cameraMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject99 || (fights_templateObject99 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject100 || (fights_templateObject100 = fights_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("envyfishMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject101 || (fights_templateObject101 = fights_taggedTemplateLiteral(["envyfish egg"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject102 || (fights_templateObject102 = fights_taggedTemplateLiteral(["ice sculpture"])))) && !(0,dist.get)("iceSculptureMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(_templateObject103 || (_templateObject103 = fights_taggedTemplateLiteral(["ice sculpture"]))).descid), false, false);
  }
}
...
function getEmbezzlerFight() {
  ...
  if (potential > 0 && (0,dist.get)("_genieFightsUsed") < 3 && (0,external_kolmafia_.userConfirm)("Garbo has detected you have ".concat(potential, " potential ways to copy an Embezzler, but no way to start a fight with one. Should we wish for an Embezzler?"))) {
    return new EmbezzlerFight("Pocket Wish", function () {
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject104 || (_templateObject104 = fights_taggedTemplateLiteral(["pocket wish"]))));
  ...
  if ((0,external_kolmafia_.getCounters)("Digitize Monster", 0, 100).trim() === "" && (0,dist.get)("_sourceTerminalDigitizeUses") !== 0) {
    do {
      var run = findRun() || new FreeRun("LTB", function () {
        return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject106 || (_templateObject106 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
      }, combat.Macro.item("Louder Than Bomb"), new Requirement([], {}), function () {
        return (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject107 || (_templateObject107 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
      });
      if (run.prepare) run.prepare();
      freeFightOutfit(fights_toConsumableArray(run.requirement ? [run.requirement] : []));
      (0,dist.adventureMacro)((0,dist.$location)(_templateObject108 || (_templateObject108 = fights_taggedTemplateLiteral(["Noob Cave"]))), run.macro);
    } while ((0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject105 || (_templateObject105 = fights_taggedTemplateLiteral(["Government agent"]))));
  }
}

var witchessPieces = [{
  piece: (0,dist.$monster)(_templateObject109 || (_templateObject109 = fights_taggedTemplateLiteral(["Witchess Bishop"]))),
  drop: (0,dist.$item)(_templateObject110 || (_templateObject110 = fights_taggedTemplateLiteral(["Sacramento wine"])))
}, {
  piece: (0,dist.$monster)(_templateObject111 || (_templateObject111 = fights_taggedTemplateLiteral(["Witchess Knight"]))),
  drop: (0,dist.$item)(_templateObject112 || (_templateObject112 = fights_taggedTemplateLiteral(["jumping horseradish"])))
}, {
  piece: (0,dist.$monster)(_templateObject113 || (_templateObject113 = fights_taggedTemplateLiteral(["Witchess Pawn"]))),
  drop: (0,dist.$item)(_templateObject114 || (_templateObject114 = fights_taggedTemplateLiteral(["armored prawn"])))
}, {
  piece: (0,dist.$monster)(_templateObject115 || (_templateObject115 = fights_taggedTemplateLiteral(["Witchess Rook"]))),
  drop: (0,dist.$item)(_templateObject116 || (_templateObject116 = fights_taggedTemplateLiteral(["Greek fire"])))
}];
...
function dailyFights() {
  ...
  if (embezzlerSources.some(function (source) {
    ...
    withStash((0,dist.$items)(_templateObject117 || (_templateObject117 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))), function () {
      embezzlerSetup(); // FIRST EMBEZZLER CHAIN

      if ((0,dist.have)((0,dist.$familiar)(_templateObject118 || (_templateObject118 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false)) {
        var startLectures = (0,dist.get)("_pocketProfessorLectures");
        var fightSource = getEmbezzlerFight();
        if (!fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject119 || (_templateObject119 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        meatOutfit(true, [].concat(fights_toConsumableArray(fightSource.requirements), [new Requirement([], {
          forceEquip: (0,dist.$items)(_templateObject120 || (_templateObject120 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
        })]));
      ...
      if ((0,dist.have)((0,dist.$familiar)(_templateObject121 || (_templateObject121 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false)) {
        var _startLectures = (0,dist.get)("_pocketProfessorLectures");

        var _fightSource = getEmbezzlerFight();

        if (!_fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject122 || (_templateObject122 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        var requirements = Requirement.merge([new Requirement(["Familiar Weight"], {
          forceEquip: (0,dist.$items)(_templateObject123 || (_templateObject123 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
      ...
      while (nextFight !== null) {
        ...
        if ((0,dist.have)((0,dist.$skill)(_templateObject124 || (_templateObject124 = fights_taggedTemplateLiteral(["Musk of the Moose"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject125 || (_templateObject125 = fights_taggedTemplateLiteral(["Musk of the Moose"]))))) (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject126 || (_templateObject126 = fights_taggedTemplateLiteral(["Musk of the Moose"]))));
        (0,combat.withMacro)(embezzlerMacro(), function () {
          if (nextFight) {
            (0,external_kolmafia_.useFamiliar)(meatFamiliar());

            if (((0,dist.have)((0,dist.$familiar)(_templateObject127 || (_templateObject127 = fights_taggedTemplateLiteral(["Reanimated Reanimator"])))) || (0,dist.have)((0,dist.$familiar)(_templateObject128 || (_templateObject128 = fights_taggedTemplateLiteral(["Obtuse Angel"]))))) && (0,dist.get)("_badlyRomanticArrows") === 0 && !nextFight.draggable) {
              if ((0,dist.have)((0,dist.$familiar)(_templateObject129 || (_templateObject129 = fights_taggedTemplateLiteral(["Obtuse Angel"]))))) (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject130 || (_templateObject130 = fights_taggedTemplateLiteral(["Obtuse Angel"]))));else (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject131 || (_templateObject131 = fights_taggedTemplateLiteral(["Reanimated Reanimator"]))));
            }

            if (nextFight.draggable && !(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || waterBreathingEquipment.some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || familiarWaterBreathingEquipment.some(dist.have)) && ((0,dist.have)((0,dist.$effect)(_templateObject132 || (_templateObject132 = fights_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(_templateObject133 || (_templateObject133 = fights_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(_templateObject134 || (_templateObject134 = fights_taggedTemplateLiteral(["envyfish egg"]))))) {
              (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject135 || (_templateObject135 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
              ...
              (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject136 || (_templateObject136 = fights_taggedTemplateLiteral(["pulled green taffy"]))));
              if (!(0,dist.have)((0,dist.$effect)(_templateObject137 || (_templateObject137 = fights_taggedTemplateLiteral(["Fishy"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject138 || (_templateObject138 = fights_taggedTemplateLiteral(["fishy pipe"]))));
              nextFight.run({
                location: (0,dist.$location)(_templateObject139 || (_templateObject139 = fights_taggedTemplateLiteral(["The Briny Deeps"])))
              });
              ...
              (0,external_kolmafia_.setLocation)((0,dist.$location)(_templateObject140 || (_templateObject140 = fights_taggedTemplateLiteral(["Noob Cave"]))));
              meatOutfit(true, nextFight.requirements);
              nextFight.run({
                location: (0,dist.$location)(_templateObject141 || (_templateObject141 = fights_taggedTemplateLiteral(["Noob Cave"])))
              });
            }
          }
        });

        if ((0,external_kolmafia_.totalTurnsPlayed)() - startTurns === 1 && (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(_templateObject142 || (_templateObject142 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (nextFight.name === "Backup" || (0,dist.get)("lastEncounter") === "Knob Goblin Embezzler")) {
...
function bestFairy() {
  if ((0,dist.have)((0,dist.$familiar)(_templateObject143 || (_templateObject143 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && (0,dist.have)((0,dist.$item)(_templateObject144 || (_templateObject144 = fights_taggedTemplateLiteral(["li'l ninja costume"]))))) return (0,dist.$familiar)(_templateObject145 || (_templateObject145 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])));
  if ((0,dist.get)("_cheerleaderSteam") > 100 && (0,dist.have)((0,dist.$familiar)(_templateObject146 || (_templateObject146 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"]))))) return (0,dist.$familiar)(_templateObject147 || (_templateObject147 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"])));
  ...
  if (!bestNonCheerleaderFairy) {
    ...
    var bestNonCheerleaderFairies = Familiar.all().filter(function (familiar) {
      return (0,dist.have)(familiar) && familiar !== (0,dist.$familiar)(_templateObject149 || (_templateObject149 = fights_taggedTemplateLiteral(["Steam-Powered Cheerleader"])));
    }).sort(function (a, b) {
      return (0,external_kolmafia_.numericModifier)(b, "Fairy", 1, (0,dist.$item)(_templateObject150 || (_templateObject150 = fights_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Fairy", 1, (0,dist.$item)(_templateObject151 || (_templateObject151 = fights_taggedTemplateLiteral(["none"]))));
    });
    var bestFairyMult = (0,external_kolmafia_.numericModifier)(bestNonCheerleaderFairies[0], "Fairy", 1, (0,dist.$item)(_templateObject152 || (_templateObject152 = fights_taggedTemplateLiteral(["none"]))));
    bestNonCheerleaderFairy = bestNonCheerleaderFairies.filter(function (fairy) {
      return (0,external_kolmafia_.numericModifier)(fairy, "Fairy", 1, (0,dist.$item)(_templateObject153 || (_templateObject153 = fights_taggedTemplateLiteral(["none"])))) === bestFairyMult;
    }).sort(function (a, b) {
      return (0,external_kolmafia_.numericModifier)(b, "Leprechaun", 1, (0,dist.$item)(_templateObject154 || (_templateObject154 = fights_taggedTemplateLiteral(["none"])))) - (0,external_kolmafia_.numericModifier)(a, "Leprechaun", 1, (0,dist.$item)(_templateObject155 || (_templateObject155 = fights_taggedTemplateLiteral(["none"]))));
    })[0];
  }
...
var pygmyMacro = combat.Macro.if_("monstername pygmy bowler", combat.Macro.trySkill("Snokebomb").item((0,dist.$item)(_templateObject156 || (_templateObject156 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))))).if_("monstername pygmy orderlies", combat.Macro.trySkill("Feel Hatred").item((0,dist.$item)(_templateObject157 || (_templateObject157 = fights_taggedTemplateLiteral(["divine champagne popper"]))))).if_("monstername pygmy janitor", combat.Macro.item((0,dist.$item)(_templateObject158 || (_templateObject158 = fights_taggedTemplateLiteral(["tennis ball"]))))).if_("monstername time-spinner prank", combat.Macro.meatKill()).abort();
var freeFightSources = [// Get a Fish Head from our robortender if available
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject159 || (_templateObject159 = fights_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject160 || (_templateObject160 = fights_taggedTemplateLiteral(["Robortender"])))) && !(0,dist.get)("_cargoPocketEmptied") && String((0,dist.get)("cargoPocketsEmptied", "")).indexOf("428") === -1;
}, function () {
  return (0,external_kolmafia_.cliExecute)("cargo monster Mob Penguin Thug");
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject161 || (_templateObject161 = fights_taggedTemplateLiteral(["Robortender"])));
  }
}), new FreeFight(function () {
  ...
  var haveEldritchEssence = (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject162 || (_templateObject162 = fights_taggedTemplateLiteral(["eldritch essence"])))) !== 0;
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject163 || (_templateObject163 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"])))) && !(0,dist.get)("_eldritchHorrorEvoked");
}, function () {
  return (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject164 || (_templateObject164 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
}), new FreeFight(function () {
  return clamp(3 - (0,dist.get)("_lynyrdSnareUses"), 0, 3);
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject165 || (_templateObject165 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject166 || (_templateObject166 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject167 || (_templateObject167 = fights_taggedTemplateLiteral(["[glitch season reward name]"])))) && !(0,dist.get)("_glitchMonsterFights");
}, function () {
...
new FreeFight(function () {
  var maxSeals = (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject168 || (_templateObject168 = fights_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) ? 10 : 5;
  var maxSealsAvailable = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? maxSeals : Math.min(maxSeals, Math.floor((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject169 || (_templateObject169 = fights_taggedTemplateLiteral(["seal-blubber candle"])))) / 3));
  return (0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject170 || (_templateObject170 = fights_taggedTemplateLiteral(["Seal Clubber"]))) ? Math.max(maxSealsAvailable - (0,dist.get)("_sealsSummoned"), 0) : 0;
}, function () {
  var figurine = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? (0,dist.$item)(_templateObject171 || (_templateObject171 = fights_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))) : (0,dist.$item)(_templateObject172 || (_templateObject172 = fights_taggedTemplateLiteral(["figurine of an ancient seal"])));
  (0,external_kolmafia_.retrieveItem)(1, figurine);
  (0,external_kolmafia_.retrieveItem)((0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? 1 : 3, (0,dist.$item)(_templateObject173 || (_templateObject173 = fights_taggedTemplateLiteral(["seal-blubber candle"]))));
  ...
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject174 || (_templateObject174 = fights_taggedTemplateLiteral(["BRICKO ooze"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject175 || (_templateObject175 = fights_taggedTemplateLiteral(["BRICKO eye brick"])))) + 2 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject176 || (_templateObject176 = fights_taggedTemplateLiteral(["BRICKO brick"]))));
  }
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.retrieveItem)(clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9), (0,dist.$item)(_templateObject179 || (_templateObject179 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject180 || (_templateObject180 = fights_taggedTemplateLiteral(["Louder Than Bomb"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject181 || (_templateObject181 = fights_taggedTemplateLiteral(["tennis ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject182 || (_templateObject182 = fights_taggedTemplateLiteral(["divine champagne popper"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject183 || (_templateObject183 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
...
new FreeFight(function () {
  ...
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject187 || (_templateObject187 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject188 || (_templateObject188 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
        return (0,dist.have)(item);
      })
    })];
  }
...
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("_drunkPygmyBanishes") === 10 && !(0,dist.have)((0,dist.$item)(_templateObject189 || (_templateObject189 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject190 || (_templateObject190 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject191 || (_templateObject191 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject192 || (_templateObject192 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
...
new FreeFight(function () {
  var rightTime = (0,dist.have)((0,dist.$item)(_templateObject194 || (_templateObject194 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) && (0,dist.get)("_drunkPygmyBanishes") >= 10;
  var saberedMonster = (0,dist.get)("_saberForceMonster");
  var wrongPygmySabered = saberedMonster && (0,dist.$monsters)(_templateObject195 || (_templateObject195 = fights_taggedTemplateLiteral(["pygmy orderlies, pygmy bowler, pygmy janitor"]))).includes(saberedMonster);
  var drunksCanAppear = (0,dist.get)("_drunkPygmyBanishes") === 10 || saberedMonster === (0,dist.$monster)(_templateObject196 || (_templateObject196 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_saberForceMonsterCount");
  var remainingSaberPygmies = (saberedMonster === (0,dist.$monster)(_templateObject197 || (_templateObject197 = fights_taggedTemplateLiteral(["drunk pygmy"]))) ? (0,dist.get)("_saberForceMonsterCount") : 0) + 2 * clamp(5 - (0,dist.get)("_saberForceUses"), 0, 5);
  return (0,dist.get)("questL11Worship") !== "unstarted" && rightTime && !wrongPygmySabered && drunksCanAppear && remainingSaberPygmies;
}, function () {
  if (((0,dist.get)("_saberForceMonster") !== (0,dist.$monster)(_templateObject198 || (_templateObject198 = fights_taggedTemplateLiteral(["drunk pygmy"]))) || (0,dist.get)("_saberForceMonsterCount") === 1) && (0,dist.get)("_saberForceUses") < 5) {
    ...
    (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject201 || (_templateObject201 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))), (0,dist.$item)(_templateObject202 || (_templateObject202 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
    (0,dist.adventureMacro)((0,dist.$location)(_templateObject203 || (_templateObject203 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.skill("Use the Force"));
  } else {
    if ((0,external_kolmafia_.closetAmount)((0,dist.$item)(_templateObject204 || (_templateObject204 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))) > 0) (0,external_kolmafia_.takeCloset)((0,external_kolmafia_.closetAmount)((0,dist.$item)(_templateObject205 || (_templateObject205 = fights_taggedTemplateLiteral(["Bowl of Scorpions"])))), (0,dist.$item)(_templateObject206 || (_templateObject206 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));else (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject207 || (_templateObject207 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  ...
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject209 || (_templateObject209 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
...
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("crystalBallMonster") === (0,dist.$monster)(_templateObject212 || (_templateObject212 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_drunkPygmyBanishes") >= 11;
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject213 || (_templateObject213 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject214 || (_templateObject214 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject215 || (_templateObject215 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject216 || (_templateObject216 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.abort());
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject217 || (_templateObject217 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
        return (0,dist.have)(item);
      }),
  ...
  return (0,dist.have)((0,dist.$item)(_templateObject220 || (_templateObject220 = fights_taggedTemplateLiteral(["Time-Spinner"])))) && (0,dist.$location)(_templateObject221 || (_templateObject221 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))).combatQueue.includes("drunk pygmy") && (0,dist.get)("_timeSpinnerMinutesUsed") < 8;
}, function () {
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject222 || (_templateObject222 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  combat.Macro.trySkill("Extract").trySkill("Sing Along").setAutoAttack;
  (0,external_kolmafia_.visitUrl)("inv_use.php?whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(_templateObject223 || (_templateObject223 = fights_taggedTemplateLiteral(["Time-Spinner"]))))));
  (0,external_kolmafia_.runChoice)(1);
  (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=1196&monid=".concat((0,dist.$monster)(_templateObject224 || (_templateObject224 = fights_taggedTemplateLiteral(["drunk pygmy"]))).id, "&option=1"));
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      bonusEquip: new Map([[(0,dist.$item)(_templateObject225 || (_templateObject225 = fights_taggedTemplateLiteral(["garbage sticker"]))), 100]]),
      preventEquip: (0,dist.$items)(_templateObject226 || (_templateObject226 = fights_taggedTemplateLiteral(["Staff of Queso Escusado, stinky cheese sword"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("_sausageFights") === 0 && (0,dist.have)((0,dist.$item)(_templateObject227 || (_templateObject227 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
}, function () {
  return (0,external_kolmafia_.adv1)(prepWandererZone(), -1, "");
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject228 || (_templateObject228 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("questL11Ron") === "finished" ? 5 - (0,dist.get)("_glarkCableUses") : 0;
}, function () {
  (0,external_kolmafia_.retrieveItem)(5 - (0,dist.get)("_glarkCableUses"), (0,dist.$item)(_templateObject229 || (_templateObject229 = fights_taggedTemplateLiteral(["glark cable"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject230 || (_templateObject230 = fights_taggedTemplateLiteral(["The Red Zeppelin"]))), combat.Macro.item((0,dist.$item)(_templateObject231 || (_templateObject231 = fights_taggedTemplateLiteral(["glark cable"])))));
}), // Mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject232 || (_templateObject232 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,dist.get)("_mushroomGardenFights") === 0;
}, function () {
  ...
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject237 || (_templateObject237 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.if_("hasskill macrometeorite", combat.Macro.trySkill("Portscan")).meatKill());
  if ((0,dist.have)((0,dist.$item)(_templateObject238 || (_templateObject238 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject239 || (_templateObject239 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject240 || (_templateObject240 = fights_taggedTemplateLiteral(["Robortender"])))) ? (0,dist.$familiar)(_templateObject241 || (_templateObject241 = fights_taggedTemplateLiteral(["Robortender"]))) : null;
  }
}), // Portscan and mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject242 || (_templateObject242 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,external_kolmafia_.getCounters)("portscan.edu", 0, 0) === "portscan.edu" && (0,dist.have)((0,dist.$skill)(_templateObject243 || (_templateObject243 = fights_taggedTemplateLiteral(["Macrometeorite"])))) && (0,dist.get)("_macrometeoriteUses") < 10;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject244 || (_templateObject244 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject245 || (_templateObject245 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject246 || (_templateObject246 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject247 || (_templateObject247 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject248 || (_templateObject248 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.if_("monstername government agent", combat.Macro.skill("Macrometeorite")).if_("monstername piranha plant", combat.Macro.if_("hasskill macrometeorite", combat.Macro.trySkill("Portscan")).meatKill()));
  if ((0,dist.have)((0,dist.$item)(_templateObject249 || (_templateObject249 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject250 || (_templateObject250 = fights_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject251 || (_templateObject251 = fights_taggedTemplateLiteral(["God Lobster"])))) ? clamp(3 - (0,dist.get)("_godLobsterFights"), 0, 3) : 0;
}, function () {
  ...
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject252 || (_templateObject252 = fights_taggedTemplateLiteral(["God Lobster"])));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$familiar)(_templateObject253 || (_templateObject253 = fights_taggedTemplateLiteral(["Machine Elf"])))) ? clamp(5 - (0,dist.get)("_machineTunnelsAdv"), 0, 5) : 0;
}, function () {
  return (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject254 || (_templateObject254 = fights_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, "");
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject255 || (_templateObject255 = fights_taggedTemplateLiteral(["Machine Elf"])));
  }
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject256 || (_templateObject256 = fights_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), -1, "");
}), new FreeFight(function () {
  ...
  nepQuest();
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject257 || (_templateObject257 = fights_taggedTemplateLiteral(["The Neverending Party"]))), combat.Macro.trySkill("Feel Pride").meatKill());
  ...
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.have)((0,dist.$item)(_templateObject258 || (_templateObject258 = fights_taggedTemplateLiteral(["January's Garbage Tote"])))) ? (0,dist.$items)(_templateObject259 || (_templateObject259 = fights_taggedTemplateLiteral(["makeshift garbage shirt"]))) : []
    })];
  }
})];
var freeKillSources = [new FreeFight(function () {
  return !(0,dist.get)("_gingerbreadMobHitUsed") && (0,dist.have)((0,dist.$skill)(_templateObject260 || (_templateObject260 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Gingerbread Mob Hit"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject261 || (_templateObject261 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject262 || (_templateObject262 = fights_taggedTemplateLiteral(["Shattering Punch"])))) ? clamp(3 - (0,dist.get)("_shatteringPunchUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Shattering Punch"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject263 || (_templateObject263 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
new FreeFight(function () {
  return !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject264 || (_templateObject264 = fights_taggedTemplateLiteral(["The Jokester's gun"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Fire the Jokester's Gun"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject265 || (_templateObject265 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject266 || (_templateObject266 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })];
  }
}), // 22	3	0	0	Chest X-Ray	combat skill	must have a Lil' Doctor™ bag equipped
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject267 || (_templateObject267 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? clamp(3 - (0,dist.get)("_chestXRayUsed"), 0, 3) : 0;
}, function () {
  ...
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject269 || (_templateObject269 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject270 || (_templateObject270 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))) ? clamp(3 - (0,dist.get)("_usedReplicaBatoomerang"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").item("replica bat-oomerang"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject271 || (_templateObject271 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
  ...
  (0,combat.withMacro)(combat.Macro.skill("Sing Along").skill("Asdon Martin: Missile Launcher"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject272 || (_templateObject272 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: bestFairy,
  requirements: function requirements() {
...
function freeFights() {
  ...
  if (!(0,dist.have)((0,dist.$item)(_templateObject273 || (_templateObject273 = fights_taggedTemplateLiteral(["li'l ninja costume"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject274 || (_templateObject274 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject275 || (_templateObject275 = fights_taggedTemplateLiteral(["The Jokester's gun"]))))) {
    (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
    freeFightMood().execute();
    freeFightOutfit([new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject276 || (_templateObject276 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })]);

    if (questStep("questL08Trapper") >= 2) {
      (0,dist.adventureMacroAuto)((0,dist.$location)(_templateObject277 || (_templateObject277 = fights_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))), combat.Macro.skill("Fire the Jokester's Gun"));
    } else if ((0,dist.have)((0,dist.$skill)(_templateObject278 || (_templateObject278 = fights_taggedTemplateLiteral(["Comprehensive Cartography"])))) && (0,dist.get)("_monstersMapped") < 3) {
      try {
        combat.Macro.skill("Fire the Jokester's Gun").setAutoAttack();
        mapMonster((0,dist.$location)(_templateObject279 || (_templateObject279 = fights_taggedTemplateLiteral(["The Haiku Dungeon"]))), (0,dist.$monster)(_templateObject280 || (_templateObject280 = fights_taggedTemplateLiteral(["amateur ninja"]))));
      } finally {
  ...
  try {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        if (freeKillSource.available()) {
          ...
          ensureEffect((0,dist.$effect)(_templateObject281 || (_templateObject281 = fights_taggedTemplateLiteral(["Feeling Lost"]))));

          if ((0,dist.have)((0,dist.$skill)(_templateObject282 || (_templateObject282 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"])))) && !(0,dist.get)("_steelyEyedSquintUsed")) {
            (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject283 || (_templateObject283 = fights_taggedTemplateLiteral(["Steely-Eyed Squint"]))));
          }
        }
    ...
    if ((0,dist.have)((0,dist.$item)(_templateObject284 || (_templateObject284 = fights_taggedTemplateLiteral(["January's Garbage Tote"]))))) (0,external_kolmafia_.cliExecute)("fold wad of used tape");
  }
}
...
function thesisReady() {
  return !(0,dist.get)("_thesisDelivered") && (0,dist.have)((0,dist.$familiar)(_templateObject285 || (_templateObject285 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject286 || (_templateObject286 = fights_taggedTemplateLiteral(["Pocket Professor"]))).experience >= 400;
}
...
function deliverThesis() {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject287 || (_templateObject287 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
  freeFightMood().execute();
  freeFightOutfit([new Requirement(["100 muscle"], {})]);
  safeRestore();

  if ((0,dist.have)((0,dist.$item)(_templateObject288 || (_templateObject288 = fights_taggedTemplateLiteral(["Powerful Glove"])))) && !(0,dist.have)((0,dist.$effect)(_templateObject289 || (_templateObject289 = fights_taggedTemplateLiteral(["Triple-Sized"])))) && (0,dist.get)("_powerfulGloveBatteryPowerUsed") <= 95) {
    (0,external_kolmafia_.cliExecute)("checkpoint");
    (0,external_kolmafia_.equip)((0,dist.$slot)(_templateObject290 || (_templateObject290 = fights_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject291 || (_templateObject291 = fights_taggedTemplateLiteral(["Powerful Glove"]))));
    ensureEffect((0,dist.$effect)(_templateObject292 || (_templateObject292 = fights_taggedTemplateLiteral(["Triple-Sized"]))));
    (0,external_kolmafia_.outfit)("checkpoint");
  }

  (0,external_kolmafia_.cliExecute)("gain 1800 muscle");
  (0,dist.adventureMacro)(thesisInNEP ? (0,dist.$location)(_templateObject293 || (_templateObject293 = fights_taggedTemplateLiteral(["The Neverending Party"]))) : (0,dist.$location)(_templateObject294 || (_templateObject294 = fights_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), combat.Macro.skill("Deliver your Thesis"));
}
...
function safeRestore() {
  ...
  if ((0,external_kolmafia_.myMp)() < 50 && (0,external_kolmafia_.myMaxmp)() > 50) {
    if (((0,dist.have)((0,dist.$item)(_templateObject295 || (_templateObject295 = fights_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(_templateObject296 || (_templateObject296 = fights_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject297 || (_templateObject297 = fights_taggedTemplateLiteral(["magical sausage"]))));
    }
...
function doSausage() {
  ...
  (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
  freeFightOutfit([new Requirement([], {
    forceEquip: (0,dist.$items)(_templateObject298 || (_templateObject298 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
  })]);
