...
function meatOutfit(embezzlerUp) {
  ...
  if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) {
    ...
    if ((0,external_kolmafia_.myClass)() !== (0,dist.$class)(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["Seal Clubber"])))) {
      ...
      } else if ((0,dist.have)((0,dist.$item)(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) {
    ...
    forceEquip.push((0,dist.$item)(_templateObject31 || (_templateObject31 = outfit_taggedTemplateLiteral(["mafia pointer finger ring"]))));
  }

  if ((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(_templateObject32 || (_templateObject32 = outfit_taggedTemplateLiteral(["Obtuse Angel"])))) {
    forceEquip.push((0,dist.$item)(_templateObject33 || (_templateObject33 = outfit_taggedTemplateLiteral(["quake of arrows"]))));
    if (!(0,dist.have)((0,dist.$item)(_templateObject34 || (_templateObject34 = outfit_taggedTemplateLiteral(["quake of arrows"]))))) (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject35 || (_templateObject35 = outfit_taggedTemplateLiteral(["quake of arrows"]))));
  }
  ...
  var bjornAlike = (0,dist.have)((0,dist.$item)(_templateObject36 || (_templateObject36 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) && !forceEquip.some(function (item) {
    return (0,external_kolmafia_.toSlot)(item) === (0,dist.$slot)(_templateObject37 || (_templateObject37 = outfit_taggedTemplateLiteral(["back"])));
  }) ? (0,dist.$item)(_templateObject38 || (_templateObject38 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) : (0,dist.$item)(_templateObject39 || (_templateObject39 = outfit_taggedTemplateLiteral(["Crown of Thrones"])));
  var compiledRequirements = Requirement.merge([].concat(outfit_toConsumableArray(requirements), [new Requirement(["".concat(((embezzlerUp ? baseMeat + 750 : baseMeat) / 100).toFixed(2), " Meat Drop"), "".concat(embezzlerUp ? 0 : 0.72, " Item Drop")].concat(additionalRequirements), {
    ...
    preventEquip: [].concat(outfit_toConsumableArray((0,dist.$items)(_templateObject40 || (_templateObject40 = outfit_taggedTemplateLiteral(["broken champagne bottle, unwrapped knock-off retro superhero cape"])))), outfit_toConsumableArray(embezzlerUp ? (0,dist.$items)(_templateObject41 || (_templateObject41 = outfit_taggedTemplateLiteral(["cheap sunglasses"]))) : []), [bjornAlike === (0,dist.$item)(_templateObject42 || (_templateObject42 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) ? (0,dist.$item)(_templateObject43 || (_templateObject43 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) : (0,dist.$item)(_templateObject44 || (_templateObject44 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))]),
    bonusEquip: new Map([[(0,dist.$item)(_templateObject45 || (_templateObject45 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(_templateObject46 || (_templateObject46 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))), 300], [(0,dist.$item)(_templateObject47 || (_templateObject47 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(_templateObject48 || (_templateObject48 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(_templateObject49 || (_templateObject49 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [(0,dist.$item)(_templateObject50 || (_templateObject50 = outfit_taggedTemplateLiteral(["Pantsgiving"]))), embezzlerUp ? 0 : pantsgivingBonus()]].concat(outfit_toConsumableArray(cheeses(embezzlerUp)), [[bjornAlike, !bjornChoice.dropPredicate || bjornChoice.dropPredicate() ? bjornChoice.meatVal() * bjornChoice.probability : 0]]))
  })]));
  (0,dist.maximizeCached)(compiledRequirements.maximizeParameters(), compiledRequirements.maximizeOptions());

  if ((0,external_kolmafia_.equippedAmount)((0,dist.$item)(_templateObject51 || (_templateObject51 = outfit_taggedTemplateLiteral(["ice nine"])))) > 0) {
    (0,external_kolmafia_.equip)((0,dist.$item)(_templateObject52 || (_templateObject52 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
  }

  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(_templateObject53 || (_templateObject53 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_.bjornifyFamiliar)(bjornChoice.familiar);
  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(_templateObject54 || (_templateObject54 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_.enthroneFamiliar)(bjornChoice.familiar);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if ((0,dist.have)(airSource)) {
            if (airSource === (0,dist.$item)(_templateObject55 || (_templateObject55 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying"])))) (0,external_kolmafia_.cliExecute)("edpiece fish");
...
var waterBreathingEquipment = (0,dist.$items)(_templateObject56 || (_templateObject56 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying, aerated diving helmet, crappy Mer-kin mask, Mer-kin gladiator mask, Mer-kin scholar mask, old SCUBA tank"])));
var familiarWaterBreathingEquipment = (0,dist.$items)(_templateObject57 || (_templateObject57 = outfit_taggedTemplateLiteral(["das boot, little bitty bathysphere"])));

function pantsgivingBonus() {
  if (!(0,dist.have)((0,dist.$item)(_templateObject58 || (_templateObject58 = outfit_taggedTemplateLiteral(["Pantsgiving"]))))) return 0;
...
function embezzlerSetup() {
  ...
  if (dist.SourceTerminal.have()) dist.SourceTerminal.educate([(0,dist.$skill)(fights_templateObject61 || (fights_templateObject61 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(fights_templateObject62 || (fights_templateObject62 = fights_taggedTemplateLiteral(["Digitize"])))]);
