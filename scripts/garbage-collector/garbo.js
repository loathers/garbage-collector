...
function mapMonster(location, monster) {
  if ((0,external_kolmafia_.haveSkill)((0,dist.$skill)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Map the Monsters"])))) && !(0,dist.get)("mappingMonsters") && (0,dist.get)("_monstersMapped") < 3) {
    (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Map the Monsters"]))));
  }
...
function guzzlrCheck() {
  ...
  if (forbiddenZones.includes(guzzlZone.zone) || !guzzlZone.wanderers || guzzlZone === (0,dist.$location)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["The Oasis"]))) || guzzlZone === (0,dist.$location)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["The Bubblin' Caldera"]))) || guzzlZone.environment === "underwater" || guzzlZone === (0,dist.$location)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["Barrrney's Barrr"]))) || guzzlZone === (0,dist.$location)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["The F'c'le"]))) || guzzlZone === (0,dist.$location)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["the poop deck"]))) || guzzlZone === (0,dist.$location)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["belowdecks"]))) || guzzlZone === (0,dist.$location)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["8-Bit Realm"]))) || guzzlZone.zone === "BatHole" && guzzlZone !== (0,dist.$location)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["The Bat Hole Entrance"]))) || guzzlZone === (0,dist.$location)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["The Secret Government Laboratory"]))) || !(0,external_canadv_ash_namespaceObject.canAdv)(guzzlZone, false)) {
    return false;
  } else {
    return true;
  }
...
function dropGuzzlrQuest() {
  ...
  (0,dist.set)("choiceAdventure1412", "");
...
var physicalImmuneMacro = dist.Macro.trySkill("curse of weaksauce").trySkill("sing along").trySkill("extract").externalIf((0,dist.have)((0,dist.$skill)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["saucestorm"])))), dist.Macro.skill("Saucestorm").repeat()).externalIf((0,dist.have)((0,dist.$skill)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["saucegeyser"])))), dist.Macro.skill("Saucegeyser").repeat()).externalIf((0,dist.have)((0,dist.$skill)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["Cannelloni Cannon"])))), dist.Macro.skill("Cannelloni Cannon").repeat()).externalIf((0,dist.have)((0,dist.$skill)(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["Wave of Sauce"])))), dist.Macro.skill("Wave of Sauce").repeat()).externalIf((0,dist.have)((0,dist.$skill)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["Saucecicle"])))), dist.Macro.skill("Saucecicle").repeat()); //The Freezewoman is spooky-aligned, don't worry

function tryFeast(familiar) {
  if ((0,dist.have)(familiar)) {
    (0,external_kolmafia_.useFamiliar)(familiar);
    (0,external_kolmafia_.use)((0,dist.$item)(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["moveable feast"]))));
  }
}
...
function meatFamiliar() {
  if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)() && (0,dist.have)((0,dist.$familiar)(familiar_templateObject || (familiar_templateObject = familiar_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && (0,dist.have)((0,dist.$item)(familiar_templateObject2 || (familiar_templateObject2 = familiar_taggedTemplateLiteral(["li'l pirate costume"]))))) {
    return (0,dist.$familiar)(familiar_templateObject3 || (familiar_templateObject3 = familiar_taggedTemplateLiteral(["Trick-or-Treating Tot"])));
  } else {
    var _iterator = _createForOfIteratorHelper((0,dist.$familiars)(familiar_templateObject4 || (familiar_templateObject4 = familiar_taggedTemplateLiteral(["Robortender, ", "Hobo Monkey, ", "Cat Burglar, Urchin Urchin, Leprechaun"])), (0,external_kolmafia_.numericModifier)((0,dist.$item)(familiar_templateObject5 || (familiar_templateObject5 = familiar_taggedTemplateLiteral(["depleted grimacite grappling hook"]))), "Adventures") === 0 ? "Mutant Cactus Bud, " : "", (0,external_kolmafia_.numericModifier)((0,dist.$item)(familiar_templateObject6 || (familiar_templateObject6 = familiar_taggedTemplateLiteral(["depleted grimacite grappling hook"]))), "Adventures") === 1 ? "Mutant Cactus Bud, " : "")),
        _step;
...
var rotatingFamiliars = {
  "Fist Turkey": {
    ...
    drop: (0,dist.$item)(familiar_templateObject7 || (familiar_templateObject7 = familiar_taggedTemplateLiteral(["Ambitious Turkey"]))),
    pref: "_turkeyBooze"
  },
  "Llama Lama": {
    expected: [3.42, 3.91, 4.52, 5.29, 5.29],
    drop: (0,dist.$item)(familiar_templateObject8 || (familiar_templateObject8 = familiar_taggedTemplateLiteral(["llama lama gong"]))),
    pref: "_gongDrops"
  },
  "Li'l Xenomorph": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject9 || (familiar_templateObject9 = familiar_taggedTemplateLiteral(["transporter transponder"]))),
    pref: "_transponderDrops"
  },
  "Rogue Program": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject10 || (familiar_templateObject10 = familiar_taggedTemplateLiteral(["Game Grid token"]))),
    pref: "_tokenDrops"
  },
  "Bloovian Groose": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject11 || (familiar_templateObject11 = familiar_taggedTemplateLiteral(["groose grease"]))),
    pref: "_grooseDrops"
  },
  "Baby Sandworm": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject12 || (familiar_templateObject12 = familiar_taggedTemplateLiteral(["agua de vida"]))),
    pref: "_aguaDrops"
  },
  "Green Pixie": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject13 || (familiar_templateObject13 = familiar_taggedTemplateLiteral(["tiny bottle of absinthe"]))),
    pref: "_absintheDrops"
  },
  "Blavious Kloop": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject14 || (familiar_templateObject14 = familiar_taggedTemplateLiteral(["devilish folio"]))),
    pref: "_kloopDrops"
  },
  "Galloping Grill": {
    expected: [3.03, 3.42, 3.91, 4.52, 5.29],
    drop: (0,dist.$item)(familiar_templateObject15 || (familiar_templateObject15 = familiar_taggedTemplateLiteral(["hot ashes"]))),
    pref: "_hotAshesDrops"
  }
};
...
function mimicDropValue() {
  ...
  return (_savedMimicDropValue = savedMimicDropValue) !== null && _savedMimicDropValue !== void 0 ? _savedMimicDropValue : savedMimicDropValue = averagePrice((0,dist.$items)(familiar_templateObject16 || (familiar_templateObject16 = familiar_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"])))) / (6.29 * 0.95 + 1 * 0.05);
}

function freeFightFamiliar() {
  var familiarValue = [];

  if ((0,dist.have)((0,dist.$familiar)(familiar_templateObject17 || (familiar_templateObject17 = familiar_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(familiar_templateObject18 || (familiar_templateObject18 = familiar_taggedTemplateLiteral(["Pocket Professor"]))).experience < 400 && !(0,dist.get)("_thesisDelivered")) {
    // Estimate based on value to charge thesis.
    familiarValue.push([(0,dist.$familiar)(familiar_templateObject19 || (familiar_templateObject19 = familiar_taggedTemplateLiteral(["Pocket Professor"]))), 3000]);
  }
  ...
  if ((0,dist.have)((0,dist.$familiar)(familiar_templateObject20 || (familiar_templateObject20 = familiar_taggedTemplateLiteral(["Stocking Mimic"]))))) {
    var mimicWeight = myFamiliarWeight((0,dist.$familiar)(familiar_templateObject21 || (familiar_templateObject21 = familiar_taggedTemplateLiteral(["Stocking Mimic"]))));
    var actionPercentage = 1 / 3 + ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(familiar_templateObject22 || (familiar_templateObject22 = familiar_taggedTemplateLiteral(["Jingle Jangle Jingle"])))) ? 0.1 : 0);
  ...
  var _iterator2 = _createForOfIteratorHelper((0,dist.$familiars)(familiar_templateObject27 || (familiar_templateObject27 = familiar_taggedTemplateLiteral(["Hobo Monkey, Cat Burglar, Urchin Urchin, Leprechaun"])))),
      _step2;
  ...
  if (have(latte) && questStep("questL02Larva") > -1 && questStep("questL11MacGuffin") > -1) {
    if (numericModifier(latte, "Familiar Weight") !== 5 || numericModifier(latte, "Meat Drop") !== 40) {
      ...
      if (!get("latteUnlocks").includes("rawhide") && (haveFamiliar($familiar(dailies_templateObject25 || (dailies_templateObject25 = dailies_taggedTemplateLiteral(["frumious bandersnatch"])))) || haveFamiliar($familiar(dailies_templateObject26 || (dailies_templateObject26 = dailies_taggedTemplateLiteral(["pair of stomping boots"]))))) && Bandersnatch.getRemainingRunaways() > 0) {
        var _runFam = haveFamiliar($familiar(dailies_templateObject27 || (dailies_templateObject27 = dailies_taggedTemplateLiteral(["pair of stomping boots"])))) ? $familiar(dailies_templateObject28 || (dailies_templateObject28 = dailies_taggedTemplateLiteral(["pair of stomping boots"]))) : $familiar(dailies_templateObject29 || (dailies_templateObject29 = dailies_taggedTemplateLiteral(["frumious bandersnatch"])));

        useFamiliar(_runFam);
        maximize("familiar weight, +equip latte lovers member's mug", false);
        if (_runFam === $familiar(dailies_templateObject30 || (dailies_templateObject30 = dailies_taggedTemplateLiteral(["frumious bandersnatch"])))) ensureEffect($effect(dailies_templateObject31 || (dailies_templateObject31 = dailies_taggedTemplateLiteral(["ode to booze"]))));
        Macro.step("runaway").setAutoAttack();
        setChoice(502, 2);
        setChoice(505, 2);

        while (!get("latteUnlocks").includes("rawhide") && Bandersnatch.getRemainingRunaways() > 0) {
          adv1($location(dailies_templateObject32 || (dailies_templateObject32 = dailies_taggedTemplateLiteral(["the spooky forest"]))), -1, "");
        }
      }
...
function prepFamiliars() {
  if ((0,dist.have)((0,dist.$familiar)(_templateObject43 || (_templateObject43 = dailies_taggedTemplateLiteral(["Robortender"]))))) {
    var _iterator = dailies_createForOfIteratorHelper((0,dist.$items)(_templateObject44 || (_templateObject44 = dailies_taggedTemplateLiteral(["Newark, drive-by shooting, Feliz Navidad, single entendre, bloody nora"])))),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject45 || (_templateObject45 = dailies_taggedTemplateLiteral(["robortender"]))));
  ...
  if ((0,dist.have)((0,dist.$item)(_templateObject46 || (_templateObject46 = dailies_taggedTemplateLiteral(["mumming trunk"])))) && !(0,dist.get)("_mummeryMods").includes("Meat Drop")) {
    (0,external_kolmafia_.useFamiliar)(meatFamiliar());
    (0,external_kolmafia_.cliExecute)("mummery meat");
  }

  if ((0,dist.have)((0,dist.$item)(_templateObject47 || (_templateObject47 = dailies_taggedTemplateLiteral(["mumming trunk"])))) && !(0,dist.get)("_mummeryMods").includes("Item Drop") && (0,dist.have)((0,dist.$familiar)(_templateObject48 || (_templateObject48 = dailies_taggedTemplateLiteral(["Trick-or-Treating Tot"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject49 || (_templateObject49 = dailies_taggedTemplateLiteral(["Trick-or-Treating Tot"]))));
    (0,external_kolmafia_.cliExecute)("mummery item");
  }

  if ((0,dist.get)("_feastUsed") === 0) {
    withStash((0,dist.$items)(_templateObject50 || (_templateObject50 = dailies_taggedTemplateLiteral(["moveable feast"]))), function () {
      if ((0,dist.have)((0,dist.$item)(_templateObject51 || (_templateObject51 = dailies_taggedTemplateLiteral(["moveable feast"]))))) [].concat(dailies_toConsumableArray((0,dist.$familiars)(_templateObject52 || (_templateObject52 = dailies_taggedTemplateLiteral(["Pocket Professor, Frumious Bandersnatch"])))), [meatFamiliar()]).forEach(tryFeast);
    });
  }
}
function horse() {
...
function dailyBuffs() {
  if (!(0,dist.get)("_clanFortuneBuffUsed") && (0,dist.have)((0,dist.$item)(_templateObject53 || (_templateObject53 = dailies_taggedTemplateLiteral(["Clan VIP lounge key"])))) && (0,external_kolmafia_.getClanLounge)()["Clan Carnival Game"] !== undefined) {
...
function configureMisc() {
  ...
  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject55 || (_templateObject55 = dailies_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject56 || (_templateObject56 = dailies_taggedTemplateLiteral(["Digitize"])))]);
    dist.SourceTerminal.enquiry((0,dist.$effect)(_templateObject57 || (_templateObject57 = dailies_taggedTemplateLiteral(["familiar.enq"]))));
  }

  if ((0,dist.get)("_VYKEACompanionLevel") === 0) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject58 || (_templateObject58 = dailies_taggedTemplateLiteral(["VYKEA hex key"]))));
    (0,external_kolmafia_.cliExecute)("create level 3 couch");
  }

  if ((0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject59 || (_templateObject59 = dailies_taggedTemplateLiteral(["Pastamancer"]))) && (0,external_kolmafia_.myThrall)() !== (0,dist.$thrall)(_templateObject60 || (_templateObject60 = dailies_taggedTemplateLiteral(["Lasagmbie"]))) && (0,external_kolmafia_.haveSkill)((0,dist.$skill)(_templateObject61 || (_templateObject61 = dailies_taggedTemplateLiteral(["Bind Lasagmbie"]))))) {
    (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject62 || (_templateObject62 = dailies_taggedTemplateLiteral(["Bind Lasagmbie"]))));
  }
...
function volcanoDailies() {
  ...
  if ((0,dist.get)("_unaccompaniedMinerUsed") < 5) {
...
function checkVolcanoQuest() {
  ...
  var volcanoItems = [dist.property.getItem("_volcanoItem1") || (0,dist.$item)(_templateObject63 || (_templateObject63 = dailies_taggedTemplateLiteral(["none"]))), dist.property.getItem("_volcanoItem2") || (0,dist.$item)(_templateObject64 || (_templateObject64 = dailies_taggedTemplateLiteral(["none"]))), dist.property.getItem("_volcanoItem3") || (0,dist.$item)(_templateObject65 || (_templateObject65 = dailies_taggedTemplateLiteral(["none"])))];
  var volcanoWhatToDo = new Map([[(0,dist.$item)(_templateObject66 || (_templateObject66 = dailies_taggedTemplateLiteral(["new age healing crystal"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject67 || (_templateObject67 = dailies_taggedTemplateLiteral(["new age healing crystal"])))) >= 5) return true;else {
      return (0,external_kolmafia_.buy)(5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject68 || (_templateObject68 = dailies_taggedTemplateLiteral(["new age healing crystal"])))), (0,dist.$item)(_templateObject69 || (_templateObject69 = dailies_taggedTemplateLiteral(["new age healing crystal"]))), 1000) === 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject70 || (_templateObject70 = dailies_taggedTemplateLiteral(["new age healing crystal"]))));
    }
  }], [(0,dist.$item)(_templateObject71 || (_templateObject71 = dailies_taggedTemplateLiteral(["smooch bottlecap"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject72 || (_templateObject72 = dailies_taggedTemplateLiteral(["smooch bottlecap"])))) > 0) return true;else return (0,external_kolmafia_.buy)(1, (0,dist.$item)(_templateObject73 || (_templateObject73 = dailies_taggedTemplateLiteral(["smooch bottlecap"]))), 5000) === 1;
  }], [(0,dist.$item)(_templateObject74 || (_templateObject74 = dailies_taggedTemplateLiteral(["gooey lava globs"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject75 || (_templateObject75 = dailies_taggedTemplateLiteral(["gooey lava globs"])))) >= 5) {
      return true;
    } else {
      var toBuy = 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject76 || (_templateObject76 = dailies_taggedTemplateLiteral(["gooey lava globs"]))));
      return (0,external_kolmafia_.buy)(toBuy, (0,dist.$item)(_templateObject77 || (_templateObject77 = dailies_taggedTemplateLiteral(["gooey lava globs"]))), 5000) === toBuy;
    }
  }], [(0,dist.$item)(_templateObject78 || (_templateObject78 = dailies_taggedTemplateLiteral(["fused fuse"]))), function () {
    return (0,dist.have)((0,dist.$item)(_templateObject79 || (_templateObject79 = dailies_taggedTemplateLiteral(["clara's bell"]))));
  }], [(0,dist.$item)(_templateObject80 || (_templateObject80 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject81 || (_templateObject81 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) < 3) {
      (0,external_kolmafia_.cliExecute)("acquire ".concat((3 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject82 || (_templateObject82 = dailies_taggedTemplateLiteral(["smooth velvet bra"]))))).toString(), " smooth velvet bra"));
    }

    return (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject83 || (_templateObject83 = dailies_taggedTemplateLiteral(["smooth velvet bra"])))) >= 3;
  }], [(0,dist.$item)(_templateObject84 || (_templateObject84 = dailies_taggedTemplateLiteral(["smooch bracers"]))), function () {
    if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject85 || (_templateObject85 = dailies_taggedTemplateLiteral(["smooch bracers"])))) < 3) {
      (0,external_kolmafia_.cliExecute)("acquire ".concat((3 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject86 || (_templateObject86 = dailies_taggedTemplateLiteral(["smooch bracers"]))))).toString(), " smooch bracers"));
    }

    return (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject87 || (_templateObject87 = dailies_taggedTemplateLiteral(["smooch bracers"])))) >= 3;
  }]]);
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (volcanoItems.includes(volcanoItem)) {
        if (tryToGetIt()) {
          if (volcanoItem !== (0,dist.$item)(_templateObject88 || (_templateObject88 = dailies_taggedTemplateLiteral(["fused fuse"])))) {
            (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
...
function cheat() {
  if ((0,dist.have)((0,dist.$item)(_templateObject89 || (_templateObject89 = dailies_taggedTemplateLiteral(["deck of every card"]))))) {
...
var snuff = (0,dist.$item)(diet_templateObject2 || (diet_templateObject2 = diet_taggedTemplateLiteral(["voodoo snuff"])));
...
function fillSpleenWith(spleenItem) {
  if ((0,external_kolmafia_.mySpleenUse)() + spleenItem.spleen <= (0,external_kolmafia_.spleenLimit)()) {
    ...
    var synthTurns = (0,external_kolmafia_.haveEffect)((0,dist.$effect)(diet_templateObject4 || (diet_templateObject4 = diet_taggedTemplateLiteral(["Synthesis: Greed"]))));
    ...
    if ((0,dist.have)((0,dist.$skill)(diet_templateObject5 || (diet_templateObject5 = diet_taggedTemplateLiteral(["Sweet Synthesis"]))))) {
      for (var i = 0; i < clamp(spleenSynth, 0, (0,external_kolmafia_.spleenLimit)() - (0,external_kolmafia_.mySpleenUse)()); i++) {
        (0,external_kolmafia_.sweetSynthesis)((0,dist.$effect)(diet_templateObject6 || (diet_templateObject6 = diet_taggedTemplateLiteral(["Synthesis: Greed"]))));
      }
    }
...
function fillStomach() {
  if ((0,external_kolmafia_.myLevel)() >= 15 && !(0,dist.get)("_hungerSauceUsed") && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject7 || (diet_templateObject7 = diet_taggedTemplateLiteral(["Hunger&trade; sauce"])))) < 3 * MPA) {
    acquire(1, (0,dist.$item)(diet_templateObject8 || (diet_templateObject8 = diet_taggedTemplateLiteral(["Hunger&trade; sauce"]))), 3 * MPA);
    (0,external_kolmafia_.use)(1, (0,dist.$item)(diet_templateObject9 || (diet_templateObject9 = diet_taggedTemplateLiteral(["Hunger&trade; sauce"]))));
  }

  useIfUnused((0,dist.$item)(diet_templateObject10 || (diet_templateObject10 = diet_taggedTemplateLiteral(["milk of magnesium"]))), "_milkOfMagnesiumUsed", 5 * MPA);
  ...
  while ((0,external_kolmafia_.myFullness)() + 5 <= (0,external_kolmafia_.fullnessLimit)()) {
    ...
    eatSpleen(count, (0,dist.$item)(diet_templateObject11 || (diet_templateObject11 = diet_taggedTemplateLiteral(["Ol' Scratch's salad fork"]))));
...
function fillLiver() {
  if ((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(diet_templateObject13 || (diet_templateObject13 = diet_taggedTemplateLiteral(["Stooper"])))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(diet_templateObject14 || (diet_templateObject14 = diet_taggedTemplateLiteral(["none"]))));
  }

  if (!(0,dist.get)("_mimeArmyShotglassUsed") && (0,external_kolmafia_.itemAmount)((0,dist.$item)(diet_templateObject15 || (diet_templateObject15 = diet_taggedTemplateLiteral(["mime army shotglass"])))) > 0) {
    (0,external_kolmafia_.equip)((0,dist.$item)(diet_templateObject16 || (diet_templateObject16 = diet_taggedTemplateLiteral(["tuxedo shirt"]))));
    (0,external_kolmafia_.drink)(itemPriority((0,dist.$item)(diet_templateObject17 || (diet_templateObject17 = diet_taggedTemplateLiteral(["astral pilsner"]))), (0,dist.$item)(diet_templateObject18 || (diet_templateObject18 = diet_taggedTemplateLiteral(["splendid martini"])))));
  }

  while ((0,external_kolmafia_.myInebriety)() + 1 <= (0,external_kolmafia_.inebrietyLimit)() && (0,external_kolmafia_.itemAmount)((0,dist.$item)(diet_templateObject19 || (diet_templateObject19 = diet_taggedTemplateLiteral(["astral pilsner"])))) > 0) {
    (0,external_kolmafia_.drink)(1, (0,dist.$item)(diet_templateObject20 || (diet_templateObject20 = diet_taggedTemplateLiteral(["astral pilsner"]))));
  }
  ...
  while ((0,external_kolmafia_.myInebriety)() + 5 <= (0,external_kolmafia_.inebrietyLimit)()) {
    ...
    drinkSpleen(count, (0,dist.$item)(diet_templateObject21 || (diet_templateObject21 = diet_taggedTemplateLiteral(["Frosty's frosty mug"]))));
    drinkSpleen(count, (0,dist.$item)(diet_templateObject22 || (diet_templateObject22 = diet_taggedTemplateLiteral(["jar of fermented pickle juice"]))));
    fillSomeSpleen();
  }
}
...
function runDiet() {
  ...
  if ((0,external_kolmafia_.getProperty)("_timesArrowUsed") !== "true" && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject46 || (diet_templateObject46 = diet_taggedTemplateLiteral(["time's arrow"])))) < 5 * MPA) {
    acquire(1, (0,dist.$item)(diet_templateObject47 || (diet_templateObject47 = diet_taggedTemplateLiteral(["time's arrow"]))), 5 * MPA);
    (0,external_kolmafia_.cliExecute)("csend 1 time's arrow to botticelli");
    (0,external_kolmafia_.setProperty)("_timesArrowUsed", "true");
  }

  if ((0,dist.have)((0,dist.$skill)(diet_templateObject48 || (diet_templateObject48 = diet_taggedTemplateLiteral(["Ancestral Recall"])))) && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject49 || (diet_templateObject49 = diet_taggedTemplateLiteral(["blue mana"])))) < 3 * MPA) {
    var casts = Math.max(10 - (0,dist.get)("_ancestralRecallCasts"), 0);
    acquire(casts, (0,dist.$item)(diet_templateObject50 || (diet_templateObject50 = diet_taggedTemplateLiteral(["blue mana"]))), 3 * MPA);
    (0,external_kolmafia_.useSkill)(casts, (0,dist.$skill)(diet_templateObject51 || (diet_templateObject51 = diet_taggedTemplateLiteral(["Ancestral Recall"]))));
  }

  useIfUnused((0,dist.$item)(diet_templateObject52 || (diet_templateObject52 = diet_taggedTemplateLiteral(["borrowed time"]))), "_borrowedTimeUsed", 5 * MPA);
  fillSomeSpleen();
  fillStomach();
  fillLiver();

  if (!(0,dist.get)("_distentionPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(diet_templateObject53 || (diet_templateObject53 = diet_taggedTemplateLiteral(["distention pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(diet_templateObject54 || (diet_templateObject54 = diet_taggedTemplateLiteral(["distention pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject55 || (diet_templateObject55 = diet_taggedTemplateLiteral(["distention pill"]))))) {
  ...
  if (!(0,dist.get)("_syntheticDogHairPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(diet_templateObject56 || (diet_templateObject56 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(diet_templateObject57 || (diet_templateObject57 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject58 || (diet_templateObject58 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))))) {
  ...
  acquire(mojoFilterCount, (0,dist.$item)(diet_templateObject59 || (diet_templateObject59 = diet_taggedTemplateLiteral(["mojo filter"]))), valuePerSpleen(bestSpleenItem));
  (0,external_kolmafia_.use)(mojoFilterCount, (0,dist.$item)(diet_templateObject60 || (diet_templateObject60 = diet_taggedTemplateLiteral(["mojo filter"]))));
  fillSomeSpleen();

  while ((0,external_kolmafia_.myFullness)() < (0,external_kolmafia_.fullnessLimit)()) {
    if ((0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject61 || (diet_templateObject61 = diet_taggedTemplateLiteral(["fudge spork"])))) < 3 * MPA && !(0,dist.get)("_fudgeSporkUsed")) (0,external_kolmafia_.eat)(1, (0,dist.$item)(diet_templateObject62 || (diet_templateObject62 = diet_taggedTemplateLiteral(["fudge spork"]))));
    eatSafe(1, (0,dist.$item)(diet_templateObject63 || (diet_templateObject63 = diet_taggedTemplateLiteral(["jumping horseradish"]))));
  }

  while ((0,external_kolmafia_.myInebriety)() < (0,external_kolmafia_.inebrietyLimit)()) {
    drinkSafe(1, (0,dist.$item)(diet_templateObject64 || (diet_templateObject64 = diet_taggedTemplateLiteral(["ambitious turkey"]))));
  }
}
...
function freeFightMood() {
  ...
  mood.potion((0,dist.$item)(mood_templateObject35 || (mood_templateObject35 = mood_taggedTemplateLiteral(["white candy heart"]))), 30); // FIXME: Figure out what's actually good!

  if (!(0,dist.have)((0,dist.$effect)(mood_templateObject36 || (mood_templateObject36 = mood_taggedTemplateLiteral(["Frosty"])))) && (0,external_kolmafia_.mallPrice)((0,dist.$item)(mood_templateObject37 || (mood_templateObject37 = mood_taggedTemplateLiteral(["frost flower"])))) < 70000) {
    if (!(0,dist.have)((0,dist.$item)(mood_templateObject38 || (mood_templateObject38 = mood_taggedTemplateLiteral(["frost flower"]))))) (0,external_kolmafia_.buy)((0,dist.$item)(mood_templateObject39 || (mood_templateObject39 = mood_taggedTemplateLiteral(["frost flower"]))));
    (0,external_kolmafia_.use)((0,dist.$item)(mood_templateObject40 || (mood_templateObject40 = mood_taggedTemplateLiteral(["frost flower"]))));
  }

  var goodSongs = (0,dist.$skills)(mood_templateObject41 || (mood_templateObject41 = mood_taggedTemplateLiteral(["Chorale of Companionship, The Ballad of Richie Thingfinder, Ur-Kel's Aria of Annoyance, The Polka of Plenty"])));
  ...
  for (var _i = 0, _Object$keys = Object.keys((0,external_kolmafia_.myEffects)()); _i < _Object$keys.length; _i++) {
    ...
    if (skill["class"] === (0,dist.$class)(mood_templateObject42 || (mood_templateObject42 = mood_taggedTemplateLiteral(["Accordion Thief"]))) && skill.buff && !goodSongs.includes(skill)) {
      (0,external_kolmafia_.cliExecute)("shrug ".concat(effectName));
    }
  }

  mood.potion((0,dist.$item)(mood_templateObject43 || (mood_templateObject43 = mood_taggedTemplateLiteral(["recording of Chorale of Companionship"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject44 || (mood_templateObject44 = mood_taggedTemplateLiteral(["recording of The Ballad of Richie Thingfinder"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject45 || (mood_templateObject45 = mood_taggedTemplateLiteral(["pink candy heart"]))), 300);
  mood.potion((0,dist.$item)(mood_templateObject46 || (mood_templateObject46 = mood_taggedTemplateLiteral(["resolution: be luckier"]))), 120);
  mood.potion((0,dist.$item)(mood_templateObject47 || (mood_templateObject47 = mood_taggedTemplateLiteral(["Meat-inflating powder"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject48 || (mood_templateObject48 = mood_taggedTemplateLiteral(["Polka Pop"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject49 || (mood_templateObject49 = mood_taggedTemplateLiteral(["resolution: be happier"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject50 || (mood_templateObject50 = mood_taggedTemplateLiteral(["blue snowcone"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject51 || (mood_templateObject51 = mood_taggedTemplateLiteral(["eagle feather"]))), 500);
  mood.potion((0,dist.$item)(mood_templateObject52 || (mood_templateObject52 = mood_taggedTemplateLiteral(["cyclops eyedrops"]))), 500);
  ...
  if ((0,dist.have)((0,dist.$item)(mood_templateObject53 || (mood_templateObject53 = mood_taggedTemplateLiteral(["redwood rain stick"])))) && !(0,dist.get)("_redwoodRainStickUsed")) {
    (0,external_kolmafia_.use)((0,dist.$item)(mood_templateObject54 || (mood_templateObject54 = mood_taggedTemplateLiteral(["redwood rain stick"]))));
  }

  var beachHeadsUsed = (0,dist.get)("_beachHeadsUsed");

  if ((0,dist.have)((0,dist.$item)(mood_templateObject55 || (mood_templateObject55 = mood_taggedTemplateLiteral(["Beach Comb"])))) && !beachHeadsUsed.toString().split(",").includes("10")) {
    mood.effect((0,dist.$effect)(mood_templateObject56 || (mood_templateObject56 = mood_taggedTemplateLiteral(["Do I Know You From Somewhere?"]))));
  }
...
function freeFightOutfit() {
  ...
  var compiledRequirements = Requirement.merge([].concat(outfit_toConsumableArray(requirements), [new Requirement((0,external_kolmafia_.myFamiliar)() === (0,dist.$familiar)(outfit_templateObject || (outfit_templateObject = outfit_taggedTemplateLiteral(["Pocket Professor"]))) ? ["Familiar Experience"] : ["Familiar Weight"], {
    bonusEquip: new Map([[(0,dist.$item)(outfit_templateObject2 || (outfit_templateObject2 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(outfit_templateObject3 || (outfit_templateObject3 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(outfit_templateObject4 || (outfit_templateObject4 = outfit_taggedTemplateLiteral(["pantogram pants"]))), 100], [(0,dist.$item)(outfit_templateObject5 || (outfit_templateObject5 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180]])
  })]));
...
function meatOutfit(embezzlerUp) {
  ...
  if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) {
    forceEquip.push((0,dist.$item)(outfit_templateObject6 || (outfit_templateObject6 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))));
  } else if (!embezzlerUp) {
    if ((0,dist.getKramcoWandererChance)() > 0.05 && (0,dist.have)((0,dist.$item)(outfit_templateObject7 || (outfit_templateObject7 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      forceEquip.push((0,dist.$item)(outfit_templateObject8 || (outfit_templateObject8 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
    } // TODO: Fix pointer finger ring construction.


    if ((0,external_kolmafia_.myClass)() != (0,dist.$class)(outfit_templateObject9 || (outfit_templateObject9 = outfit_taggedTemplateLiteral(["Seal Clubber"])))) {
      if ((0,dist.have)((0,dist.$item)(outfit_templateObject10 || (outfit_templateObject10 = outfit_taggedTemplateLiteral(["haiku katana"]))))) {
        forceEquip.push((0,dist.$item)(outfit_templateObject11 || (outfit_templateObject11 = outfit_taggedTemplateLiteral(["haiku katana"]))));
      } else if ((0,dist.have)((0,dist.$item)(outfit_templateObject12 || (outfit_templateObject12 = outfit_taggedTemplateLiteral(["unwrapped retro superhero cape"]))))) {
        if (!(0,dist.have)((0,dist.$item)(outfit_templateObject13 || (outfit_templateObject13 = outfit_taggedTemplateLiteral(["ice nine"]))))) (0,external_kolmafia_.retrieveItem)((0,dist.$item)(outfit_templateObject14 || (outfit_templateObject14 = outfit_taggedTemplateLiteral(["ice nine"]))));
        forceEquip.push((0,dist.$item)(outfit_templateObject15 || (outfit_templateObject15 = outfit_taggedTemplateLiteral(["ice nine"]))));
      }
    }

    if ((0,dist.have)((0,dist.$item)(outfit_templateObject16 || (outfit_templateObject16 = outfit_taggedTemplateLiteral(["protonic accelerator pack"])))) && (0,dist.get)("questPAGhost") === "unstarted" && (0,dist.get)("nextParanormalActivity") <= (0,external_kolmafia_.totalTurnsPlayed)() && !forceEquip.includes((0,dist.$item)(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["ice nine"]))))) {
      forceEquip.push((0,dist.$item)(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));
    }

    forceEquip.push((0,dist.$item)(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["mafia pointer finger ring"]))));
  }
...
var secondChainMacro = function secondChainMacro() {
  return combat.Macro.if_("monstername Knob Goblin Embezzler", combat.Macro.if_("!hasskill Lecture on Relativity", combat.Macro.trySkill("Meteor Shower")).trySkill("Lecture on Relativity").meatKill()).abort();
};

var embezzlerMacro = function embezzlerMacro() {
  return combat.Macro.if_("monstername Knob Goblin Embezzler", combat.Macro.if_("snarfblat 186", combat.Macro.item((0,dist.$item)(fights_templateObject5 || (fights_templateObject5 = fights_taggedTemplateLiteral(["green taffy"]))))).externalIf((0,dist.get)("_sourceTerminalDigitizeMonster") !== (0,dist.$monster)(fights_templateObject6 || (fights_templateObject6 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))), combat.Macro.trySkill("Digitize")).externalIf((0,dist.get)("spookyPuttyCopiesMade") < 5, combat.Macro.tryItem((0,dist.$item)(fights_templateObject7 || (fights_templateObject7 = fights_taggedTemplateLiteral(["Spooky Putty sheet"]))))).externalIf(!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject8 || (fights_templateObject8 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))), combat.Macro.tryItem((0,dist.$item)(fights_templateObject9 || (fights_templateObject9 = fights_taggedTemplateLiteral(["4-d camera"]))))).meatKill()).abort();
};

var embezzlerSources = [new EmbezzlerFight(function () {
  return (0,dist.get)("_sourceTerminalDigitizeMonster") === (0,dist.$monster)(fights_templateObject10 || (fights_templateObject10 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,external_kolmafia_.getCounters)("Digitize Monster", 0, 0).trim() !== "";
}, function () {
  return dist.SourceTerminal.have() && (0,dist.get)("_sourceTerminalDigitizeUses") === 0 ? 1 : 0;
}, function (location) {
  (0,external_kolmafia_.adv1)(location);
}), new EmbezzlerFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject11 || (fights_templateObject11 = fights_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject12 || (fights_templateObject12 = fights_taggedTemplateLiteral(["Clan VIP Lounge key"])))) && !(0,dist.get)("_photocopyUsed") ? 1 : 0;
}, function () {
  faxEmbezzler();
  (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject13 || (fights_templateObject13 = fights_taggedTemplateLiteral(["photocopied monster"]))));
}), new EmbezzlerFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject14 || (fights_templateObject14 = fights_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(fights_templateObject15 || (fights_templateObject15 = fights_taggedTemplateLiteral(["Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject16 || (fights_templateObject16 = fights_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"])))) && (0,external_canadv_ash_namespaceObject.canAdv)((0,dist.$location)(fights_templateObject17 || (fights_templateObject17 = fights_taggedTemplateLiteral(["Knob Treasury"]))), true) && !(0,dist.get)("_freePillKeeperUsed") ? 1 : 0;
}, function () {
  (0,external_kolmafia_.cliExecute)("pillkeeper semirare");
  (0,external_kolmafia_.adv1)((0,dist.$location)(fights_templateObject18 || (fights_templateObject18 = fights_taggedTemplateLiteral(["Knob Treasury"]))));
}), new EmbezzlerFight(function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(fights_templateObject19 || (fights_templateObject19 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  return dist.ChateauMantegna.have() && !dist.ChateauMantegna.paintingFought() && dist.ChateauMantegna.paintingMonster() === (0,dist.$monster)(fights_templateObject20 || (fights_templateObject20 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) ? 1 : 0;
}, function () {
  return dist.ChateauMantegna.fightPainting();
}), new EmbezzlerFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject21 || (fights_templateObject21 = fights_taggedTemplateLiteral(["Spooky putty monster"])))) && (0,dist.get)("spookyPuttyMonster") === (0,dist.$monster)(fights_templateObject22 || (fights_templateObject22 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])));
}, function () {
  if ((0,dist.have)((0,dist.$item)(fights_templateObject23 || (fights_templateObject23 = fights_taggedTemplateLiteral(["Spooky putty sheet"]))))) {
    return 5 - (0,dist.get)("spookyPuttyCopiesMade");
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject24 || (fights_templateObject24 = fights_taggedTemplateLiteral(["Spooky putty monster"])))) && (0,dist.get)("spookyPuttyMonster") === (0,dist.$monster)(fights_templateObject25 || (fights_templateObject25 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"])))) {
    return 6 - (0,dist.get)("spookyPuttyCopiesMade");
  }

  return 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject26 || (fights_templateObject26 = fights_taggedTemplateLiteral(["Spooky putty monster"]))));
}), new EmbezzlerFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject27 || (fights_templateObject27 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(fights_templateObject28 || (fights_templateObject28 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject29 || (fights_templateObject29 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && (0,dist.get)("cameraMonster") === (0,dist.$monster)(fights_templateObject30 || (fights_templateObject30 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_cameraUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject31 || (fights_templateObject31 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))));
}), new EmbezzlerFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject32 || (fights_templateObject32 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(fights_templateObject33 || (fights_templateObject33 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject34 || (fights_templateObject34 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(fights_templateObject35 || (fights_templateObject35 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject36 || (fights_templateObject36 = fights_taggedTemplateLiteral(["envyfish egg"]))));
}), new EmbezzlerFight(function () {
  return (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(fights_templateObject37 || (fights_templateObject37 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && (0,dist.have)((0,dist.$item)(fights_templateObject38 || (fights_templateObject38 = fights_taggedTemplateLiteral(["backup camera"])))) && (0,dist.get)("_backUpUses") < 11;
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject39 || (fights_templateObject39 = fights_taggedTemplateLiteral(["backup camera"])))) ? 11 - (0,dist.get)("_backUpUses") : 0;
}, function (location) {
  var realLocation = location.combatPercent >= 100 ? location : (0,dist.$location)(fights_templateObject40 || (fights_templateObject40 = fights_taggedTemplateLiteral(["Noob Cave"])));
  (0,dist.adventureMacro)(realLocation, combat.Macro.if_("!monstername Knob Goblin Embezzler", combat.Macro.skill("Back-Up to Your Last Enemy")).step(embezzlerMacro()));
}, [new Requirement([], {
  forceEquip: (0,dist.$items)(fights_templateObject41 || (fights_templateObject41 = fights_taggedTemplateLiteral(["backup camera"]))),
  bonusEquip: new Map([[(0,dist.$item)(fights_templateObject42 || (fights_templateObject42 = fights_taggedTemplateLiteral(["backup camera"]))), 5000]])
})], true), new EmbezzlerFight(function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(fights_templateObject43 || (fights_templateObject43 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false) ? 1 : 0;
}, function () {}), new EmbezzlerFight(function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(fights_templateObject44 || (fights_templateObject44 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false) ? 1 : 0;
}, function () {})];
...
function embezzlerSetup() {
  ...
  withStash((0,dist.$items)(fights_templateObject49 || (fights_templateObject49 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))), function () {
    if ((0,dist.have)((0,dist.$item)(fights_templateObject50 || (fights_templateObject50 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject51 || (fights_templateObject51 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))));
    }
  });
  if ((0,dist.have)((0,dist.$item)(fights_templateObject52 || (fights_templateObject52 = fights_taggedTemplateLiteral(["license to chill"])))) && !(0,dist.get)("_licenseToChillUsed")) (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject53 || (fights_templateObject53 = fights_taggedTemplateLiteral(["license to chill"]))));
  if (dist.SourceTerminal.have()) dist.SourceTerminal.educate([(0,dist.$skill)(fights_templateObject54 || (fights_templateObject54 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(fights_templateObject55 || (fights_templateObject55 = fights_taggedTemplateLiteral(["Digitize"])))]);

  if (!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject56 || (fights_templateObject56 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))))) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject57 || (fights_templateObject57 = fights_taggedTemplateLiteral(["4-d camera"]))));
  }
}
...
function getEmbezzlerFight() {
  ...
  if (potentials && (0,dist.get)("_genieFightsUsed") < 3 && (0,external_kolmafia_.userConfirm)("Garbo has detected you have potential ways to copy an Embezzler, but no way to start a fight with one. Should we wish for an Embezzler?")) {
    return new EmbezzlerFight(function () {
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject58 || (fights_templateObject58 = fights_taggedTemplateLiteral(["pocket wish"]))));
...
function startDigitize() {
  if ((0,external_kolmafia_.getCounters)("Digitize Monster", 0, 100).trim() === "" && (0,dist.get)("_sourceTerminalDigitizeUses") !== 0) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject59 || (fights_templateObject59 = fights_taggedTemplateLiteral(["Louder than Bomb"]))));
    (0,dist.adventureMacro)((0,dist.$location)(fights_templateObject60 || (fights_templateObject60 = fights_taggedTemplateLiteral(["Noob Cave"]))), combat.Macro.tryItem((0,dist.$item)(fights_templateObject61 || (fights_templateObject61 = fights_taggedTemplateLiteral(["Louder than Bomb"])))));
  }
}
...
function dailyFights() {
  if (embezzlerSources.some(function (source) {
    ...
    withStash((0,dist.$items)(fights_templateObject62 || (fights_templateObject62 = fights_taggedTemplateLiteral(["Spooky putty sheet"]))), function () {
      ...
      if ((0,dist.have)((0,dist.$familiar)(fights_templateObject63 || (fights_templateObject63 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false)) {
        var fightSource = getEmbezzlerFight();
        if (!fightSource) return;
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(fights_templateObject64 || (fights_templateObject64 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
        meatOutfit(true, [].concat(fights_toConsumableArray(fightSource.requirements), [new Requirement([], {
          forceEquip: (0,dist.$items)(fights_templateObject65 || (fights_templateObject65 = fights_taggedTemplateLiteral(["Pocket Professor memory chip"])))
        })]));
      ...
      if ((0,dist.have)((0,dist.$familiar)(fights_templateObject66 || (fights_templateObject66 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false)) {
      ...
      while (nextFight !== null) {
        if ((0,dist.have)((0,dist.$skill)(fights_templateObject69 || (fights_templateObject69 = fights_taggedTemplateLiteral(["musk of the moose"])))) && !(0,dist.have)((0,dist.$effect)(fights_templateObject70 || (fights_templateObject70 = fights_taggedTemplateLiteral(["musk of the moose"]))))) (0,external_kolmafia_.useSkill)((0,dist.$skill)(fights_templateObject71 || (fights_templateObject71 = fights_taggedTemplateLiteral(["musk of the moose"]))));
        (0,combat.withMacro)(embezzlerMacro(), function () {
          if (nextFight) {
            (0,external_kolmafia_.useFamiliar)(meatFamiliar());

            if (nextFight.draggable && !(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || (0,dist.$items)(fights_templateObject72 || (fights_templateObject72 = fights_taggedTemplateLiteral(["aerated diving helmet, crappy mer-kin mask, Mer-kin gladiator mask, Mer-kin scholar mask, old SCUBA tank, The Crown of Ed the Undying"]))).some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || (0,dist.$items)(fights_templateObject73 || (fights_templateObject73 = fights_taggedTemplateLiteral(["little bitty bathysphere, das boot"]))).some(dist.have)) && ((0,dist.have)((0,dist.$effect)(fights_templateObject74 || (fights_templateObject74 = fights_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(fights_templateObject75 || (fights_templateObject75 = fights_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(fights_templateObject76 || (fights_templateObject76 = fights_taggedTemplateLiteral(["envyfish egg"]))))) {
              (0,external_kolmafia_.setLocation)((0,dist.$location)(fights_templateObject77 || (fights_templateObject77 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
              ...
              (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject78 || (fights_templateObject78 = fights_taggedTemplateLiteral(["pulled green taffy"]))));
              if (!(0,dist.have)((0,dist.$effect)(fights_templateObject79 || (fights_templateObject79 = fights_taggedTemplateLiteral(["Fishy"]))))) (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject80 || (fights_templateObject80 = fights_taggedTemplateLiteral(["fishy pipe"]))));
              nextFight.run((0,dist.$location)(fights_templateObject81 || (fights_templateObject81 = fights_taggedTemplateLiteral(["The Briny Deeps"]))));
            } else if (nextFight.draggable) {
              var _location = prepWandererZone();

              (0,external_kolmafia_.setLocation)(_location);
              meatOutfit(true, nextFight.requirements);
              nextFight.run(_location);
            } else {
              (0,external_kolmafia_.setLocation)((0,dist.$location)(fights_templateObject82 || (fights_templateObject82 = fights_taggedTemplateLiteral(["Noob Cave"]))));
              meatOutfit(true, nextFight.requirements);
              nextFight.run((0,dist.$location)(fights_templateObject83 || (fights_templateObject83 = fights_taggedTemplateLiteral(["Noob Cave"]))));
            }
          }
        });
        startDigitize();
...
var pygmyMacro = combat.Macro.if_("monstername pygmy bowler", combat.Macro.trySkill("Snokebomb").item((0,dist.$item)(fights_templateObject84 || (fights_templateObject84 = fights_taggedTemplateLiteral(["Louder than Bomb"]))))).if_("monstername pygmy orderlies", combat.Macro.trySkill("Feel Hatred").item((0,dist.$item)(fights_templateObject85 || (fights_templateObject85 = fights_taggedTemplateLiteral(["divine champagne popper"]))))).if_("monstername pygmy janitor", combat.Macro.item((0,dist.$item)(fights_templateObject86 || (fights_templateObject86 = fights_taggedTemplateLiteral(["tennis ball"]))))).if_("monstername time-spinner prank", combat.Macro.meatKill()).abort();
var freeFightSources = [// Get a Fish Head from our robortender if available
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject87 || (fights_templateObject87 = fights_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) && (0,dist.have)((0,dist.$familiar)(fights_templateObject88 || (fights_templateObject88 = fights_taggedTemplateLiteral(["Robortender"])))) && !(0,dist.get)("_cargoPocketEmptied") && String((0,dist.get)("cargoPocketsEmptied", "")).indexOf("428") === -1;
}, function () {
  return (0,external_kolmafia_.cliExecute)("cargo monster Mob Penguin Thug");
}, {
  familiar: function familiar() {
    return (0,dist.$familiar)(fights_templateObject89 || (fights_templateObject89 = fights_taggedTemplateLiteral(["Robortender"])));
  }
}), new FreeFight(function () {
  ...
  var haveEldritchEssence = (0,dist.have)((0,dist.$item)(_templateObject90 || (_templateObject90 = fights_taggedTemplateLiteral(["eldritch essence"]))));
  ...
  return (0,dist.have)((0,dist.$skill)(_templateObject91 || (_templateObject91 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"])))) && !(0,dist.get)("_eldritchHorrorEvoked");
}, function () {
  return (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject92 || (_templateObject92 = fights_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
}), new FreeFight(function () {
  return clamp(3 - (0,dist.get)("_lynyrdSnareUses"), 0, 3);
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject93 || (_templateObject93 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject94 || (_templateObject94 = fights_taggedTemplateLiteral(["lynyrd snare"]))));
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject95 || (_templateObject95 = fights_taggedTemplateLiteral(["[glitch season reward name]"])))) && !(0,dist.get)("_glitchMonsterFights");
}, function () {
...
new FreeFight(function () {
  var maxSeals = (0,dist.have)((0,dist.$item)(_templateObject96 || (_templateObject96 = fights_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) ? 10 : 5;
  var maxSealsAvailable = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? maxSeals : Math.min(maxSeals, (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject97 || (_templateObject97 = fights_taggedTemplateLiteral(["seal-blubber candle"])))));
  return (0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject98 || (_templateObject98 = fights_taggedTemplateLiteral(["Seal Clubber"]))) ? Math.max(maxSealsAvailable - (0,dist.get)("_sealsSummoned"), 0) : 0;
}, function () {
  var figurine = (0,dist.get)("lastGuildStoreOpen") === (0,external_kolmafia_.myAscensions)() ? (0,dist.$item)(_templateObject99 || (_templateObject99 = fights_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))) : (0,dist.$item)(_templateObject100 || (_templateObject100 = fights_taggedTemplateLiteral(["figurine of an ancient seal"])));
  (0,external_kolmafia_.retrieveItem)(1, figurine);
  (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject101 || (_templateObject101 = fights_taggedTemplateLiteral(["seal-blubber candle"]))));
  ...
  return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject102 || (_templateObject102 = fights_taggedTemplateLiteral(["BRICKO ooze"]))));
}, {
  cost: function cost() {
    return (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject103 || (_templateObject103 = fights_taggedTemplateLiteral(["BRICKO eye brick"])))) + 2 * (0,external_kolmafia_.mallPrice)((0,dist.$item)(_templateObject104 || (_templateObject104 = fights_taggedTemplateLiteral(["BRICKO brick"]))));
  }
}), //Initial 9 Pygmy fights
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" ? clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9) : 0;
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject105 || (_templateObject105 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject106 || (_templateObject106 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)(clamp(9 - (0,dist.get)("_drunkPygmyBanishes"), 0, 9), (0,dist.$item)(_templateObject107 || (_templateObject107 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject108 || (_templateObject108 = fights_taggedTemplateLiteral(["Louder than Bomb"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject109 || (_templateObject109 = fights_taggedTemplateLiteral(["tennis ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject110 || (_templateObject110 = fights_taggedTemplateLiteral(["divine champagne popper"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject111 || (_templateObject111 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
...
new FreeFight(function () {
  ...
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject112 || (_templateObject112 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject113 || (_templateObject113 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject114 || (_templateObject114 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject115 || (_templateObject115 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject116 || (_templateObject116 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
...
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("_drunkPygmyBanishes") === 10 && !(0,dist.have)((0,dist.$item)(_templateObject117 || (_templateObject117 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
}, function () {
  (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject118 || (_templateObject118 = fights_taggedTemplateLiteral(["bowling ball"])))), (0,dist.$item)(_templateObject119 || (_templateObject119 = fights_taggedTemplateLiteral(["bowling ball"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject120 || (_templateObject120 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject121 || (_templateObject121 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
}), //11th+ pygmy fight if we have a saber- saber friends
new FreeFight(function () {
  var rightTime = (0,dist.have)((0,dist.$item)(_templateObject122 || (_templateObject122 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) && (0,dist.get)("_drunkPygmyBanishes") >= 10;
  var saberedMonster = (0,dist.get)("_saberForceMonster");
  var wrongPygmySabered = saberedMonster && (0,dist.$monsters)(_templateObject123 || (_templateObject123 = fights_taggedTemplateLiteral(["pygmy orderlies, pygmy bowler, pygmy janitor"]))).includes(saberedMonster);
  var drunksCanAppear = (0,dist.get)("_drunkPygmyBanishes") == 10 || saberedMonster === (0,dist.$monster)(_templateObject124 || (_templateObject124 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_saberForceMonsterCount");
  var remainingSaberPygmies = (saberedMonster === (0,dist.$monster)(_templateObject125 || (_templateObject125 = fights_taggedTemplateLiteral(["drunk pygmy"]))) ? (0,dist.get)("_saberForceMonsterCount") : 0) + 2 * clamp(5 - (0,dist.get)("_saberForceUses"), 0, 5);
  ...
  if (((0,dist.get)("_saberForceMonster") !== (0,dist.$monster)(_templateObject126 || (_templateObject126 = fights_taggedTemplateLiteral(["drunk pygmy"]))) || (0,dist.get)("_saberForceMonsterCount") === 1) && (0,dist.get)("_saberForceUses") < 5) {
    ...
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject132 || (_templateObject132 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
    (0,dist.adventureMacro)((0,dist.$location)(_templateObject133 || (_templateObject133 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), pygmyMacro);
  }
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject134 || (_templateObject134 = fights_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))
    })];
  }
}), //Finally, saber or not, if we have a drunk pygmy in our crystal ball, let it out.
new FreeFight(function () {
  return (0,dist.get)("questL11Worship") !== "unstarted" && (0,dist.get)("crystalBallMonster") === (0,dist.$monster)(_templateObject135 || (_templateObject135 = fights_taggedTemplateLiteral(["drunk pygmy"]))) && (0,dist.get)("_drunkPygmyBanishes") >= 11;
}, function () {
  ...
  (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject138 || (_templateObject138 = fights_taggedTemplateLiteral(["Bowl of Scorpions"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject139 || (_templateObject139 = fights_taggedTemplateLiteral(["The Hidden Bowling Alley"]))), combat.Macro.abort());
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject140 || (_templateObject140 = fights_taggedTemplateLiteral(["miniature crystal ball"]))).filter(function (item) {
        return (0,dist.have)(item);
      })
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject141 || (_templateObject141 = fights_taggedTemplateLiteral(["time-spinner"])))) && (0,dist.$location)(_templateObject142 || (_templateObject142 = fights_taggedTemplateLiteral(["the hidden bowling alley"]))).combatQueue.includes("drunk pygmy") && (0,dist.get)("_timeSpinnerMinutesUsed") < 8;
}, function () {
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(_templateObject143 || (_templateObject143 = fights_taggedTemplateLiteral(["bowl of scorpions"]))));
  combat.Macro.trySkill("Extract").trySkill("Sing Along").setAutoAttack;
  (0,external_kolmafia_.visitUrl)("inv_use.php?whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(_templateObject144 || (_templateObject144 = fights_taggedTemplateLiteral(["time-spinner"]))))));
  (0,external_kolmafia_.runChoice)(1);
  (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=1196&monid=".concat((0,dist.$monster)(_templateObject145 || (_templateObject145 = fights_taggedTemplateLiteral(["drunk pygmy"]))).id, "&option=1"));
}), new FreeFight(function () {
  return (0,dist.get)("_sausageFights") === 0 && (0,dist.have)((0,dist.$item)(_templateObject146 || (_templateObject146 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
}, function () {
  return (0,external_kolmafia_.adv1)(prepWandererZone(), -1, "");
}, {
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject147 || (_templateObject147 = fights_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.get)("questL11Ron") === "finished" ? 5 - (0,dist.get)("_glarkCableUses") : 0;
}, function () {
  (0,external_kolmafia_.retrieveItem)(5 - (0,dist.get)("_glarkCableUses"), (0,dist.$item)(_templateObject148 || (_templateObject148 = fights_taggedTemplateLiteral(["glark cable"]))));
  (0,dist.adventureMacro)((0,dist.$location)(_templateObject149 || (_templateObject149 = fights_taggedTemplateLiteral(["The Red Zeppelin"]))), combat.Macro.item((0,dist.$item)(_templateObject150 || (_templateObject150 = fights_taggedTemplateLiteral(["glark cable"])))));
}), // Mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject151 || (_templateObject151 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,dist.get)("_mushroomGardenFights") === 0;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject152 || (_templateObject152 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject153 || (_templateObject153 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject154 || (_templateObject154 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject155 || (_templateObject155 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject156 || (_templateObject156 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.trySkill("Portscan").meatKill());
  if ((0,dist.have)((0,dist.$item)(_templateObject157 || (_templateObject157 = fights_taggedTemplateLiteral(["Packet of tall grass seeds"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject158 || (_templateObject158 = fights_taggedTemplateLiteral(["Packet of tall grass seeds"]))));
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject159 || (_templateObject159 = fights_taggedTemplateLiteral(["Robortender"])))) ? (0,dist.$familiar)(_templateObject160 || (_templateObject160 = fights_taggedTemplateLiteral(["Robortender"]))) : null;
  }
}), // Portscan and mushroom garden
new FreeFight(function () {
  return ((0,dist.have)((0,dist.$item)(_templateObject161 || (_templateObject161 = fights_taggedTemplateLiteral(["packet of mushroom spores"])))) || (0,external_kolmafia_.getCampground)()["packet of mushroom spores"] !== undefined) && (0,external_kolmafia_.getCounters)("portscan.edu", 0, 0) === "portscan.edu" && (0,dist.have)((0,dist.$skill)(_templateObject162 || (_templateObject162 = fights_taggedTemplateLiteral(["Macrometeorite"])))) && (0,dist.get)("_macrometeoriteUses") < 10;
}, function () {
  if ((0,dist.have)((0,dist.$item)(_templateObject163 || (_templateObject163 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))))) (0,external_kolmafia_.use)((0,dist.$item)(_templateObject164 || (_templateObject164 = fights_taggedTemplateLiteral(["packet of mushroom spores"]))));

  if (dist.SourceTerminal.have()) {
    dist.SourceTerminal.educate([(0,dist.$skill)(_templateObject165 || (_templateObject165 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(_templateObject166 || (_templateObject166 = fights_taggedTemplateLiteral(["Portscan"])))]);
  }

  (0,dist.adventureMacro)((0,dist.$location)(_templateObject167 || (_templateObject167 = fights_taggedTemplateLiteral(["Your Mushroom Garden"]))), combat.Macro.if_("monstername government agent", combat.Macro.skill("Macrometeorite")).if_("monstername piranha plant", combat.Macro.trySkill("Portscan").meatKill()));
}), new FreeFight(function () {
  ...
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject169 || (_templateObject169 = fights_taggedTemplateLiteral(["God Lobster"])));
  }
}), new FreeFight(function () {
  ...
  familiar: function familiar() {
    return (0,dist.$familiar)(_templateObject172 || (_templateObject172 = fights_taggedTemplateLiteral(["Machine Elf"])));
  }
...
new FreeFight(function () {
  ...
  return dist.Witchess.fightPiece((0,dist.$monster)(_templateObject173 || (_templateObject173 = fights_taggedTemplateLiteral(["Witchess Bishop"]))));
}), new FreeFight(function () {
  ...
  requirements: function requirements() {
    return [new Requirement([], {
      forceEquip: (0,dist.have)((0,dist.$item)(_templateObject176 || (_templateObject176 = fights_taggedTemplateLiteral(["January's Garbage Tote"])))) ? (0,dist.$items)(_templateObject177 || (_templateObject177 = fights_taggedTemplateLiteral(["makeshift garbage shirt"]))) : []
    })];
  }
})];
var freeKillSources = [new FreeFight(function () {
  return !(0,dist.get)("_gingerbreadMobHitUsed") && (0,dist.have)((0,dist.$skill)(_templateObject178 || (_templateObject178 = fights_taggedTemplateLiteral(["Gingerbread Mob Hit"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Gingerbread Mob Hit"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject179 || (_templateObject179 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject180 || (_templateObject180 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? (0,dist.$familiar)(_templateObject181 || (_templateObject181 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"]))) : null;
  },
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {})];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$skill)(_templateObject182 || (_templateObject182 = fights_taggedTemplateLiteral(["Shattering Punch"])))) ? clamp(3 - (0,dist.get)("_shatteringPunchUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Shattering Punch"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject183 || (_templateObject183 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject184 || (_templateObject184 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? (0,dist.$familiar)(_templateObject185 || (_templateObject185 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"]))) : null;
  },
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {})];
  }
...
new FreeFight(function () {
  return !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject186 || (_templateObject186 = fights_taggedTemplateLiteral(["The Jokester's gun"]))));
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Fire the Jokester's Gun"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject187 || (_templateObject187 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject188 || (_templateObject188 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? (0,dist.$familiar)(_templateObject189 || (_templateObject189 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"]))) : null;
  },
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject190 || (_templateObject190 = fights_taggedTemplateLiteral(["The Jokester's Gun"])))
    })];
  }
}), // 22	3	0	0	Chest X-Ray	combat skill	must have a Lil' Doctor™ bag equipped
new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject191 || (_templateObject191 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? clamp(3 - (0,dist.get)("_chestXRayUsed"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").trySkill("Chest X-Ray"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject192 || (_templateObject192 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject193 || (_templateObject193 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? (0,dist.$familiar)(_templateObject194 || (_templateObject194 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"]))) : null;
  },
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {
      forceEquip: (0,dist.$items)(_templateObject195 || (_templateObject195 = fights_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    })];
  }
}), new FreeFight(function () {
  return (0,dist.have)((0,dist.$item)(_templateObject196 || (_templateObject196 = fights_taggedTemplateLiteral(["replica bat-oomerang"])))) ? clamp(3 - (0,dist.get)("_usedReplicaBatoomerang"), 0, 3) : 0;
}, function () {
  return (0,combat.withMacro)(combat.Macro.skill("Sing Along").item("replica bat-oomerang"), function () {
    return (0,external_kolmafia_.use)((0,dist.$item)(_templateObject197 || (_templateObject197 = fights_taggedTemplateLiteral(["drum machine"]))));
  });
}, {
  familiar: function familiar() {
    return (0,dist.have)((0,dist.$familiar)(_templateObject198 || (_templateObject198 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? (0,dist.$familiar)(_templateObject199 || (_templateObject199 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"]))) : null;
  },
  requirements: function requirements() {
    return [new Requirement(["100 Item Drop"], {})];
  }
...
function freeFights() {
  ...
  if (!(0,dist.have)((0,dist.$item)(_templateObject203 || (_templateObject203 = fights_taggedTemplateLiteral(["li'l ninja costume"])))) && (0,dist.have)((0,dist.$familiar)(_templateObject204 || (_templateObject204 = fights_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && !(0,dist.get)("_firedJokestersGun") && (0,dist.have)((0,dist.$item)(_templateObject205 || (_templateObject205 = fights_taggedTemplateLiteral(["The Jokester's gun"]))))) {
    freeFightMood().execute();
    freeFightOutfit([new Requirement([], {
      forceEquip: (0,dist.$items)(_templateObject206 || (_templateObject206 = fights_taggedTemplateLiteral(["The Jokester's gun"])))
    })]);
    ...
    if (lib_questStep("questL08Trapper") >= 2) {
      ...
      try {
        ...
        mapMonster((0,dist.$location)(_templateObject210 || (_templateObject210 = fights_taggedTemplateLiteral(["The Haiku Dungeon"]))), (0,dist.$monster)(_templateObject211 || (_templateObject211 = fights_taggedTemplateLiteral(["amateur ninja"]))));
      } finally {
...
function thesisReady() {
  return !(0,dist.get)("_thesisDelivered") && (0,dist.have)((0,dist.$familiar)(_templateObject215 || (_templateObject215 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && (0,dist.$familiar)(_templateObject216 || (_templateObject216 = fights_taggedTemplateLiteral(["Pocket Professor"]))).experience >= 400;
}
...
function deliverThesis() {
  ...
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject218 || (_templateObject218 = fights_taggedTemplateLiteral(["Pocket Professor"]))));
  freeFightMood().execute();
  ...
  (0,dist.adventureMacro)(thesisInNEP ? (0,dist.$location)(_templateObject224 || (_templateObject224 = fights_taggedTemplateLiteral(["The Neverending Party"]))) : (0,dist.$location)(_templateObject225 || (_templateObject225 = fights_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), combat.Macro.skill("Deliver your Thesis"));
}
...
function safeRestore() {
  ...
  if ((0,external_kolmafia_.myMp)() < 50 && (0,external_kolmafia_.myMaxmp)() > 50) {
    if (((0,dist.have)((0,dist.$item)(_templateObject226 || (_templateObject226 = fights_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(_templateObject227 || (_templateObject227 = fights_taggedTemplateLiteral(["sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject228 || (_templateObject228 = fights_taggedTemplateLiteral(["magical sausage"]))));
    }
...
function barfTurn() {
  ...
  if (!(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || (0,dist.$items)(src_templateObject13 || (src_templateObject13 = src_taggedTemplateLiteral(["aerated diving helmet, crappy mer-kin mask, Mer-kin gladiator mask, Mer-kin scholar mask, old SCUBA tank, The Crown of Ed the Undying"]))).some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || (0,dist.$items)(src_templateObject14 || (src_templateObject14 = src_taggedTemplateLiteral(["little bitty bathysphere, das boot"]))).some(dist.have)) && ((0,dist.have)((0,dist.$effect)(src_templateObject15 || (src_templateObject15 = src_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(src_templateObject16 || (src_templateObject16 = src_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(src_templateObject17 || (src_templateObject17 = src_taggedTemplateLiteral(["envyfish egg"])))) && embezzlerUp) {
  ...
  if ((0,dist.have)((0,dist.$item)(src_templateObject23 || (src_templateObject23 = src_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("_envyfishEggUsed")) {
    ...
    (0,dist.adventureMacroAuto)(location, combat.Macro.externalIf(underwater, combat.Macro.if_("monsterid ".concat((0,dist.$monster)(src_templateObject29 || (src_templateObject29 = src_taggedTemplateLiteral(["knob goblin embezzler"]))).id), combat.Macro.item("pulled green taffy"))).meatKill());
  }
...
function src_main() {
  ...
  var gardens = (0,dist.$items)(src_templateObject30 || (src_templateObject30 = src_taggedTemplateLiteral(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores"])));
  ...
  try {
    ...
    if ((0,dist.have)((0,dist.$item)(src_templateObject31 || (src_templateObject31 = src_taggedTemplateLiteral(["packet of tall grass seeds"])))) && (0,external_kolmafia_.myGardenType)() !== "grass") (0,external_kolmafia_.use)((0,dist.$item)(src_templateObject32 || (src_templateObject32 = src_taggedTemplateLiteral(["packet of tall grass seeds"]))));
    (0,external_kolmafia_.setAutoAttack)(0);
    ...
    withStash((0,dist.$items)(src_templateObject33 || (src_templateObject33 = src_taggedTemplateLiteral(["haiku katana, repaid diaper"]))), function () {
      // 0. diet stuff.
      ...
      (0,dist.setDefaultMaximizeOptions)({
        preventEquip: (0,dist.$items)(src_templateObject34 || (src_templateObject34 = src_taggedTemplateLiteral(["broken champagne bottle"])))
