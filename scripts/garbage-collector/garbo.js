...
var Macro = /*#__PURE__*/function (_LibramMacro) {
  ...
  _createClass(Macro, [{
    ...
    value: function meatKill() {
      ...
      return this.externalIf(shouldRedigitize(), Macro.if_("monstername ".concat((0,libram__WEBPACK_IMPORTED_MODULE_1__.get)("_sourceTerminalDigitizeMonster")), Macro.trySkill("Digitize"))).tryHaveSkill("Sing Along").externalIf(!(0,libram__WEBPACK_IMPORTED_MODULE_1__.have)((0,libram__WEBPACK_IMPORTED_MODULE_1__.$effect)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["On the Trail"])))), Macro.if_("monstername garbage tourist", Macro.trySkill("Transcendent Olfaction"))).externalIf((0,libram__WEBPACK_IMPORTED_MODULE_1__.get)("_gallapagosMonster") !== (0,libram__WEBPACK_IMPORTED_MODULE_1__.$monster)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["garbage tourist"]))), Macro.if_("monstername garbage tourist", Macro.trySkill("Gallapagosian Mating Call"))).externalIf((0,libram__WEBPACK_IMPORTED_MODULE_1__.get)("_latteMonster") !== (0,libram__WEBPACK_IMPORTED_MODULE_1__.$monster)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["garbage tourist"]))), Macro.if_("monstername garbage tourist", Macro.trySkill("Offer Latte to Opponent"))).externalIf((0,libram__WEBPACK_IMPORTED_MODULE_1__.get)("lastCopyableMonster") === (0,libram__WEBPACK_IMPORTED_MODULE_1__.$monster)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["garbage tourist"]))), Macro.if_("!monstername garbage tourist", Macro.trySkill("Feel Nostalgic"))).externalIf((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myFamiliar)() === (0,libram__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["Stocking Mimic"]))), Macro.skill("Curse of Weaksauce").while_("!pastround 10", Macro.item("seal tooth"))).externalIf(sealClubberSetup, Macro.trySkill("Furious Wallop").attack()).externalIf(opsSetup, Macro.skill("Throw Shield").attack()).externalIf(katanaSetup, Macro.skill("Summer Siesta").attack()).externalIf(capeSetup, Macro.skill("Precision Shot")).trySkill("Pocket Crumbs").if_("discobandit", Macro.trySkill("Disco Dance of Doom").trySkill("Disco Dance II: Electric Boogaloo").trySkill("Disco Dance 3: Back in the Habit")).trySkill("Curse of Weaksauce").attack().repeat();
    }
  }], [{
    key: "tryHaveSkill",
    value: function tryHaveSkill(skillOrName) {
...
var embezzlerSources = [new EmbezzlerFight("Digitize", function () {
  ...
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject62 || (fights_templateObject62 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))));
}), new EmbezzlerFight("Green Taffy", function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject63 || (fights_templateObject63 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(fights_templateObject64 || (fights_templateObject64 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed");
}, function () {
  return (0,dist.have)((0,dist.$item)(fights_templateObject65 || (fights_templateObject65 = fights_taggedTemplateLiteral(["envyfish egg"])))) && (0,dist.get)("envyfishMonster") === (0,dist.$monster)(fights_templateObject66 || (fights_templateObject66 = fights_taggedTemplateLiteral(["Knob Goblin Embezzler"]))) && !(0,dist.get)("_envyfishEggUsed") ? 1 : 0;
}, function () {
  return (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject67 || (fights_templateObject67 = fights_taggedTemplateLiteral(["envyfish egg"]))));
}), new EmbezzlerFight("Professor MeatChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(fights_templateObject68 || (fights_templateObject68 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_meatChain", false) ? 10 : 0;
}, function () {
  return;
}), new EmbezzlerFight("Professor WeightChain", function () {
  return false;
}, function () {
  return (0,dist.have)((0,dist.$familiar)(fights_templateObject69 || (fights_templateObject69 = fights_taggedTemplateLiteral(["Pocket Professor"])))) && !(0,dist.get)("_garbo_weightChain", false) ? 5 : 0;
}, function () {
  return;
})];
...
function embezzlerSetup() {
  ...
  safeRestore();
  if ((0,external_kolmafia_.mySpleenUse)() < (0,external_kolmafia_.spleenLimit)()) ensureEffect((0,dist.$effect)(fights_templateObject70 || (fights_templateObject70 = fights_taggedTemplateLiteral(["Eau d' Clochard"]))));

  if ((0,external_kolmafia_.mySpleenUse)() < (0,external_kolmafia_.spleenLimit)() && (0,dist.have)((0,dist.$item)(fights_templateObject71 || (fights_templateObject71 = fights_taggedTemplateLiteral(["body spradium"]))))) {
    ensureEffect((0,dist.$effect)(fights_templateObject72 || (fights_templateObject72 = fights_taggedTemplateLiteral(["Boxing Day Glow"]))));
  }

  freeFightMood().execute(50);
  withStash((0,dist.$items)(fights_templateObject73 || (fights_templateObject73 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))), function () {
    if ((0,dist.have)((0,dist.$item)(fights_templateObject74 || (fights_templateObject74 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject75 || (fights_templateObject75 = fights_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))));
    }
  });
  if ((0,dist.have)((0,dist.$item)(fights_templateObject76 || (fights_templateObject76 = fights_taggedTemplateLiteral(["License to Chill"])))) && !(0,dist.get)("_licenseToChillUsed")) (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject77 || (fights_templateObject77 = fights_taggedTemplateLiteral(["License to Chill"]))));
  bathroomFinance(embezzlerCount());
  if (dist.SourceTerminal.have()) dist.SourceTerminal.educate([(0,dist.$skill)(fights_templateObject78 || (fights_templateObject78 = fights_taggedTemplateLiteral(["Extract"]))), (0,dist.$skill)(fights_templateObject79 || (fights_templateObject79 = fights_taggedTemplateLiteral(["Digitize"])))]);

  if (!(0,dist.get)("_cameraUsed") && !(0,dist.have)((0,dist.$item)(fights_templateObject80 || (fights_templateObject80 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))))) {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject81 || (fights_templateObject81 = fights_taggedTemplateLiteral(["4-d camera"]))));
  } // Fix invalid copiers (caused by ascending or combat text-effects)


  if ((0,dist.have)((0,dist.$item)(fights_templateObject82 || (fights_templateObject82 = fights_taggedTemplateLiteral(["Spooky Putty monster"])))) && !(0,dist.get)("spookyPuttyMonster")) {
    // Visit the description to update the monster as it may be valid but not tracked correctly
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject83 || (fights_templateObject83 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))).descid), false, false);

    if (!(0,dist.get)("spookyPuttyMonster")) {
      // Still invalid, use it to turn back into the spooky putty sheet
      (0,external_kolmafia_.use)((0,dist.$item)(fights_templateObject84 || (fights_templateObject84 = fights_taggedTemplateLiteral(["Spooky Putty monster"]))));
    }
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject85 || (fights_templateObject85 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"])))) && !(0,dist.get)("rainDohMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject86 || (fights_templateObject86 = fights_taggedTemplateLiteral(["Rain-Doh box full of monster"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject87 || (fights_templateObject87 = fights_taggedTemplateLiteral(["shaking 4-d camera"])))) && !(0,dist.get)("cameraMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject88 || (fights_templateObject88 = fights_taggedTemplateLiteral(["shaking 4-d camera"]))).descid), false, false);
  }

  if ((0,dist.have)((0,dist.$item)(fights_templateObject89 || (fights_templateObject89 = fights_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("envyfishMonster")) {
    (0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat((0,dist.$item)(fights_templateObject90 || (fights_templateObject90 = fights_taggedTemplateLiteral(["envyfish egg"]))).descid), false, false);
  }
}
...
function getEmbezzlerFight() {
  ...
  if (potentials && (0,dist.get)("_genieFightsUsed") < 3 && (0,external_kolmafia_.userConfirm)("Garbo has detected you have potential ways to copy an Embezzler, but no way to start a fight with one. Should we wish for an Embezzler?")) {
    return new EmbezzlerFight("Pocket Wish", function () {
      ...
      (0,external_kolmafia_.retrieveItem)((0,dist.$item)(fights_templateObject91 || (fights_templateObject91 = fights_taggedTemplateLiteral(["pocket wish"]))));
...
function startDigitize() {
  if ((0,external_kolmafia_.getCounters)("Digitize Monster", 0, 100).trim() === "" && (0,dist.get)("_sourceTerminalDigitizeUses") !== 0) {
    do {
      ...
      (0,dist.adventureMacro)((0,dist.$location)(fights_templateObject95 || (fights_templateObject95 = fights_taggedTemplateLiteral(["Noob Cave"]))), run.macro);
    } while ((0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(fights_templateObject92 || (fights_templateObject92 = fights_taggedTemplateLiteral(["Government agent"]))));
  }
}

var witchessPieces = [{
  piece: (0,dist.$monster)(fights_templateObject96 || (fights_templateObject96 = fights_taggedTemplateLiteral(["Witchess Bishop"]))),
  drop: (0,dist.$item)(fights_templateObject97 || (fights_templateObject97 = fights_taggedTemplateLiteral(["Sacramento wine"])))
}, {
  piece: (0,dist.$monster)(fights_templateObject98 || (fights_templateObject98 = fights_taggedTemplateLiteral(["Witchess Knight"]))),
  drop: (0,dist.$item)(fights_templateObject99 || (fights_templateObject99 = fights_taggedTemplateLiteral(["jumping horseradish"])))
}, {
  piece: (0,dist.$monster)(fights_templateObject100 || (fights_templateObject100 = fights_taggedTemplateLiteral(["Witchess Pawn"]))),
  drop: (0,dist.$item)(fights_templateObject101 || (fights_templateObject101 = fights_taggedTemplateLiteral(["armored prawn"])))
}, {
  piece: (0,dist.$monster)(fights_templateObject102 || (fights_templateObject102 = fights_taggedTemplateLiteral(["Witchess Rook"]))),
...
function runDiet() {
  ...
  if ((0,external_kolmafia_.mySpleenUse)() === 0) {
    if (!(0,dist.have)((0,dist.$effect)(diet_templateObject23 || (diet_templateObject23 = diet_taggedTemplateLiteral(["Eau d' Clochard"]))))) {
      if (!(0,dist.have)((0,dist.$item)(diet_templateObject24 || (diet_templateObject24 = diet_taggedTemplateLiteral(["beggin' cologne"]))))) {
        var equilibriumPrice = (baseMeat * (0,external_kolmafia_.numericModifier)((0,dist.$effect)(diet_templateObject25 || (diet_templateObject25 = diet_taggedTemplateLiteral(["Eau d' Clochard"]))), "Meat") * (0,external_kolmafia_.numericModifier)((0,dist.$item)(diet_templateObject26 || (diet_templateObject26 = diet_taggedTemplateLiteral(["beggin' cologne"]))), "Effect Duration") + Math.min((0,external_kolmafia_.numericModifier)((0,dist.$item)(diet_templateObject27 || (diet_templateObject27 = diet_taggedTemplateLiteral(["beggin' cologne"]))), "Effect Duration"), embezzlerCount()) * 750) / 100 - valuePerSpleen(bestSpleenItem);
        if (equilibriumPrice > 0) (0,external_kolmafia_.buy)(1, (0,dist.$item)(diet_templateObject28 || (diet_templateObject28 = diet_taggedTemplateLiteral(["beggin' cologne"]))), equilibriumPrice);
      }

      if ((0,dist.have)((0,dist.$item)(diet_templateObject29 || (diet_templateObject29 = diet_taggedTemplateLiteral(["beggin' cologne"]))))) {
        (0,external_kolmafia_.chew)(1, (0,dist.$item)(diet_templateObject30 || (diet_templateObject30 = diet_taggedTemplateLiteral(["beggin' cologne"]))));
      }
    }

    if ((0,dist.have)((0,dist.$skill)(diet_templateObject31 || (diet_templateObject31 = diet_taggedTemplateLiteral(["Sweet Synthesis"]))))) ensureEffect((0,dist.$effect)(diet_templateObject32 || (diet_templateObject32 = diet_taggedTemplateLiteral(["Synthesis: Collection"]))));
    if ((0,dist.have)((0,dist.$item)(diet_templateObject33 || (diet_templateObject33 = diet_taggedTemplateLiteral(["body spradium"]))))) ensureEffect((0,dist.$effect)(diet_templateObject34 || (diet_templateObject34 = diet_taggedTemplateLiteral(["Boxing Day Glow"]))));
  }

  useIfUnused((0,dist.$item)(diet_templateObject35 || (diet_templateObject35 = diet_taggedTemplateLiteral(["fancy chocolate car"]))), (0,dist.get)("_chocolatesUsed") === 0, 2 * MPA);
  var loveChocolateCount = Math.max(3 - Math.floor(20000 / MPA) - (0,dist.get)("_loveChocolatesUsed"), 0);
  var loveChocolateEat = Math.min(loveChocolateCount, (0,external_kolmafia_.itemAmount)((0,dist.$item)(diet_templateObject36 || (diet_templateObject36 = diet_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"])))));
  (0,external_kolmafia_.use)(loveChocolateEat, (0,dist.$item)(diet_templateObject37 || (diet_templateObject37 = diet_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))));
  var choco = new Map([[(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject38 || (diet_templateObject38 = diet_taggedTemplateLiteral(["Seal Clubber"])))), (0,dist.$item)(diet_templateObject39 || (diet_templateObject39 = diet_taggedTemplateLiteral(["chocolate seal-clubbing club"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject40 || (diet_templateObject40 = diet_taggedTemplateLiteral(["Turtle Tamer"])))), (0,dist.$item)(diet_templateObject41 || (diet_templateObject41 = diet_taggedTemplateLiteral(["chocolate turtle totem"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject42 || (diet_templateObject42 = diet_taggedTemplateLiteral(["Pastamancer"])))), (0,dist.$item)(diet_templateObject43 || (diet_templateObject43 = diet_taggedTemplateLiteral(["chocolate pasta spoon"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject44 || (diet_templateObject44 = diet_taggedTemplateLiteral(["Sauceror"])))), (0,dist.$item)(diet_templateObject45 || (diet_templateObject45 = diet_taggedTemplateLiteral(["chocolate saucepan"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject46 || (diet_templateObject46 = diet_taggedTemplateLiteral(["Accordion Thief"])))), (0,dist.$item)(diet_templateObject47 || (diet_templateObject47 = diet_taggedTemplateLiteral(["chocolate stolen accordion"])))], [(0,external_kolmafia_.toInt)((0,dist.$class)(diet_templateObject48 || (diet_templateObject48 = diet_taggedTemplateLiteral(["Disco Bandit"])))), (0,dist.$item)(diet_templateObject49 || (diet_templateObject49 = diet_taggedTemplateLiteral(["chocolate disco ball"])))]]);
  ...
  if (choco.has((0,external_kolmafia_.toInt)((0,external_kolmafia_.myClass)())) && (0,dist.get)("_chocolatesUsed") < 3) {
    ...
    var item = choco.get((0,external_kolmafia_.toInt)((0,external_kolmafia_.myClass)())) || (0,dist.$item)(diet_templateObject50 || (diet_templateObject50 = diet_taggedTemplateLiteral(["none"])));
    var count = clamp(3 - used, 0, 3);
    (0,external_kolmafia_.use)(count, item);
  }

  useIfUnused((0,dist.$item)(diet_templateObject51 || (diet_templateObject51 = diet_taggedTemplateLiteral(["fancy chocolate sculpture"]))), (0,dist.get)("_chocolateSculpturesUsed") < 1, 5 * MPA + 5000);
  useIfUnused((0,dist.$item)(diet_templateObject52 || (diet_templateObject52 = diet_taggedTemplateLiteral(["essential tofu"]))), "_essentialTofuUsed", 5 * MPA);

  if (!(0,dist.get)("_etchedHourglassUsed") && (0,dist.have)((0,dist.$item)(diet_templateObject53 || (diet_templateObject53 = diet_taggedTemplateLiteral(["etched hourglass"]))))) {
    (0,external_kolmafia_.use)(1, (0,dist.$item)(diet_templateObject54 || (diet_templateObject54 = diet_taggedTemplateLiteral(["etched hourglass"]))));
  }

  if ((0,external_kolmafia_.getProperty)("_timesArrowUsed") !== "true" && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject55 || (diet_templateObject55 = diet_taggedTemplateLiteral(["time's arrow"])))) < 5 * MPA) {
    acquire(1, (0,dist.$item)(diet_templateObject56 || (diet_templateObject56 = diet_taggedTemplateLiteral(["time's arrow"]))), 5 * MPA);
    (0,external_kolmafia_.cliExecute)("csend 1 time's arrow to botticelli");
    (0,external_kolmafia_.setProperty)("_timesArrowUsed", "true");
  }

  if ((0,dist.have)((0,dist.$skill)(diet_templateObject57 || (diet_templateObject57 = diet_taggedTemplateLiteral(["Ancestral Recall"])))) && (0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject58 || (diet_templateObject58 = diet_taggedTemplateLiteral(["blue mana"])))) < 3 * MPA) {
    var casts = Math.max(10 - (0,dist.get)("_ancestralRecallCasts"), 0);
    acquire(casts, (0,dist.$item)(diet_templateObject59 || (diet_templateObject59 = diet_taggedTemplateLiteral(["blue mana"]))), 3 * MPA);
    (0,external_kolmafia_.useSkill)(casts, (0,dist.$skill)(diet_templateObject60 || (diet_templateObject60 = diet_taggedTemplateLiteral(["Ancestral Recall"]))));
  }

  if (globalOptions.ascending) useIfUnused((0,dist.$item)(diet_templateObject61 || (diet_templateObject61 = diet_taggedTemplateLiteral(["borrowed time"]))), "_borrowedTimeUsed", 5 * MPA);
  fillSomeSpleen();
  fillStomach();
  fillLiver();

  if (!(0,dist.get)("_distentionPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(diet_templateObject62 || (diet_templateObject62 = diet_taggedTemplateLiteral(["distention pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(diet_templateObject63 || (diet_templateObject63 = diet_taggedTemplateLiteral(["distention pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject64 || (diet_templateObject64 = diet_taggedTemplateLiteral(["distention pill"]))))) {
  ...
  if (!(0,dist.get)("_syntheticDogHairPillUsed") && 1 <= (0,external_kolmafia_.myInebriety)()) {
    if (!(0,dist.get)("garbo_skipPillCheck", false) && !(0,dist.have)((0,dist.$item)(diet_templateObject65 || (diet_templateObject65 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1)) {
    ...
    if (((0,dist.have)((0,dist.$item)(diet_templateObject66 || (diet_templateObject66 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))), 1) || !(0,dist.get)("garbo_skipPillCheck", false)) && !(0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject67 || (diet_templateObject67 = diet_taggedTemplateLiteral(["synthetic dog hair pill"]))))) {
  ...
  acquire(mojoFilterCount, (0,dist.$item)(diet_templateObject68 || (diet_templateObject68 = diet_taggedTemplateLiteral(["mojo filter"]))), valuePerSpleen(bestSpleenItem), false);

  if ((0,dist.have)((0,dist.$item)(diet_templateObject69 || (diet_templateObject69 = diet_taggedTemplateLiteral(["mojo filter"]))))) {
    (0,external_kolmafia_.use)(Math.min(mojoFilterCount, (0,external_kolmafia_.availableAmount)((0,dist.$item)(diet_templateObject70 || (diet_templateObject70 = diet_taggedTemplateLiteral(["mojo filter"]))))), (0,dist.$item)(diet_templateObject71 || (diet_templateObject71 = diet_taggedTemplateLiteral(["mojo filter"]))));
    fillSomeSpleen();
  }

  while ((0,external_kolmafia_.myFullness)() < (0,external_kolmafia_.fullnessLimit)()) {
    if ((0,external_kolmafia_.mallPrice)((0,dist.$item)(diet_templateObject72 || (diet_templateObject72 = diet_taggedTemplateLiteral(["fudge spork"])))) < 3 * MPA && !(0,dist.get)("_fudgeSporkUsed")) (0,external_kolmafia_.eat)(1, (0,dist.$item)(diet_templateObject73 || (diet_templateObject73 = diet_taggedTemplateLiteral(["fudge spork"]))));
    mindMayo(Mayo.zapine, 1);
    eatSafe(1, (0,dist.$item)(diet_templateObject74 || (diet_templateObject74 = diet_taggedTemplateLiteral(["jumping horseradish"]))));
  }

  while ((0,external_kolmafia_.myInebriety)() < (0,external_kolmafia_.inebrietyLimit)()) {
    drinkSafe(1, (0,dist.$item)(diet_templateObject75 || (diet_templateObject75 = diet_taggedTemplateLiteral(["Ambitious Turkey"]))));
  }
}
...
var Mayo = {
  nex: (0,dist.$item)(diet_templateObject79 || (diet_templateObject79 = diet_taggedTemplateLiteral(["Mayonex"]))),
  diol: (0,dist.$item)(diet_templateObject80 || (diet_templateObject80 = diet_taggedTemplateLiteral(["Mayodiol"]))),
  zapine: (0,dist.$item)(diet_templateObject81 || (diet_templateObject81 = diet_taggedTemplateLiteral(["Mayozapine"]))),
  flex: (0,dist.$item)(diet_templateObject82 || (diet_templateObject82 = diet_taggedTemplateLiteral(["Mayoflex"])))
};

function mindMayo(mayo, quantity) {
  if ((0,external_kolmafia_.getWorkshed)() !== (0,dist.$item)(diet_templateObject83 || (diet_templateObject83 = diet_taggedTemplateLiteral(["portable Mayo Clinic"])))) return;
  ...
  if (!(0,dist.have)((0,dist.$item)(diet_templateObject84 || (diet_templateObject84 = diet_taggedTemplateLiteral(["Mayo Minder\u2122"]))))) (0,external_kolmafia_.buy)((0,dist.$item)(diet_templateObject85 || (diet_templateObject85 = diet_taggedTemplateLiteral(["Mayo Minder\u2122"]))));

  if ((0,dist.get)("mayoMinderSetting") !== mayo.name) {
    (0,property.withChoice)(1076, (0,external_kolmafia_.toInt)(mayo) - 8260, function () {
      return (0,external_kolmafia_.use)((0,dist.$item)(diet_templateObject86 || (diet_templateObject86 = diet_taggedTemplateLiteral(["Mayo Minder\u2122"]))));
    });
  }
}
...
function barfTurn() {
  ...
  if ((0,dist.have)((0,dist.$item)(src_templateObject14 || (src_templateObject14 = src_taggedTemplateLiteral(["latte lovers member's mug"])))) && (0,dist.get)("_latteRefillsUsed") < 3 && (0,dist.get)("_latteCopyUsed") && (0,dist.get)("latteUnlocks").includes("cajun") && (0,dist.get)("latteUnlocks").includes("rawhide")) {
    var latteIngredients = ["cajun", "rawhide", (0,dist.get)("latteUnlocks").includes("carrot") ? "carrot" : (0,external_kolmafia_.myPrimestat)() === (0,dist.$stat)(src_templateObject15 || (src_templateObject15 = src_taggedTemplateLiteral(["muscle"]))) ? "vanilla" : (0,external_kolmafia_.myPrimestat)() === (0,dist.$stat)(src_templateObject16 || (src_templateObject16 = src_taggedTemplateLiteral(["mysticality"]))) ? "pumpkin spice" : "cinnamon"].join(" ");
    (0,external_kolmafia_.cliExecute)("latte refill ".concat(latteIngredients));
  } // a. set up familiar
  ...
  var location = embezzlerUp ? prepWandererZone() : (0,dist.$location)(src_templateObject17 || (src_templateObject17 = src_taggedTemplateLiteral(["Barf Mountain"])));

  if (!(0,dist.get)("_envyfishEggUsed") && ((0,external_kolmafia_.booleanModifier)("Adventure Underwater") || waterBreathingEquipment.some(dist.have)) && ((0,external_kolmafia_.booleanModifier)("Underwater Familiar") || familiarWaterBreathingEquipment.some(dist.have)) && ((0,dist.have)((0,dist.$effect)(src_templateObject18 || (src_templateObject18 = src_taggedTemplateLiteral(["Fishy"])))) || (0,dist.have)((0,dist.$item)(src_templateObject19 || (src_templateObject19 = src_taggedTemplateLiteral(["fishy pipe"])))) && !(0,dist.get)("_fishyPipeUsed")) && !(0,dist.have)((0,dist.$item)(src_templateObject20 || (src_templateObject20 = src_taggedTemplateLiteral(["envyfish egg"])))) && embezzlerUp) {
    ...
    location = (0,dist.$location)(src_templateObject24 || (src_templateObject24 = src_taggedTemplateLiteral(["The Briny Deeps"])));
  }

  var underwater = location === (0,dist.$location)(src_templateObject25 || (src_templateObject25 = src_taggedTemplateLiteral(["The Briny Deeps"])));
  ...
  if ((0,dist.have)((0,dist.$item)(src_templateObject26 || (src_templateObject26 = src_taggedTemplateLiteral(["envyfish egg"])))) && !(0,dist.get)("_envyfishEggUsed")) {
    meatOutfit(true);
    (0,combat.withMacro)(combat.Macro.meatKill(), function () {
      return (0,external_kolmafia_.use)((0,dist.$item)(src_templateObject27 || (src_templateObject27 = src_taggedTemplateLiteral(["envyfish egg"]))));
    });
  } else if ((0,external_kolmafia_.myInebriety)() <= (0,external_kolmafia_.inebrietyLimit)() && (0,dist.have)((0,dist.$item)(src_templateObject28 || (src_templateObject28 = src_taggedTemplateLiteral(["protonic accelerator pack"])))) && (0,dist.get)("questPAGhost") !== "unstarted" && ghostLocation) {
    (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
    freeFightOutfit([new Requirement([], {
      forceEquip: (0,dist.$items)(src_templateObject29 || (src_templateObject29 = src_taggedTemplateLiteral(["protonic accelerator pack"])))
    })]);
    (0,dist.adventureMacro)(ghostLocation, physicalImmuneMacro);
  } else if ((0,external_kolmafia_.myInebriety)() <= (0,external_kolmafia_.inebrietyLimit)() && (0,dist.have)((0,dist.$item)(src_templateObject30 || (src_templateObject30 = src_taggedTemplateLiteral(["\"I Voted!\" sticker"])))) && (0,external_kolmafia_.getCounters)("Vote", 0, 0) !== "" && (0,dist.get)("_voteFreeFights") < 3) {
    (0,external_kolmafia_.useFamiliar)(freeFightFamiliar());
    freeFightOutfit([new Requirement([], {
      forceEquip: (0,dist.$items)(src_templateObject31 || (src_templateObject31 = src_taggedTemplateLiteral(["\"I Voted!\" sticker"])))
    })]);
    (0,dist.adventureMacroAuto)(prepWandererZone(), combat.Macro.step(physicalImmuneMacro).meatKill());
  } else {
    (0,dist.adventureMacroAuto)(location, combat.Macro.externalIf(underwater, combat.Macro.if_("monsterid ".concat((0,dist.$monster)(src_templateObject32 || (src_templateObject32 = src_taggedTemplateLiteral(["Knob Goblin Embezzler"]))).id), combat.Macro.item("pulled green taffy"))).meatKill(), combat.Macro.if_("(monsterid ".concat((0,dist.$monster)(src_templateObject33 || (src_templateObject33 = src_taggedTemplateLiteral(["Knob Goblin Embezzler"]))).id, ") && !gotjump && !(pastround 2)"), combat.Macro.externalIf(underwater, combat.Macro.item("pulled green taffy")).meatKill()).abort());
  }
  ...
  if ((0,external_kolmafia_.myAdventures)() === 1) {
    if (((0,dist.have)((0,dist.$item)(src_templateObject34 || (src_templateObject34 = src_taggedTemplateLiteral(["magical sausage"])))) || (0,dist.have)((0,dist.$item)(src_templateObject35 || (src_templateObject35 = src_taggedTemplateLiteral(["magical sausage casing"]))))) && (0,dist.get)("_sausagesEaten") < 23) {
      (0,external_kolmafia_.eat)((0,dist.$item)(src_templateObject36 || (src_templateObject36 = src_taggedTemplateLiteral(["magical sausage"]))));
    }
  }
...
function main() {
  ...
  var gardens = (0,dist.$items)(src_templateObject37 || (src_templateObject37 = src_taggedTemplateLiteral(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores"])));
  ...
  try {
    ...
    if ((0,dist.have)((0,dist.$item)(src_templateObject40 || (src_templateObject40 = src_taggedTemplateLiteral(["packet of tall grass seeds"])))) && (0,external_kolmafia_.myGardenType)() !== "grass" && (0,external_kolmafia_.myGardenType)() !== "mushroom") (0,external_kolmafia_.use)((0,dist.$item)(src_templateObject41 || (src_templateObject41 = src_taggedTemplateLiteral(["packet of tall grass seeds"]))));
    (0,external_kolmafia_.setAutoAttack)(0);
    ...
    (0,property.withProperties)({
      ...
      if ((0,external_kolmafia_.myClass)() === (0,dist.$class)(src_templateObject42 || (src_templateObject42 = src_taggedTemplateLiteral(["Seal Clubber"]))) && !(0,dist.have)((0,dist.$skill)(src_templateObject43 || (src_templateObject43 = src_taggedTemplateLiteral(["Furious Wallop"])))) && (0,external_kolmafia_.guildStoreAvailable)()) {
        (0,external_kolmafia_.visitUrl)("guild.php?action=buyskill&skillid=32", true);
      }

      var stashItems = (0,dist.$items)(src_templateObject44 || (src_templateObject44 = src_taggedTemplateLiteral(["repaid diaper, Buddy Bjorn, Crown of Thrones, origami pasties, Pantsgiving"])));
      if ((0,external_kolmafia_.myInebriety)() <= (0,external_kolmafia_.inebrietyLimit)() && ((0,external_kolmafia_.myClass)() !== (0,dist.$class)(src_templateObject45 || (src_templateObject45 = src_taggedTemplateLiteral(["Seal Clubber"]))) || !(0,dist.have)((0,dist.$skill)(src_templateObject46 || (src_templateObject46 = src_taggedTemplateLiteral(["Furious Wallop"])))))) stashItems.push((0,dist.$item)(src_templateObject47 || (src_templateObject47 = src_taggedTemplateLiteral(["haiku katana"])))); // FIXME: Dynamically figure out pointer ring approach.
      ...
      withStash(stashItems, function () {
        withVIPClan(function () {
          ...
          (0,dist.setDefaultMaximizeOptions)({
            preventEquip: (0,dist.$items)(src_templateObject48 || (src_templateObject48 = src_taggedTemplateLiteral(["broken champagne bottle, Spooky Putty snake, Spooky Putty mitre, Spooky Putty leotard, Spooky Putty ball, papier-mitre"])))
