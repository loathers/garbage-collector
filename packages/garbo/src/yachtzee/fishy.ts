...
export function optimizeForFishy(
  ...
  const bestWaterBreathingEquipment =
    getBestWaterBreathingEquipment(yachtzeeTurns);
  ...
  const fishySources = [
    ...
    },
    {
      ...
      turns: 30 + (haveFishyPipe ? 10 : 0),
      cost:
        mallPrice($item`powdered candy sushi set`) +
    ...
    },
    {
      ...
      turns: 30 + (haveFishyPipe ? 10 : 0),
      cost:
        mallPrice($item`concentrated fish broth`) +
        bestWaterBreathingEquipment.cost,
      action: () => {
        acquire(
          1,
    ...
    },
    {
      ...
      turns: 40 + (haveFishyPipe ? 10 : 0),
      cost:
        2 * mallPrice($item`pocket wish`) + bestWaterBreathingEquipment.cost,
      action: () => {
