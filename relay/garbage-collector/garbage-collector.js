...
var aa = __webpack_require__(481),
    m = __webpack_require__(232),
    r = __webpack_require__(438);
...
function App(_ref) {
  var settings = _ref.settings,
      updatedSettings = _ref.updatedSettings;
  var preferences = settings.map(function (setting) {
    return /*#__PURE__*/react.createElement(components_Setting, {
      value: setting.value,
      type: setting.type,
      name: setting.name,
...
getData(function (data) {
  react_dom.render( /*#__PURE__*/react.createElement(relay_App, {
